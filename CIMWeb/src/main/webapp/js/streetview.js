        ...
        function urlFor (lon, lat)
        {
            return (
                ...
                getPanoPoint (lon, lat).then (
                    (pano) => // { pano_id: "oVi3A6P1RPZxp7YZryxtGw", pano_lat: 47.116508, pano_lon: 7.252622, pano_yaw: 264 }
                    {
                        let url;
                        if ("" !== pano.pano_id)
                        {
                            ...
                            url = "http://maps.google.com/?" +
                                ...
                                "z=16";
                        return (url); // "http://maps.google.com/?ie=UTF8&layer=c&om=0&cbll=47.116508,7.252622&cbp=13,74.35,,0,5&t=h&ll=47.116504,7.25264&spn=0.052323,0.0842&z=16&panoid=oVi3A6P1RPZxp7YZryxtGw"
                    }
                )
            );
        }
