    ...
    <g id="iconic-clock-second-hand">
        ...
        <circle
            ...
            setTime (date)
            {
                ...
                document.querySelector ("#iconic-clock-face").setAttribute("style", pm ? "fill:#888488;fill-opacity:1;stroke:#000000;stroke-opacity:1" : "fill:#ffffff;fill-opacity:1;stroke:#000000;stroke-opacity:1");
            }
        }
