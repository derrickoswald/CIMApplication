    ...
    function (base, Core, Domain, Metering)
    {
        ...
        class DispatchSchedule extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                temp = Core.CurveStyle[document.getElementById (id + "_curveStyleKind").value]; if (temp) obj["curveStyleKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#CurveStyle." + temp; else delete obj["curveStyleKind"];
                ...
                temp = TimeIntervalKind[document.getElementById (id + "_timeIntervalUnit").value]; if (temp) obj["timeIntervalUnit"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TimeIntervalKind." + temp; else delete obj["timeIntervalUnit"];
        ...
        class DERMonitorableParameter extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = DERParameterKind[document.getElementById (id + "_DERParameter").value]; if (temp) obj["DERParameter"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#DERParameterKind." + temp; else delete obj["DERParameter"];
                temp = Metering.FlowDirectionKind[document.getElementById (id + "_flowDirection").value]; if (temp) obj["flowDirection"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#FlowDirectionKind." + temp; else delete obj["flowDirection"];
                temp = Domain.UnitMultiplier[document.getElementById (id + "_yMultiplier").value]; if (temp) obj["yMultiplier"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#UnitMultiplier." + temp; else delete obj["yMultiplier"];
                temp = DERUnitSymbol[document.getElementById (id + "_yUnit").value]; if (temp) obj["yUnit"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#DERUnitSymbol." + temp; else delete obj["yUnit"];
