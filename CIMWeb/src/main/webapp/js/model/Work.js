    ...
    function (base, Assets, Common, Core)
    {
        ...
        class RepairItem extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = BreakerRepairItemKind[document.getElementById (id + "_breakerRepairItem").value]; if (temp) obj["breakerRepairItem"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#BreakerRepairItemKind." + temp; else delete obj["breakerRepairItem"];
                temp = TransformerRepairItemKind[document.getElementById (id + "_transformerRepairItem").value]; if (temp) obj["transformerRepairItem"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#TransformerRepairItemKind." + temp; else delete obj["transformerRepairItem"];
        ...
        class MaintenanceWorkTask extends WorkTask
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = BreakerMaintenanceKind[document.getElementById (id + "_breakerMaintenanceKind").value]; if (temp) obj["breakerMaintenanceKind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#BreakerMaintenanceKind." + temp; else delete obj["breakerMaintenanceKind"];
                temp = TransformerMaintenanceKind[document.getElementById (id + "_transformerMaintenanceKind").value]; if (temp) obj["transformerMaintenanceKind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#TransformerMaintenanceKind." + temp; else delete obj["transformerMaintenanceKind"];
