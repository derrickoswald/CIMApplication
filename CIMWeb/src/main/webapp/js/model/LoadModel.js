    ...
    function (base, Core)
    {
        ...
        class LoadGroup extends Core.IdentifiedObject
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.LoadGroup;
                if (null == bucket)
        ...
        class LoadResponseCharacteristic extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.LoadResponseCharacteristic;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.LoadResponseCharacteristic;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "LoadResponseCharacteristic" };
                super.submit (id, obj);
        ...
        class PowerCutZone extends Core.PowerSystemResource
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PowerCutZone;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.PowerCutZone;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PowerCutZone" };
                super.submit (id, obj);
        ...
        class SeasonDayTypeSchedule extends Core.RegularIntervalSchedule
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.SeasonDayTypeSchedule;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.SeasonDayTypeSchedule;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "SeasonDayTypeSchedule" };
                super.submit (id, obj);
        ...
        class DayType extends Core.IdentifiedObject
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.DayType;
                if (null == bucket)
        ...
        class EnergyArea extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.EnergyArea;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.EnergyArea;
                if (null == bucket)
        ...
        class Season extends Core.IdentifiedObject
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.Season;
                if (null == bucket)
        ...
        class ConformLoadGroup extends LoadGroup
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ConformLoadGroup;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = LoadGroup.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.ConformLoadGroup;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = LoadGroup.prototype.export.call (this, obj, false);
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "ConformLoadGroup" };
                super.submit (id, obj);
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["ConformLoadSchedules", "0..*", "1", "ConformLoadSchedule", "ConformLoadGroup"]
                        ]
                    )
                );
            }
        ...
        class NonConformLoadGroup extends LoadGroup
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.NonConformLoadGroup;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.NonConformLoadGroup;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "NonConformLoadGroup" };
                super.submit (id, obj);
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["NonConformLoadSchedules", "0..*", "1", "NonConformLoadSchedule", "NonConformLoadGroup"],
        ...
        class NonConformLoadSchedule extends SeasonDayTypeSchedule
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.NonConformLoadSchedule;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = SeasonDayTypeSchedule.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.NonConformLoadSchedule;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = SeasonDayTypeSchedule.prototype.export.call (this, obj, false);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "NonConformLoadSchedule" };
                super.submit (id, obj);
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["NonConformLoadGroup", "1", "0..*", "NonConformLoadGroup", "NonConformLoadSchedules"]
                        ]
                    )
                );
            }
        ...
        class ConformLoadSchedule extends SeasonDayTypeSchedule
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ConformLoadSchedule;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ConformLoadSchedule;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ConformLoadSchedule" };
                super.submit (id, obj);
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["ConformLoadGroup", "1", "0..*", "ConformLoadGroup", "ConformLoadSchedules"]
                        ]
                    )
                );
            }
        ...
        class LoadArea extends EnergyArea
        {
            ...
            export (obj, full)
            {
                let fields = EnergyArea.prototype.export.call (this, obj, false);
        ...
        class SubLoadArea extends EnergyArea
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.SubLoadArea;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.SubLoadArea;
                if (null == bucket)
