    ...
    function (base, Core, InfAssetInfo, Wires)
    {
        ...
        class ShuntCompensatorControl extends Wires.RegulatingControl
        {
            ...
            submit (id, obj)
            {
                ...
                temp = InfAssetInfo.ShuntImpedanceControlKind[document.getElementById (id + "_controlKind").value]; if (temp) obj["controlKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ShuntImpedanceControlKind." + temp; else delete obj["controlKind"];
                temp = document.getElementById (id + "_highVoltageOverride").value; if ("" !== temp) obj["highVoltageOverride"] = temp;
                temp = InfAssetInfo.ShuntImpedanceLocalControlKind[document.getElementById (id + "_localControlKind").value]; if (temp) obj["localControlKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ShuntImpedanceLocalControlKind." + temp; else delete obj["localControlKind"];
                ...
                temp = InfAssetInfo.RegulationBranchKind[document.getElementById (id + "_regBranchKind").value]; if (temp) obj["regBranchKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#RegulationBranchKind." + temp; else delete obj["regBranchKind"];
                temp = Core.PhaseCode[document.getElementById (id + "_sensingPhaseCode").value]; if (temp) obj["sensingPhaseCode"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#PhaseCode." + temp; else delete obj["sensingPhaseCode"];
