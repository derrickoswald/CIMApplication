    ...
    function (base, Common, Contingency, Core, MarketCommon, MktDomain, Production)
    {
        ...
        class ResourceCertification extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                temp = MktDomain.ResourceCertificationKind[document.getElementById (id + "_type").value]; if (temp) obj["type"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#ResourceCertificationKind." + temp; else delete obj["type"];
        ...
        class RegisteredGenerator extends MarketCommon.RegisteredResource
        {
            ...
            submit (id, obj)
            {
                ...
                temp = MktDomain.CostBasis[document.getElementById (id + "_minimumLoadCostBasis").value]; if (temp) obj["minimumLoadCostBasis"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#CostBasis." + temp; else delete obj["minimumLoadCostBasis"];
                ...
                temp = MktDomain.UnitRegulationKind[document.getElementById (id + "_regulationFlag").value]; if (temp) obj["regulationFlag"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#UnitRegulationKind." + temp; else delete obj["regulationFlag"];
                ...
                temp = MktDomain.CostBasis[document.getElementById (id + "_startUpCostBasis").value]; if (temp) obj["startUpCostBasis"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#CostBasis." + temp; else delete obj["startUpCostBasis"];
                ...
                temp = MktDomain.YesNo[document.getElementById (id + "_variableEnergyResource").value]; if (temp) obj["variableEnergyResource"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#YesNo." + temp; else delete obj["variableEnergyResource"];
                temp = document.getElementById (id + "_MktHeatRateCurve").value; if ("" !== temp) obj["MktHeatRateCurve"] = temp;
