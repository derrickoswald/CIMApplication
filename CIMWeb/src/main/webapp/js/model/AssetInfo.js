    ...
    function (base, Assets, Core, Wires)
    {
        ...
        class BushingInfo extends Assets.AssetInfo
        {
            ...
            submit (id, obj)
            {
                ...
                temp = BushingInsulationKind[document.getElementById (id + "_insulationKind").value]; if (temp) obj["insulationKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#BushingInsulationKind." + temp; else delete obj["insulationKind"];
        ...
        class WirePhaseInfo extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = Wires.SinglePhaseKind[document.getElementById (id + "_phaseInfo").value]; if (temp) obj["phaseInfo"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#SinglePhaseKind." + temp; else delete obj["phaseInfo"];
        ...
        class OperatingMechanismInfo extends Assets.AssetInfo
        {
            ...
            submit (id, obj)
            {
                ...
                temp = OperatingMechanismKind[document.getElementById (id + "_mechanismKind").value]; if (temp) obj["mechanismKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#OperatingMechanismKind." + temp; else delete obj["mechanismKind"];
        ...
        class WireSpacingInfo extends Assets.AssetInfo
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WireSpacingInfo;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_attributes (/<cim:WireSpacingInfo.ACLineSegment\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "ACLineSegment", sub, context);
                let bucket = context.parsed.WireSpacingInfo;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_attributes (obj, "WireSpacingInfo", "ACLineSegment", "ACLineSegment", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    ...
                    {{#ACLineSegment}}<div><b>ACLineSegment</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/ACLineSegment}}
                    </div>
                    </fieldset>
            ...
            condition (obj)
            {
                ...
                if (obj["ACLineSegment"]) obj["ACLineSegment_string"] = obj["ACLineSegment"].join ();
            }
            ...
            uncondition (obj)
            {
                ...
                delete obj["ACLineSegment_string"];
            }
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WireSpacingInfo" };
                super.submit (id, obj);
                ...
                temp = WireUsageKind[document.getElementById (id + "_usage").value]; if (temp) obj["usage"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#WireUsageKind." + temp; else delete obj["usage"];
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["ACLineSegment", "0..*", "0..1", "ACLineSegment", "WireSpacingInfo"]
                        ]
                    )
                );
            }
        ...
        class WireInfo extends Assets.AssetInfo
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_attributes (/<cim:WireInfo.ACLineSegmentPhase\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "ACLineSegmentPhase", sub, context);
            ...
            export (obj, full)
            {
                ...
                base.export_attributes (obj, "WireInfo", "ACLineSegmentPhase", "ACLineSegmentPhase", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    ...
                    {{#WirePhaseInfo}}<div><b>WirePhaseInfo</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/WirePhaseInfo}}
                    {{#ACLineSegmentPhase}}<div><b>ACLineSegmentPhase</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/ACLineSegmentPhase}}
                    </div>
                    </fieldset>
            ...
            condition (obj)
            {
                ...
                if (obj["WirePhaseInfo"]) obj["WirePhaseInfo_string"] = obj["WirePhaseInfo"].join ();
                if (obj["ACLineSegmentPhase"]) obj["ACLineSegmentPhase_string"] = obj["ACLineSegmentPhase"].join ();
            }
            ...
            uncondition (obj)
            {
                ...
                delete obj["WirePhaseInfo_string"];
                delete obj["ACLineSegmentPhase_string"];
            }
            ...
            submit (id, obj)
            {
                ...
                temp = WireInsulationKind[document.getElementById (id + "_insulationMaterial").value]; if (temp) obj["insulationMaterial"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#WireInsulationKind." + temp; else delete obj["insulationMaterial"];
                temp = document.getElementById (id + "_insulationThickness").value; if ("" !== temp) obj["insulationThickness"] = temp;
                temp = WireMaterialKind[document.getElementById (id + "_material").value]; if (temp) obj["material"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#WireMaterialKind." + temp; else delete obj["material"];
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["ACLineSegmentPhase", "0..*", "0..1", "ACLineSegmentPhase", "WireInfo"]
                        ]
                    )
                );
            }
        ...
        class WirePosition extends Core.IdentifiedObject
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:WirePosition.sequenceNumber>([\s\S]*?)<\/cim:WirePosition.sequenceNumber>/g, obj, "sequenceNumber", base.to_string, sub, context);
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "WirePosition", "sequenceNumber", "sequenceNumber",  base.from_string, fields);
        ...
        class InterrupterUnitInfo extends Assets.AssetInfo
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = InterruptingMediumKind[document.getElementById (id + "_interruptingMedium").value]; if (temp) obj["interruptingMedium"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#InterruptingMediumKind." + temp; else delete obj["interruptingMedium"];
        ...
        class TransformerEndInfo extends Assets.AssetInfo
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = Wires.WindingConnection[document.getElementById (id + "_connectionKind").value]; if (temp) obj["connectionKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#WindingConnection." + temp; else delete obj["connectionKind"];
        ...
        class CableInfo extends WireInfo
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = CableConstructionKind[document.getElementById (id + "_constructionKind").value]; if (temp) obj["constructionKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#CableConstructionKind." + temp; else delete obj["constructionKind"];
                ...
                temp = CableOuterJacketKind[document.getElementById (id + "_outerJacketKind").value]; if (temp) obj["outerJacketKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#CableOuterJacketKind." + temp; else delete obj["outerJacketKind"];
                temp = document.getElementById (id + "_sheathAsNeutral").checked; if (temp) obj["sheathAsNeutral"] = true;
                temp = CableShieldMaterialKind[document.getElementById (id + "_shieldMaterial").value]; if (temp) obj["shieldMaterial"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#CableShieldMaterialKind." + temp; else delete obj["shieldMaterial"];
