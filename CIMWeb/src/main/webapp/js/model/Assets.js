    ...
    function (base, Common, Core, InfAssets)
    {
        ...
        class ASTMStandard extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = ASTMStandardEditionKind[document.getElementById (id + "_standardEdition").value]; if (temp) obj["standardEdition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ASTMStandardEditionKind." + temp; else delete obj["standardEdition"];
                temp = ASTMStandardKind[document.getElementById (id + "_standardNumber").value]; if (temp) obj["standardNumber"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ASTMStandardKind." + temp; else delete obj["standardNumber"];
        ...
        class UKMinistryOfDefenceStandard extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = UKMinistryOfDefenceStandardEditionKind[document.getElementById (id + "_standardEdition").value]; if (temp) obj["standardEdition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#UKMinistryOfDefenceStandardEditionKind." + temp; else delete obj["standardEdition"];
                temp = UKMinistryofDefenceStandardKind[document.getElementById (id + "_standardNumber").value]; if (temp) obj["standardNumber"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#UKMinistryofDefenceStandardKind." + temp; else delete obj["standardNumber"];
        ...
        class EPAStandard extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = EPAStandardEditionKind[document.getElementById (id + "_standardEdition").value]; if (temp) obj["standardEdition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#EPAStandardEditionKind." + temp; else delete obj["standardEdition"];
                temp = EPAStandardKind[document.getElementById (id + "_standardNumber").value]; if (temp) obj["standardNumber"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#EPAStandardKind." + temp; else delete obj["standardNumber"];
        ...
        class Asset extends Core.IdentifiedObject
        {
            ...
            edit_template ()
            {
                return (
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_ReplacementWorkTasks'>ReplacementWorkTasks: </label><div class='col-sm-8'><input id='{{id}}_ReplacementWorkTasks' class='form-control' type='text'{{#ReplacementWorkTasks}} value='{{ReplacementWorkTasks_string}}'{{/ReplacementWorkTasks}}></div></div>
            ...
            submit (id, obj)
            {
                ...
                temp = document.getElementById (id + "_inUseDate").value; if ("" !== temp) obj["inUseDate"] = temp;
                temp = InUseStateKind[document.getElementById (id + "_inUseState").value]; if (temp) obj["inUseState"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#InUseStateKind." + temp; else delete obj["inUseState"];
                temp = AssetKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AssetKind." + temp; else delete obj["kind"];
                temp = document.getElementById (id + "_lifecycleDate").value; if ("" !== temp) obj["lifecycleDate"] = temp;
                temp = AssetLifecycleStateKind[document.getElementById (id + "_lifecycleState").value]; if (temp) obj["lifecycleState"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AssetLifecycleStateKind." + temp; else delete obj["lifecycleState"];
                ...
                temp = RetiredReasonKind[document.getElementById (id + "_retiredReason").value]; if (temp) obj["retiredReason"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#RetiredReasonKind." + temp; else delete obj["retiredReason"];
                ...
                temp = document.getElementById (id + "_ReplacementWorkTasks").value; if ("" !== temp) obj["ReplacementWorkTasks"] = temp.split (",");
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["ReplacementWorkTasks", "0..*", "0..*", "WorkTask", "OldAsset"],
        ...
        class AssetGroup extends Common.Document
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = AssetGroupKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AssetGroupKind." + temp; else delete obj["kind"];
        ...
        class TestStandard extends Core.IdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = TestMethod[document.getElementById (id + "_testMethod").value]; if (temp) obj["testMethod"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TestMethod." + temp; else delete obj["testMethod"];
                ...
                temp = TestVariantKind[document.getElementById (id + "_testVariant").value]; if (temp) obj["testVariant"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TestVariantKind." + temp; else delete obj["testVariant"];
        ...
        class DobleStandard extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = DobleStandardEditionKind[document.getElementById (id + "_standardEdition").value]; if (temp) obj["standardEdition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#DobleStandardEditionKind." + temp; else delete obj["standardEdition"];
                temp = DobleStandardKind[document.getElementById (id + "_standardNumber").value]; if (temp) obj["standardNumber"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#DobleStandardKind." + temp; else delete obj["standardNumber"];
        ...
        class FailureEvent extends Common.ActivityRecord
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = BreakerFailureReasonKind[document.getElementById (id + "_breakerFailureReason").value]; if (temp) obj["breakerFailureReason"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#BreakerFailureReasonKind." + temp; else delete obj["breakerFailureReason"];
                temp = document.getElementById (id + "_corporateCode").value; if ("" !== temp) obj["corporateCode"] = temp;
                temp = AssetFailureClassification[document.getElementById (id + "_failureClassification").value]; if (temp) obj["failureClassification"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AssetFailureClassification." + temp; else delete obj["failureClassification"];
                temp = document.getElementById (id + "_failureDateTime").value; if ("" !== temp) obj["failureDateTime"] = temp;
                temp = FailureIsolationMethodKind[document.getElementById (id + "_failureIsolationMethod").value]; if (temp) obj["failureIsolationMethod"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#FailureIsolationMethodKind." + temp; else delete obj["failureIsolationMethod"];
                temp = AssetFailureMode[document.getElementById (id + "_failureMode").value]; if (temp) obj["failureMode"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AssetFailureMode." + temp; else delete obj["failureMode"];
                ...
                temp = TransformerFailureReasonKind[document.getElementById (id + "_transformerFailureReason").value]; if (temp) obj["transformerFailureReason"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TransformerFailureReasonKind." + temp; else delete obj["transformerFailureReason"];
        ...
        class ProductAssetModel extends Core.IdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                temp = CorporateStandardKind[document.getElementById (id + "_corporateStandardKind").value]; if (temp) obj["corporateStandardKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#CorporateStandardKind." + temp; else delete obj["corporateStandardKind"];
                ...
                temp = AssetModelUsageKind[document.getElementById (id + "_usageKind").value]; if (temp) obj["usageKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AssetModelUsageKind." + temp; else delete obj["usageKind"];
        ...
        class AssetDeployment extends Core.IdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = BreakerApplicationKind[document.getElementById (id + "_breakerApplication").value]; if (temp) obj["breakerApplication"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#BreakerApplicationKind." + temp; else delete obj["breakerApplication"];
                temp = document.getElementById (id + "_deploymentDate").value; if ("" !== temp) obj["deploymentDate"] = temp;
                temp = DeploymentStateKind[document.getElementById (id + "_deploymentState").value]; if (temp) obj["deploymentState"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#DeploymentStateKind." + temp; else delete obj["deploymentState"];
                temp = FacilityKind[document.getElementById (id + "_facilityKind").value]; if (temp) obj["facilityKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#FacilityKind." + temp; else delete obj["facilityKind"];
                temp = document.getElementById (id + "_likelihoodOfFailure").value; if ("" !== temp) obj["likelihoodOfFailure"] = temp;
                temp = TransformerApplicationKind[document.getElementById (id + "_transformerApplication").value]; if (temp) obj["transformerApplication"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TransformerApplicationKind." + temp; else delete obj["transformerApplication"];
                temp = document.getElementById (id + "_Asset").value; if ("" !== temp) obj["Asset"] = temp;
        ...
        class DINStandard extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = DINStandardEditionKind[document.getElementById (id + "_standardEdition").value]; if (temp) obj["standardEdition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#DINStandardEditionKind." + temp; else delete obj["standardEdition"];
                temp = DINStandardKind[document.getElementById (id + "_standardNumber").value]; if (temp) obj["standardNumber"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#DINStandardKind." + temp; else delete obj["standardNumber"];
        ...
        class TAPPIStandard extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = TAPPIStandardEditionKind[document.getElementById (id + "_standardEdition").value]; if (temp) obj["standardEdition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TAPPIStandardEditionKind." + temp; else delete obj["standardEdition"];
                temp = TAPPIStandardKind[document.getElementById (id + "_standardNumber").value]; if (temp) obj["standardNumber"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TAPPIStandardKind." + temp; else delete obj["standardNumber"];
        ...
        class ISOStandard extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = ISOStandardEditionKind[document.getElementById (id + "_standardEdition").value]; if (temp) obj["standardEdition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ISOStandardEditionKind." + temp; else delete obj["standardEdition"];
                temp = ISOStandardKind[document.getElementById (id + "_standardNumber").value]; if (temp) obj["standardNumber"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ISOStandardKind." + temp; else delete obj["standardNumber"];
        ...
        class Seal extends Core.IdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                temp = SealConditionKind[document.getElementById (id + "_condition").value]; if (temp) obj["condition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#SealConditionKind." + temp; else delete obj["condition"];
                temp = SealKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#SealKind." + temp; else delete obj["kind"];
        ...
        class IECStandard extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = IECStandardEditionKind[document.getElementById (id + "_standardEdition").value]; if (temp) obj["standardEdition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#IECStandardEditionKind." + temp; else delete obj["standardEdition"];
                temp = IECStandardKind[document.getElementById (id + "_standardNumber").value]; if (temp) obj["standardNumber"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#IECStandardKind." + temp; else delete obj["standardNumber"];
        ...
        class WEPStandard extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = WEPStandardEditionKind[document.getElementById (id + "_standardEdition").value]; if (temp) obj["standardEdition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#WEPStandardEditionKind." + temp; else delete obj["standardEdition"];
                temp = WEPStandardKind[document.getElementById (id + "_standardNumber").value]; if (temp) obj["standardNumber"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#WEPStandardKind." + temp; else delete obj["standardNumber"];
        ...
        class CIGREStandard extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = CIGREStandardEditionKind[document.getElementById (id + "_standardEdition").value]; if (temp) obj["standardEdition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#CIGREStandardEditionKind." + temp; else delete obj["standardEdition"];
                temp = CIGREStandardKind[document.getElementById (id + "_standardNumber").value]; if (temp) obj["standardNumber"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#CIGREStandardKind." + temp; else delete obj["standardNumber"];
        ...
        class Analytic extends Common.Document
        {
            ...
            submit (id, obj)
            {
                ...
                temp = AnalyticKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AnalyticKind." + temp; else delete obj["kind"];
                temp = ScaleKind[document.getElementById (id + "_scaleKind").value]; if (temp) obj["scaleKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ScaleKind." + temp; else delete obj["scaleKind"];
        ...
        class LaborelecStandard extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = LaborelecStandardEditionKind[document.getElementById (id + "_standardEdition").value]; if (temp) obj["standardEdition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#LaborelecStandardEditionKind." + temp; else delete obj["standardEdition"];
                temp = LaborelecStandardKind[document.getElementById (id + "_standardNumber").value]; if (temp) obj["standardNumber"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#LaborelecStandardKind." + temp; else delete obj["standardNumber"];
        ...
        class AssetLocationHazard extends Common.Hazard
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = AssetHazardKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AssetHazardKind." + temp; else delete obj["kind"];
        ...
        class Procedure extends Common.Document
        {
            ...
            submit (id, obj)
            {
                ...
                temp = ProcedureKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ProcedureKind." + temp; else delete obj["kind"];
        ...
        class Medium extends Core.IdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = MediumKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#MediumKind." + temp; else delete obj["kind"];
        ...
        class IEEEStandard extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = IEEEStandardEditionKind[document.getElementById (id + "_standardEdition").value]; if (temp) obj["standardEdition"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#IEEEStandardEditionKind." + temp; else delete obj["standardEdition"];
                temp = IEEEStandardKind[document.getElementById (id + "_standardNumber").value]; if (temp) obj["standardNumber"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#IEEEStandardKind." + temp; else delete obj["standardNumber"];
        ...
        class StructureSupport extends Asset
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = InfAssets.AnchorKind[document.getElementById (id + "_anchorKind").value]; if (temp) obj["anchorKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AnchorKind." + temp; else delete obj["anchorKind"];
                ...
                temp = InfAssets.StructureSupportKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#StructureSupportKind." + temp; else delete obj["kind"];
        ...
        class Streetlight extends Asset
        {
            ...
            submit (id, obj)
            {
                ...
                temp = InfAssets.StreetlightLampKind[document.getElementById (id + "_lampKind").value]; if (temp) obj["lampKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#StreetlightLampKind." + temp; else delete obj["lampKind"];
        ...
        class FACTSDevice extends Asset
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = InfAssets.FACTSDeviceKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#FACTSDeviceKind." + temp; else delete obj["kind"];
        ...
        class Joint extends Asset
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = InfAssets.JointConfigurationKind[document.getElementById (id + "_configurationKind").value]; if (temp) obj["configurationKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#JointConfigurationKind." + temp; else delete obj["configurationKind"];
                temp = InfAssets.JointFillKind[document.getElementById (id + "_fillKind").value]; if (temp) obj["fillKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#JointFillKind." + temp; else delete obj["fillKind"];
        ...
        class Structure extends AssetContainer
        {
            ...
            submit (id, obj)
            {
                ...
                temp = InfAssets.StructureMaterialKind[document.getElementById (id + "_materialKind").value]; if (temp) obj["materialKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#StructureMaterialKind." + temp; else delete obj["materialKind"];
        ...
        class OilSpecimen extends Specimen
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = OilSampleLocation[document.getElementById (id + "_oilSampleTakenFrom").value]; if (temp) obj["oilSampleTakenFrom"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#OilSampleLocation." + temp; else delete obj["oilSampleTakenFrom"];
                temp = document.getElementById (id + "_oilSampleTemperature").value; if ("" !== temp) obj["oilSampleTemperature"] = temp;
                temp = OilTemperatureSource[document.getElementById (id + "_oilTemperatureSource").value]; if (temp) obj["oilTemperatureSource"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#OilTemperatureSource." + temp; else delete obj["oilTemperatureSource"];
                temp = SampleContainerType[document.getElementById (id + "_sampleContainer").value]; if (temp) obj["sampleContainer"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#SampleContainerType." + temp; else delete obj["sampleContainer"];
        ...
        class LabTestDataSet extends ProcedureDataSet
        {
            ...
            submit (id, obj)
            {
                ...
                temp = TestReason[document.getElementById (id + "_reasonForTest").value]; if (temp) obj["reasonForTest"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TestReason." + temp; else delete obj["reasonForTest"];
        ...
        class RiskScore extends AggregateScore
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = RiskScoreKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#RiskScoreKind." + temp; else delete obj["kind"];
