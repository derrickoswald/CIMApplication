...
(
    ...
    function (base)
    {
         ...
         *
         */
        var MarketStatementDescription =
        {
         ...
         *
         */
        var MarketStatementLineItemAliasName =
        {
        ...
        var ADSInstructionTypeCommitment =
        {
            START_UP: "START_UP",
            SHUT_DOWN: "SHUT_DOWN"
        };
        ...
        var ResourceCertificationCategory =
        {
            DAM: "DAM",
            RTM: "RTM",
            RC: "RC",
