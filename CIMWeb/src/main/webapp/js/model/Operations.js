    ...
    function (base, Common, Core)
    {
        ...
        class TroubleOrder extends Common.Document
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_attributes (/<cim:TroubleOrder.WorkTask\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "WorkTask", sub, context);
                base.parse_attribute (/<cim:TroubleOrder.Location\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "Location", sub, context);
                base.parse_attributes (/<cim:TroubleOrder.TroubleTicket\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "TroubleTicket", sub, context);
                base.parse_attribute (/<cim:TroubleOrder.UnplannedOutage\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "UnplannedOutage", sub, context);
            ...
            export (obj, full)
            {
                ...
                base.export_attributes (obj, "TroubleOrder", "WorkTask", "WorkTask", fields);
                base.export_attribute (obj, "TroubleOrder", "Location", "Location", fields);
                base.export_attributes (obj, "TroubleOrder", "TroubleTicket", "TroubleTicket", fields);
                base.export_attribute (obj, "TroubleOrder", "UnplannedOutage", "UnplannedOutage", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    ...
                    {{#WorkTask}}<div><b>WorkTask</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/WorkTask}}
            ...
            {
                super.condition (obj);
                if (obj["WorkTask"]) obj["WorkTask_string"] = obj["WorkTask"].join ();
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["WorkTask", "0..*", "0..1", "WorkTask", "TroubleOrder"],
                            ["Location", "0..1", "0..1", "Location", "TroubleOrder"],
                            ["TroubleTicket", "0..*", "0..1", "TroubleTicket", "TroubleOrder"],
                            ["UnplannedOutage", "0..1", "0..*", "UnplannedOutage", "TroubleOrder"]
                        ]
                    )
                );
            }
        ...
        class SwitchingPlan extends Common.Document
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_attribute (/<cim:SwitchingPlan.PlannedOutageNotification\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "PlannedOutageNotification", sub, context);
                ...
                base.parse_attributes (/<cim:SwitchingPlan.SwitchingAction\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "SwitchingAction", sub, context);
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "SwitchingPlan", "PlannedOutageNotification", "PlannedOutageNotification", fields);
                ...
                base.export_attributes (obj, "SwitchingPlan", "SwitchingAction", "SwitchingAction", fields);
            ...
            template ()
            {
                return (
                    ...
                    {{#PlannedOutageNotification}}<div><b>PlannedOutageNotification</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{PlannedOutageNotification}}");}); return false;'>{{PlannedOutageNotification}}</a></div>{{/PlannedOutageNotification}}
                    ...
                    {{#SwitchingAction}}<div><b>SwitchingAction</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/SwitchingAction}}
                    {{#OutagePlan}}<div><b>OutagePlan</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{OutagePlan}}");}); return false;'>{{OutagePlan}}</a></div>{{/OutagePlan}}
            ...
            condition (obj)
            {
                ...
                if (obj["SwitchingAction"]) obj["SwitchingAction_string"] = obj["SwitchingAction"].join ();
            ...
            uncondition (obj)
            {
                ...
                delete obj["SwitchingAction_string"];
            ...
            submit (id, obj)
            {
                ...
                temp = document.getElementById (id + "_PlannedOutageNotification").value; if ("" !== temp) obj["PlannedOutageNotification"] = temp;
                temp = document.getElementById (id + "_OutagePlan").value; if ("" !== temp) obj["OutagePlan"] = temp;
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["PlannedOutageNotification", "0..1", "0..1", "PlannedOutageNotification", "SwitchingPlan"],
                            ["WorkTasks", "0..*", "0..1", "WorkTask", "SwitchingPlan"],
                            ["SafetyDocuments", "0..*", "0..1", "SafetyDocument", "SwitchingPlan"],
                            ["SwitchingAction", "0..*", "0..1", "SwitchingAction", "SwitchingPlan"],
        ...
        class Incident extends Common.Document
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_attribute (/<cim:Incident.UnplannedOutage\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "UnplannedOutage", sub, context);
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "Incident", "UnplannedOutage", "UnplannedOutage", fields);
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["UnplannedOutage", "0..1", "0..*", "UnplannedOutage", "Incident"],
        ...
        class SwitchingStep extends base.Element
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:SwitchingStep.subStepSequenceNumber>([\s\S]*?)<\/cim:SwitchingStep.subStepSequenceNumber>/g, obj, "subStepSequenceNumber", base.to_string, sub, context);
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "SwitchingStep", "subStepSequenceNumber", "subStepSequenceNumber",  base.from_string, fields);
            ...
            template ()
            {
                return (
                    ...
                    {{#subStepSequenceNumber}}<div><b>subStepSequenceNumber</b>: {{subStepSequenceNumber}}</div>{{/subStepSequenceNumber}}
                    {{#SwitchingAction}}<div><b>SwitchingAction</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{SwitchingAction}}");}); return false;'>{{SwitchingAction}}</a></div>{{/SwitchingAction}}
            ...
            edit_template ()
            {
                return (
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_subStepSequenceNumber'>subStepSequenceNumber: </label><div class='col-sm-8'><input id='{{id}}_subStepSequenceNumber' class='form-control' type='text'{{#subStepSequenceNumber}} value='{{subStepSequenceNumber}}'{{/subStepSequenceNumber}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_SwitchingAction'>SwitchingAction: </label><div class='col-sm-8'><input id='{{id}}_SwitchingAction' class='form-control' type='text'{{#SwitchingAction}} value='{{SwitchingAction}}'{{/SwitchingAction}}></div></div>
            ...
            submit (id, obj)
            {
                ...
                temp = document.getElementById (id + "_subStepSequenceNumber").value; if ("" !== temp) obj["subStepSequenceNumber"] = temp;
                temp = document.getElementById (id + "_SwitchingAction").value; if ("" !== temp) obj["SwitchingAction"] = temp;
        ...
        class PSREvent extends Common.ActivityRecord
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = PSREventKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#PSREventKind." + temp; else delete obj["kind"];
                temp = document.getElementById (id + "_PowerSystemResource").value; if ("" !== temp) obj["PowerSystemResource"] = temp;
        ...
        class Outage extends Common.Document
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_attributes (/<cim:Outage.OutageIsolationEquipment\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "OutageIsolationEquipment", sub, context);
            ...
            export (obj, full)
            {
                ...
                base.export_attributes (obj, "Outage", "OutageIsolationEquipment", "OutageIsolationEquipment", fields);
            ...
            template ()
            {
                return (
                    ...
                    {{#OutageIsolationEquipment}}<div><b>OutageIsolationEquipment</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/OutageIsolationEquipment}}
            ...
            condition (obj)
            {
                ...
                if (obj["OutageIsolationEquipment"]) obj["OutageIsolationEquipment_string"] = obj["OutageIsolationEquipment"].join ();
            ...
            uncondition (obj)
            {
                ...
                delete obj["OutageIsolationEquipment_string"];
            ...
            submit (id, obj)
            {
                ...
                temp = OutageStatusKind[document.getElementById (id + "_outageKind").value]; if (temp) obj["outageKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#OutageStatusKind." + temp; else delete obj["outageKind"];
                temp = Common.CrewStatusKind[document.getElementById (id + "_statusKind").value]; if (temp) obj["statusKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#CrewStatusKind." + temp; else delete obj["statusKind"];
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["OutageIsolationEquipment", "0..*", "0..1", "ConductingEquipment", "Outage"],
        ...
        class EstimatedRestorationTime extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = ERTConfidenceKind[document.getElementById (id + "_confidenceKind").value]; if (temp) obj["confidenceKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ERTConfidenceKind." + temp; else delete obj["confidenceKind"];
        ...
        class SwitchingAction extends Core.IdentifiedObject
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_attribute (/<cim:SwitchingAction.phases\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "phases", sub, context);
                ...
                base.parse_attribute (/<cim:SwitchingAction.SwitchingPlan\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "SwitchingPlan", sub, context);
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "SwitchingAction", "phases", "phases", fields);
                ...
                base.export_attribute (obj, "SwitchingAction", "SwitchingPlan", "SwitchingPlan", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["SwitchingPlan", "0..1", "0..*", "SwitchingPlan", "SwitchingAction"]
                        ]
                    )
                );
            }
         ...
         *
         */
        class PlannedOutageNotification extends Common.Document
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.PlannedOutageNotification;
                if (null == bucket)
                   cim_data.PlannedOutageNotification = bucket = {};
                bucket[template.id] = template;
            }
            ...
            {
               super.remove (obj, cim_data);
               delete cim_data.PlannedOutageNotification[obj.id];
            }

            parse (context, sub)
            {
                let obj = Common.Document.prototype.parse.call (this, context, sub);
                obj.cls = "PlannedOutageNotification";
                base.parse_attribute (/<cim:PlannedOutageNotification.SwitchingPlan\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "SwitchingPlan", sub, context);
                base.parse_attributes (/<cim:PlannedOutageNotification.Customer\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "Customer", sub, context);
                let bucket = context.parsed.PlannedOutageNotification;
                if (null == bucket)
                   context.parsed.PlannedOutageNotification = bucket = {};
                bucket[obj.id] = obj;
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "PlannedOutageNotification", "SwitchingPlan", "SwitchingPlan", fields);
                base.export_attributes (obj, "PlannedOutageNotification", "Customer", "Customer", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PlannedOutageNotification_collapse" aria-expanded="true" aria-controls="PlannedOutageNotification_collapse" style="margin-left: 10px;">PlannedOutageNotification</a></legend>
                    <div id="PlannedOutageNotification_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Common.Document.prototype.template.call (this) +
                    `
                    {{#SwitchingPlan}}<div><b>SwitchingPlan</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{SwitchingPlan}}");}); return false;'>{{SwitchingPlan}}</a></div>{{/SwitchingPlan}}
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PlannedOutageNotification_collapse" aria-expanded="true" aria-controls="{{id}}_PlannedOutageNotification_collapse" style="margin-left: 10px;">PlannedOutageNotification</a></legend>
                    <div id="{{id}}_PlannedOutageNotification_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Common.Document.prototype.edit_template.call (this) +
                    `
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_SwitchingPlan'>SwitchingPlan: </label><div class='col-sm-8'><input id='{{id}}_SwitchingPlan' class='form-control' type='text'{{#SwitchingPlan}} value='{{SwitchingPlan}}'{{/SwitchingPlan}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_Customer'>Customer: </label><div class='col-sm-8'><input id='{{id}}_Customer' class='form-control' type='text'{{#Customer}} value='{{Customer_string}}'{{/Customer}}></div></div>
                    </div>
                    </fieldset>
                    `
                );
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PlannedOutageNotification" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_SwitchingPlan").value; if ("" !== temp) obj["SwitchingPlan"] = temp;
                temp = document.getElementById (id + "_Customer").value; if ("" !== temp) obj["Customer"] = temp.split (",");
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["SwitchingPlan", "0..1", "0..1", "SwitchingPlan", "PlannedOutageNotification"],
                            ["Customer", "0..*", "0..*", "Customer", "PlannedOutageNotification"]
                        ]
                    )
                );
            }
        ...
        class OutageArea extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                temp = AreaKind[document.getElementById (id + "_outageAreaKind").value]; if (temp) obj["outageAreaKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AreaKind." + temp; else delete obj["outageAreaKind"];
        ...
        class UnplannedOutage extends Outage
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_attributes (/<cim:UnplannedOutage.TroubleOrder\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "TroubleOrder", sub, context);
                base.parse_attributes (/<cim:UnplannedOutage.Incident\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "Incident", sub, context);
            ...
            export (obj, full)
            {
                ...
                base.export_attributes (obj, "UnplannedOutage", "TroubleOrder", "TroubleOrder", fields);
                base.export_attributes (obj, "UnplannedOutage", "Incident", "Incident", fields);
            ...
            template ()
            {
                return (
                    ...
                    {{#TroubleTicket}}<div><b>TroubleTicket</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/TroubleTicket}}
                    {{#TroubleOrder}}<div><b>TroubleOrder</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/TroubleOrder}}
                    {{#Incident}}<div><b>Incident</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/Incident}}
            ...
            condition (obj)
            {
                ...
                if (obj["TroubleTicket"]) obj["TroubleTicket_string"] = obj["TroubleTicket"].join ();
                if (obj["TroubleOrder"]) obj["TroubleOrder_string"] = obj["TroubleOrder"].join ();
                if (obj["Incident"]) obj["Incident_string"] = obj["Incident"].join ();
            }
            ...
            uncondition (obj)
            {
                ...
                delete obj["TroubleTicket_string"];
                delete obj["TroubleOrder_string"];
                delete obj["Incident_string"];
            }
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = document.getElementById (id + "_cause").value; if ("" !== temp) obj["cause"] = temp;
                temp = OutageCauseKind[document.getElementById (id + "_causeKind").value]; if (temp) obj["causeKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#OutageCauseKind." + temp; else delete obj["causeKind"];
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["TroubleOrder", "0..*", "0..1", "TroubleOrder", "UnplannedOutage"],
                            ["Incident", "0..*", "0..1", "Incident", "UnplannedOutage"],
         ...
         *
         */
        class ClampAction extends SwitchingAction
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.ClampAction;
                if (null == bucket)
                   cim_data.ClampAction = bucket = {};
                bucket[template.id] = template;
            }
            ...
            {
               super.remove (obj, cim_data);
               delete cim_data.ClampAction[obj.id];
            }
            ...
            parse (context, sub)
            {
                ...
                obj.cls = "ClampAction";
                base.parse_attribute (/<cim:ClampAction.kind\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "kind", sub, context);
                base.parse_attribute (/<cim:ClampAction.Clamp\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "Clamp", sub, context);
                let bucket = context.parsed.ClampAction;
                if (null == bucket)
                   context.parsed.ClampAction = bucket = {};
                bucket[obj.id] = obj;
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "ClampAction", "kind", "kind", fields);
                base.export_attribute (obj, "ClampAction", "Clamp", "Clamp", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#ClampAction_collapse" aria-expanded="true" aria-controls="ClampAction_collapse" style="margin-left: 10px;">ClampAction</a></legend>
                    <div id="ClampAction_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + SwitchingAction.prototype.template.call (this) +
                    `
                    {{#kind}}<div><b>kind</b>: {{kind}}</div>{{/kind}}
                    {{#Clamp}}<div><b>Clamp</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{Clamp}}");}); return false;'>{{Clamp}}</a></div>{{/Clamp}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_ClampAction_collapse" aria-expanded="true" aria-controls="{{id}}_ClampAction_collapse" style="margin-left: 10px;">ClampAction</a></legend>
                    <div id="{{id}}_ClampAction_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_Clamp'>Clamp: </label><div class='col-sm-8'><input id='{{id}}_Clamp' class='form-control' type='text'{{#Clamp}} value='{{Clamp}}'{{/Clamp}}></div></div>
                    </div>
                    </fieldset>
                    `
                );
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ClampAction" };
                super.submit (id, obj);
                temp = TempEquipActionKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TempEquipActionKind." + temp; else delete obj["kind"];
                temp = document.getElementById (id + "_Clamp").value; if ("" !== temp) obj["Clamp"] = temp;
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["Clamp", "0..1", "0..1", "Clamp", "ClampAction"]
                        ]
                    )
                );
            }
        ...
        class ShuntCompensatorAction extends SwitchingAction
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.ShuntCompensatorAction;
                if (null == bucket)
                   cim_data.ShuntCompensatorAction = bucket = {};
                bucket[template.id] = template;
            }
            ...
            {
               super.remove (obj, cim_data);
               delete cim_data.ShuntCompensatorAction[obj.id];
            }

            parse (context, sub)
            {
                let obj = SwitchingAction.prototype.parse.call (this, context, sub);
                obj.cls = "ShuntCompensatorAction";
                base.parse_attribute (/<cim:ShuntCompensatorAction.kind\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "kind", sub, context);
                base.parse_attribute (/<cim:ShuntCompensatorAction.ShuntCompensator\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "ShuntCompensator", sub, context);
                let bucket = context.parsed.ShuntCompensatorAction;
                if (null == bucket)
                   context.parsed.ShuntCompensatorAction = bucket = {};
                bucket[obj.id] = obj;
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "ShuntCompensatorAction", "kind", "kind", fields);
                base.export_attribute (obj, "ShuntCompensatorAction", "ShuntCompensator", "ShuntCompensator", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#ShuntCompensatorAction_collapse" aria-expanded="true" aria-controls="ShuntCompensatorAction_collapse" style="margin-left: 10px;">ShuntCompensatorAction</a></legend>
                    <div id="ShuntCompensatorAction_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + SwitchingAction.prototype.template.call (this) +
                    `
                    {{#kind}}<div><b>kind</b>: {{kind}}</div>{{/kind}}
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_ShuntCompensatorAction_collapse" aria-expanded="true" aria-controls="{{id}}_ShuntCompensatorAction_collapse" style="margin-left: 10px;">ShuntCompensatorAction</a></legend>
                    <div id="{{id}}_ShuntCompensatorAction_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + SwitchingAction.prototype.edit_template.call (this) +
                    `
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_kind'>kind: </label><div class='col-sm-8'><select id='{{id}}_kind' class='form-control custom-select'>{{#kindTempEquipActionKind}}<option value='{{id}}'{{#selected}} selected{{/selected}}>{{id}}</option>{{/kindTempEquipActionKind}}</select></div></div>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ShuntCompensatorAction" };
                super.submit (id, obj);
                temp = TempEquipActionKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TempEquipActionKind." + temp; else delete obj["kind"];
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["ShuntCompensator", "0..1", "0..1", "ShuntCompensator", "ShuntCompensatorAction"]
                        ]
                    )
                );
            }
        ...
        class SwitchAction extends SwitchingAction
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = SwitchActionKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#SwitchActionKind." + temp; else delete obj["kind"];
         ...
         *
         */
        class EnergyConsumerAction extends SwitchingAction
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.EnergyConsumerAction;
                if (null == bucket)
                   cim_data.EnergyConsumerAction = bucket = {};
                bucket[template.id] = template;
            }
            ...
            {
               super.remove (obj, cim_data);
               delete cim_data.EnergyConsumerAction[obj.id];
            }

            parse (context, sub)
            {
                let obj = SwitchingAction.prototype.parse.call (this, context, sub);
                obj.cls = "EnergyConsumerAction";
                base.parse_attribute (/<cim:EnergyConsumerAction.kind\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "kind", sub, context);
                base.parse_attribute (/<cim:EnergyConsumerAction.EnergyConsumer\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "EnergyConsumer", sub, context);
                let bucket = context.parsed.EnergyConsumerAction;
                if (null == bucket)
                   context.parsed.EnergyConsumerAction = bucket = {};
                bucket[obj.id] = obj;
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "EnergyConsumerAction", "kind", "kind", fields);
                base.export_attribute (obj, "EnergyConsumerAction", "EnergyConsumer", "EnergyConsumer", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#EnergyConsumerAction_collapse" aria-expanded="true" aria-controls="EnergyConsumerAction_collapse" style="margin-left: 10px;">EnergyConsumerAction</a></legend>
                    <div id="EnergyConsumerAction_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + SwitchingAction.prototype.template.call (this) +
                    `
                    {{#kind}}<div><b>kind</b>: {{kind}}</div>{{/kind}}
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_EnergyConsumerAction_collapse" aria-expanded="true" aria-controls="{{id}}_EnergyConsumerAction_collapse" style="margin-left: 10px;">EnergyConsumerAction</a></legend>
                    <div id="{{id}}_EnergyConsumerAction_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + SwitchingAction.prototype.edit_template.call (this) +
                    `
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_kind'>kind: </label><div class='col-sm-8'><select id='{{id}}_kind' class='form-control custom-select'>{{#kindTempEquipActionKind}}<option value='{{id}}'{{#selected}} selected{{/selected}}>{{id}}</option>{{/kindTempEquipActionKind}}</select></div></div>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "EnergyConsumerAction" };
                super.submit (id, obj);
                temp = TempEquipActionKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TempEquipActionKind." + temp; else delete obj["kind"];
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["EnergyConsumer", "0..1", "0..1", "EnergyConsumer", "EnergyConsumerAction"]
                        ]
                    )
                );
            }
        ...
        class TagAction extends SwitchingAction
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = TagActionKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TagActionKind." + temp; else delete obj["kind"];
        ...
        class ClearanceAction extends SwitchingAction
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = ClearanceActionKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ClearanceActionKind." + temp; else delete obj["kind"];
        ...
        class JumperAction extends SwitchingAction
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_attribute (/<cim:JumperAction.Clamp\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "Clamp", sub, context);
                base.parse_attributes (/<cim:JumperAction.JumpedEquipments\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "JumpedEquipments", sub, context);
                base.parse_attributes (/<cim:JumperAction.ACLineSegments\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "ACLineSegments", sub, context);
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "JumperAction", "Clamp", "Clamp", fields);
                base.export_attributes (obj, "JumperAction", "JumpedEquipments", "JumpedEquipments", fields);
                base.export_attributes (obj, "JumperAction", "ACLineSegments", "ACLineSegments", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["Clamp", "0..1", "0..1", "Clamp", "JumperAction"],
                            ["JumpedEquipments", "0..*", "0..1", "ConductingEquipment", "JumpingAction"],
                            ["ACLineSegments", "0..*", "0..1", "ACLineSegment", "LineJumpingAction"]
                        ]
                    )
                );
            }
