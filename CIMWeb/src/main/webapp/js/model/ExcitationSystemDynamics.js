...
(
    ...
    function (base, StandardModels)
    {
         ...
         *
         */
        let ExcIEEEST1AUELselectorKind =
        {
        ...
        class ExcitationSystemDynamics extends StandardModels.DynamicsFunctionBlock
        {
            constructor (template, cim_data)
            {
                ...
                let bucket = cim_data.ExcitationSystemDynamics;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcitationSystemDynamics;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ExcitationSystemDynamics" };
                super.submit (id, obj);
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["VoltageCompensatorDynamics", "1", "1", "VoltageCompensatorDynamics", "ExcitationSystemDynamics"],
        ...
        class ExcAC5A extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcAC5A;
                if (null == bucket)
        ...
        class ExcIEEEDC1A extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEDC1A;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEDC1A;
                if (null == bucket)
        ...
        class ExcST3A extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcST3A;
                if (null == bucket)
        ...
        class ExcREXS extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcREXS;
                if (null == bucket)
            ...
            {
                super.condition (obj);
                obj["fbfExcREXSFeedbackSignalKind"] = [{ id: '', selected: (!obj["fbf"])}]; for (let property in ExcREXSFeedbackSignalKind) obj["fbfExcREXSFeedbackSignalKind"].push ({ id: property, selected: obj["fbf"] && obj["fbf"].endsWith ('.' + property)});
            }

            uncondition (obj)
            {
                super.uncondition (obj);
                delete obj["fbfExcREXSFeedbackSignalKind"];
            }
            ...
            edit_template ()
            {
                return (
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_fbf'>fbf: </label><div class='col-sm-8'><select id='{{id}}_fbf' class='form-control custom-select'>{{#fbfExcREXSFeedbackSignalKind}}<option value='{{id}}'{{#selected}} selected{{/selected}}>{{id}}</option>{{/fbfExcREXSFeedbackSignalKind}}</select></div></div>
        ...
        class ExcIEEEAC7B extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEAC7B;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEAC7B;
                if (null == bucket)
        ...
        class ExcDC2A extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcDC2A;
                if (null == bucket)
        ...
        class ExcAVR5 extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcAVR5;
                if (null == bucket)
        ...
        class ExcIEEEAC1A extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEAC1A;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEAC1A;
                if (null == bucket)
        ...
        class ExcIEEEAC6A extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEAC6A;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEAC6A;
                if (null == bucket)
        ...
        class ExcAVR2 extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcAVR2;
                if (null == bucket)
        ...
        class ExcAVR3 extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcAVR3;
                if (null == bucket)
        ...
        class ExcBBC extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcBBC;
                if (null == bucket)
        ...
        class ExcSCRX extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcSCRX;
                if (null == bucket)
        ...
        class ExcSK extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcSK;
                if (null == bucket)
        ...
        class ExcIEEEST4B extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEST4B;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEST4B;
                if (null == bucket)
        ...
        class ExcIEEEDC4B extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEDC4B;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEDC4B;
                if (null == bucket)
        ...
        class ExcDC3A extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:ExcDC3A.efdmax>([\s\S]*?)<\/cim:ExcDC3A.efdmax>/g, obj, "efdmax", base.to_string, sub, context);
                ...
                let bucket = context.parsed.ExcDC3A;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "ExcDC3A", "efdmax", "efdmax",  base.from_string, fields);
        ...
        class ExcIEEEAC8B extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEAC8B;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEAC8B;
                if (null == bucket)
        ...
        class ExcPIC extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcPIC;
                if (null == bucket)
        ...
        class ExcST4B extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcST4B;
                if (null == bucket)
        ...
        class ExcIEEEST5B extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEST5B;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEST5B;
                if (null == bucket)
        ...
        class ExcAC1A extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcAC1A;
                if (null == bucket)
         ...
         *
         */
        class ExcNI extends ExcitationSystemDynamics
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.ExcNI;
                if (null == bucket)
                   cim_data.ExcNI = bucket = {};
                bucket[template.id] = template;
            }
            ...
            parse (context, sub)
            {
                let obj = ExcitationSystemDynamics.prototype.parse.call (this, context, sub);
                obj.cls = "ExcNI";
                base.parse_element (/<cim:ExcNI.busFedSelector>([\s\S]*?)<\/cim:ExcNI.busFedSelector>/g, obj, "busFedSelector", base.to_boolean, sub, context);
                base.parse_element (/<cim:ExcNI.ka>([\s\S]*?)<\/cim:ExcNI.ka>/g, obj, "ka", base.to_string, sub, context);
                base.parse_element (/<cim:ExcNI.kf>([\s\S]*?)<\/cim:ExcNI.kf>/g, obj, "kf", base.to_string, sub, context);
                base.parse_element (/<cim:ExcNI.r>([\s\S]*?)<\/cim:ExcNI.r>/g, obj, "r", base.to_string, sub, context);
                base.parse_element (/<cim:ExcNI.ta>([\s\S]*?)<\/cim:ExcNI.ta>/g, obj, "ta", base.to_string, sub, context);
                base.parse_element (/<cim:ExcNI.tf1>([\s\S]*?)<\/cim:ExcNI.tf1>/g, obj, "tf1", base.to_string, sub, context);
                base.parse_element (/<cim:ExcNI.tf2>([\s\S]*?)<\/cim:ExcNI.tf2>/g, obj, "tf2", base.to_string, sub, context);
                base.parse_element (/<cim:ExcNI.tr>([\s\S]*?)<\/cim:ExcNI.tr>/g, obj, "tr", base.to_string, sub, context);
                base.parse_element (/<cim:ExcNI.vrmax>([\s\S]*?)<\/cim:ExcNI.vrmax>/g, obj, "vrmax", base.to_string, sub, context);
                base.parse_element (/<cim:ExcNI.vrmin>([\s\S]*?)<\/cim:ExcNI.vrmin>/g, obj, "vrmin", base.to_string, sub, context);
                let bucket = context.parsed.ExcNI;
                if (null == bucket)
                   context.parsed.ExcNI = bucket = {};
                bucket[obj.id] = obj;
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "ExcNI", "busFedSelector", "busFedSelector",  base.from_boolean, fields);
                base.export_element (obj, "ExcNI", "ka", "ka",  base.from_string, fields);
                base.export_element (obj, "ExcNI", "kf", "kf",  base.from_string, fields);
                base.export_element (obj, "ExcNI", "r", "r",  base.from_string, fields);
                base.export_element (obj, "ExcNI", "ta", "ta",  base.from_string, fields);
                base.export_element (obj, "ExcNI", "tf1", "tf1",  base.from_string, fields);
                base.export_element (obj, "ExcNI", "tf2", "tf2",  base.from_string, fields);
                base.export_element (obj, "ExcNI", "tr", "tr",  base.from_string, fields);
                base.export_element (obj, "ExcNI", "vrmax", "vrmax",  base.from_string, fields);
                base.export_element (obj, "ExcNI", "vrmin", "vrmin",  base.from_string, fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#ExcNI_collapse" aria-expanded="true" aria-controls="ExcNI_collapse" style="margin-left: 10px;">ExcNI</a></legend>
                    <div id="ExcNI_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + ExcitationSystemDynamics.prototype.template.call (this) +
                    `
                    {{#busFedSelector}}<div><b>busFedSelector</b>: {{busFedSelector}}</div>{{/busFedSelector}}
                    {{#ka}}<div><b>ka</b>: {{ka}}</div>{{/ka}}
                    {{#kf}}<div><b>kf</b>: {{kf}}</div>{{/kf}}
                    {{#r}}<div><b>r</b>: {{r}}</div>{{/r}}
                    {{#ta}}<div><b>ta</b>: {{ta}}</div>{{/ta}}
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_ExcNI_collapse" aria-expanded="true" aria-controls="{{id}}_ExcNI_collapse" style="margin-left: 10px;">ExcNI</a></legend>
                    <div id="{{id}}_ExcNI_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + ExcitationSystemDynamics.prototype.edit_template.call (this) +
                    `
                    <div class='form-group row'><div class='col-sm-4' for='{{id}}_busFedSelector'>busFedSelector: </div><div class='col-sm-8'><div class='form-check'><input id='{{id}}_busFedSelector' class='form-check-input' type='checkbox'{{#busFedSelector}} checked{{/busFedSelector}}></div></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_ka'>ka: </label><div class='col-sm-8'><input id='{{id}}_ka' class='form-control' type='text'{{#ka}} value='{{ka}}'{{/ka}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_kf'>kf: </label><div class='col-sm-8'><input id='{{id}}_kf' class='form-control' type='text'{{#kf}} value='{{kf}}'{{/kf}}></div></div>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ExcNI" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_busFedSelector").checked; if (temp) obj["busFedSelector"] = true;
                temp = document.getElementById (id + "_ka").value; if ("" !== temp) obj["ka"] = temp;
                temp = document.getElementById (id + "_kf").value; if ("" !== temp) obj["kf"] = temp;
        ...
        class ExcIEEEAC5A extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEAC5A;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEAC5A;
                if (null == bucket)
        ...
        class ExcIEEEDC2A extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEDC2A;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEDC2A;
                if (null == bucket)
         ...
         *
         */
        class ExcRQB extends ExcitationSystemDynamics
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.ExcRQB;
                if (null == bucket)
                   cim_data.ExcRQB = bucket = {};
                bucket[template.id] = template;
            }
            ...
            parse (context, sub)
            {
                let obj = ExcitationSystemDynamics.prototype.parse.call (this, context, sub);
                obj.cls = "ExcRQB";
                base.parse_element (/<cim:ExcRQB.ki0>([\s\S]*?)<\/cim:ExcRQB.ki0>/g, obj, "ki0", base.to_float, sub, context);
                base.parse_element (/<cim:ExcRQB.ki1>([\s\S]*?)<\/cim:ExcRQB.ki1>/g, obj, "ki1", base.to_float, sub, context);
                base.parse_element (/<cim:ExcRQB.klir>([\s\S]*?)<\/cim:ExcRQB.klir>/g, obj, "klir", base.to_float, sub, context);
                base.parse_element (/<cim:ExcRQB.klus>([\s\S]*?)<\/cim:ExcRQB.klus>/g, obj, "klus", base.to_float, sub, context);
                base.parse_element (/<cim:ExcRQB.lsat>([\s\S]*?)<\/cim:ExcRQB.lsat>/g, obj, "lsat", base.to_string, sub, context);
                base.parse_element (/<cim:ExcRQB.lus>([\s\S]*?)<\/cim:ExcRQB.lus>/g, obj, "lus", base.to_string, sub, context);
                base.parse_element (/<cim:ExcRQB.mesu>([\s\S]*?)<\/cim:ExcRQB.mesu>/g, obj, "mesu", base.to_string, sub, context);
                base.parse_element (/<cim:ExcRQB.t4m>([\s\S]*?)<\/cim:ExcRQB.t4m>/g, obj, "t4m", base.to_string, sub, context);
                base.parse_element (/<cim:ExcRQB.tc>([\s\S]*?)<\/cim:ExcRQB.tc>/g, obj, "tc", base.to_string, sub, context);
                base.parse_element (/<cim:ExcRQB.te>([\s\S]*?)<\/cim:ExcRQB.te>/g, obj, "te", base.to_string, sub, context);
                base.parse_element (/<cim:ExcRQB.tf>([\s\S]*?)<\/cim:ExcRQB.tf>/g, obj, "tf", base.to_string, sub, context);
                base.parse_element (/<cim:ExcRQB.ucmax>([\s\S]*?)<\/cim:ExcRQB.ucmax>/g, obj, "ucmax", base.to_string, sub, context);
                base.parse_element (/<cim:ExcRQB.ucmin>([\s\S]*?)<\/cim:ExcRQB.ucmin>/g, obj, "ucmin", base.to_string, sub, context);
                let bucket = context.parsed.ExcRQB;
                if (null == bucket)
                   context.parsed.ExcRQB = bucket = {};
                bucket[obj.id] = obj;
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "ExcRQB", "ki0", "ki0",  base.from_float, fields);
                base.export_element (obj, "ExcRQB", "ki1", "ki1",  base.from_float, fields);
                base.export_element (obj, "ExcRQB", "klir", "klir",  base.from_float, fields);
                base.export_element (obj, "ExcRQB", "klus", "klus",  base.from_float, fields);
                base.export_element (obj, "ExcRQB", "lsat", "lsat",  base.from_string, fields);
                base.export_element (obj, "ExcRQB", "lus", "lus",  base.from_string, fields);
                base.export_element (obj, "ExcRQB", "mesu", "mesu",  base.from_string, fields);
                base.export_element (obj, "ExcRQB", "t4m", "t4m",  base.from_string, fields);
                base.export_element (obj, "ExcRQB", "tc", "tc",  base.from_string, fields);
                base.export_element (obj, "ExcRQB", "te", "te",  base.from_string, fields);
                base.export_element (obj, "ExcRQB", "tf", "tf",  base.from_string, fields);
                base.export_element (obj, "ExcRQB", "ucmax", "ucmax",  base.from_string, fields);
                base.export_element (obj, "ExcRQB", "ucmin", "ucmin",  base.from_string, fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#ExcRQB_collapse" aria-expanded="true" aria-controls="ExcRQB_collapse" style="margin-left: 10px;">ExcRQB</a></legend>
                    <div id="ExcRQB_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + ExcitationSystemDynamics.prototype.template.call (this) +
                    `
                    {{#ki0}}<div><b>ki0</b>: {{ki0}}</div>{{/ki0}}
                    {{#ki1}}<div><b>ki1</b>: {{ki1}}</div>{{/ki1}}
                    {{#klir}}<div><b>klir</b>: {{klir}}</div>{{/klir}}
                    {{#klus}}<div><b>klus</b>: {{klus}}</div>{{/klus}}
                    {{#lsat}}<div><b>lsat</b>: {{lsat}}</div>{{/lsat}}
                    {{#lus}}<div><b>lus</b>: {{lus}}</div>{{/lus}}
                    {{#mesu}}<div><b>mesu</b>: {{mesu}}</div>{{/mesu}}
                    {{#t4m}}<div><b>t4m</b>: {{t4m}}</div>{{/t4m}}
                    {{#tc}}<div><b>tc</b>: {{tc}}</div>{{/tc}}
                    {{#te}}<div><b>te</b>: {{te}}</div>{{/te}}
                    {{#tf}}<div><b>tf</b>: {{tf}}</div>{{/tf}}
                    {{#ucmax}}<div><b>ucmax</b>: {{ucmax}}</div>{{/ucmax}}
                    {{#ucmin}}<div><b>ucmin</b>: {{ucmin}}</div>{{/ucmin}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_ExcRQB_collapse" aria-expanded="true" aria-controls="{{id}}_ExcRQB_collapse" style="margin-left: 10px;">ExcRQB</a></legend>
                    <div id="{{id}}_ExcRQB_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + ExcitationSystemDynamics.prototype.edit_template.call (this) +
                    `
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_ki0'>ki0: </label><div class='col-sm-8'><input id='{{id}}_ki0' class='form-control' type='text'{{#ki0}} value='{{ki0}}'{{/ki0}}></div></div>
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_klir'>klir: </label><div class='col-sm-8'><input id='{{id}}_klir' class='form-control' type='text'{{#klir}} value='{{klir}}'{{/klir}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_klus'>klus: </label><div class='col-sm-8'><input id='{{id}}_klus' class='form-control' type='text'{{#klus}} value='{{klus}}'{{/klus}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_lsat'>lsat: </label><div class='col-sm-8'><input id='{{id}}_lsat' class='form-control' type='text'{{#lsat}} value='{{lsat}}'{{/lsat}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_lus'>lus: </label><div class='col-sm-8'><input id='{{id}}_lus' class='form-control' type='text'{{#lus}} value='{{lus}}'{{/lus}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_mesu'>mesu: </label><div class='col-sm-8'><input id='{{id}}_mesu' class='form-control' type='text'{{#mesu}} value='{{mesu}}'{{/mesu}}></div></div>
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_te'>te: </label><div class='col-sm-8'><input id='{{id}}_te' class='form-control' type='text'{{#te}} value='{{te}}'{{/te}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_tf'>tf: </label><div class='col-sm-8'><input id='{{id}}_tf' class='form-control' type='text'{{#tf}} value='{{tf}}'{{/tf}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_ucmax'>ucmax: </label><div class='col-sm-8'><input id='{{id}}_ucmax' class='form-control' type='text'{{#ucmax}} value='{{ucmax}}'{{/ucmax}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_ucmin'>ucmin: </label><div class='col-sm-8'><input id='{{id}}_ucmin' class='form-control' type='text'{{#ucmin}} value='{{ucmin}}'{{/ucmin}}></div></div>
                    </div>
                    </fieldset>
                    `
                );
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ExcRQB" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_ki0").value; if ("" !== temp) obj["ki0"] = temp;
                temp = document.getElementById (id + "_ki1").value; if ("" !== temp) obj["ki1"] = temp;
                temp = document.getElementById (id + "_klir").value; if ("" !== temp) obj["klir"] = temp;
                temp = document.getElementById (id + "_klus").value; if ("" !== temp) obj["klus"] = temp;
                temp = document.getElementById (id + "_lsat").value; if ("" !== temp) obj["lsat"] = temp;
                temp = document.getElementById (id + "_lus").value; if ("" !== temp) obj["lus"] = temp;
                temp = document.getElementById (id + "_mesu").value; if ("" !== temp) obj["mesu"] = temp;
                temp = document.getElementById (id + "_t4m").value; if ("" !== temp) obj["t4m"] = temp;
                temp = document.getElementById (id + "_tc").value; if ("" !== temp) obj["tc"] = temp;
                temp = document.getElementById (id + "_te").value; if ("" !== temp) obj["te"] = temp;
                temp = document.getElementById (id + "_tf").value; if ("" !== temp) obj["tf"] = temp;
                temp = document.getElementById (id + "_ucmax").value; if ("" !== temp) obj["ucmax"] = temp;
                temp = document.getElementById (id + "_ucmin").value; if ("" !== temp) obj["ucmin"] = temp;
        ...
        class ExcDC1A extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:ExcDC1A.efdmax>([\s\S]*?)<\/cim:ExcDC1A.efdmax>/g, obj, "efdmax", base.to_string, sub, context);
                ...
                let bucket = context.parsed.ExcDC1A;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "ExcDC1A", "efdmax", "efdmax",  base.from_string, fields);
        ...
        class ExcAVR4 extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcAVR4;
                if (null == bucket)
        ...
        class ExcST2A extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcST2A;
                if (null == bucket)
        ...
        class ExcAC6A extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcAC6A;
                if (null == bucket)
        ...
        class ExcIEEEST1A extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEST1A;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEST1A;
                if (null == bucket)
            ...
            {
                super.condition (obj);
                obj["uelinExcIEEEST1AUELselectorKind"] = [{ id: '', selected: (!obj["uelin"])}]; for (let property in ExcIEEEST1AUELselectorKind) obj["uelinExcIEEEST1AUELselectorKind"].push ({ id: property, selected: obj["uelin"] && obj["uelin"].endsWith ('.' + property)});
            }

            uncondition (obj)
            {
                super.uncondition (obj);
                delete obj["uelinExcIEEEST1AUELselectorKind"];
            }
            ...
            edit_template ()
            {
                return (
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_tc1'>tc1: </label><div class='col-sm-8'><input id='{{id}}_tc1' class='form-control' type='text'{{#tc1}} value='{{tc1}}'{{/tc1}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_tf'>tf: </label><div class='col-sm-8'><input id='{{id}}_tf' class='form-control' type='text'{{#tf}} value='{{tf}}'{{/tf}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_uelin'>uelin: </label><div class='col-sm-8'><select id='{{id}}_uelin' class='form-control custom-select'>{{#uelinExcIEEEST1AUELselectorKind}}<option value='{{id}}'{{#selected}} selected{{/selected}}>{{id}}</option>{{/uelinExcIEEEST1AUELselectorKind}}</select></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_vamax'>vamax: </label><div class='col-sm-8'><input id='{{id}}_vamax' class='form-control' type='text'{{#vamax}} value='{{vamax}}'{{/vamax}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_vamin'>vamin: </label><div class='col-sm-8'><input id='{{id}}_vamin' class='form-control' type='text'{{#vamin}} value='{{vamin}}'{{/vamin}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_vimax'>vimax: </label><div class='col-sm-8'><input id='{{id}}_vimax' class='form-control' type='text'{{#vimax}} value='{{vimax}}'{{/vimax}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_vimin'>vimin: </label><div class='col-sm-8'><input id='{{id}}_vimin' class='form-control' type='text'{{#vimin}} value='{{vimin}}'{{/vimin}}></div></div>
        ...
        class ExcAC3A extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcAC3A;
                if (null == bucket)
        ...
        class ExcIEEEAC2A extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEAC2A;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEAC2A;
                if (null == bucket)
        ...
        class ExcANS extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcANS;
                if (null == bucket)
        ...
        class ExcST1A extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcST1A;
                if (null == bucket)
        ...
        class ExcIEEEST6B extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEST6B;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEST6B;
                if (null == bucket)
            ...
            {
                super.condition (obj);
                obj["oelinExcST6BOELselectorKind"] = [{ id: '', selected: (!obj["oelin"])}]; for (let property in ExcST6BOELselectorKind) obj["oelinExcST6BOELselectorKind"].push ({ id: property, selected: obj["oelin"] && obj["oelin"].endsWith ('.' + property)});
            }

            uncondition (obj)
            {
                super.uncondition (obj);
                delete obj["oelinExcST6BOELselectorKind"];
            }
            ...
            edit_template ()
            {
                return (
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_km'>km: </label><div class='col-sm-8'><input id='{{id}}_km' class='form-control' type='text'{{#km}} value='{{km}}'{{/km}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_kpa'>kpa: </label><div class='col-sm-8'><input id='{{id}}_kpa' class='form-control' type='text'{{#kpa}} value='{{kpa}}'{{/kpa}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_oelin'>oelin: </label><div class='col-sm-8'><select id='{{id}}_oelin' class='form-control custom-select'>{{#oelinExcST6BOELselectorKind}}<option value='{{id}}'{{#selected}} selected{{/selected}}>{{id}}</option>{{/oelinExcST6BOELselectorKind}}</select></div></div>
        ...
        class ExcAVR1 extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcAVR1;
                if (null == bucket)
        ...
        class ExcCZ extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcCZ;
                if (null == bucket)
        ...
        class ExcIEEEAC4A extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEAC4A;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEAC4A;
                if (null == bucket)
        ...
        class ExcIEEEDC3A extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEDC3A;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEDC3A;
                if (null == bucket)
        ...
        class ExcAC4A extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcAC4A;
                if (null == bucket)
        ...
        class ExcAVR7 extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcAVR7;
                if (null == bucket)
        ...
        class ExcSEXS extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcSEXS;
                if (null == bucket)
        ...
        class ExcOEX3T extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcOEX3T;
                if (null == bucket)
        ...
        class ExcST6B extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcST6B;
                if (null == bucket)
        ...
        class ExcDC3A1 extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcDC3A1;
                if (null == bucket)
        ...
        class ExcIEEEST2A extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEST2A;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEST2A;
                if (null == bucket)
        ...
        class ExcIEEEST7B extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEST7B;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEST7B;
                if (null == bucket)
            ...
            {
                super.condition (obj);
                obj["oelinExcST7BOELselectorKind"] = [{ id: '', selected: (!obj["oelin"])}]; for (let property in ExcST7BOELselectorKind) obj["oelinExcST7BOELselectorKind"].push ({ id: property, selected: obj["oelin"] && obj["oelin"].endsWith ('.' + property)});
                obj["uelinExcST7BUELselectorKind"] = [{ id: '', selected: (!obj["uelin"])}]; for (let property in ExcST7BUELselectorKind) obj["uelinExcST7BUELselectorKind"].push ({ id: property, selected: obj["uelin"] && obj["uelin"].endsWith ('.' + property)});
            }

            uncondition (obj)
            {
                super.uncondition (obj);
                delete obj["oelinExcST7BOELselectorKind"];
                delete obj["uelinExcST7BUELselectorKind"];
            }
            ...
            edit_template ()
            {
                return (
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_kl'>kl: </label><div class='col-sm-8'><input id='{{id}}_kl' class='form-control' type='text'{{#kl}} value='{{kl}}'{{/kl}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_kpa'>kpa: </label><div class='col-sm-8'><input id='{{id}}_kpa' class='form-control' type='text'{{#kpa}} value='{{kpa}}'{{/kpa}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_oelin'>oelin: </label><div class='col-sm-8'><select id='{{id}}_oelin' class='form-control custom-select'>{{#oelinExcST7BOELselectorKind}}<option value='{{id}}'{{#selected}} selected{{/selected}}>{{id}}</option>{{/oelinExcST7BOELselectorKind}}</select></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_tb'>tb: </label><div class='col-sm-8'><input id='{{id}}_tb' class='form-control' type='text'{{#tb}} value='{{tb}}'{{/tb}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_tc'>tc: </label><div class='col-sm-8'><input id='{{id}}_tc' class='form-control' type='text'{{#tc}} value='{{tc}}'{{/tc}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_tf'>tf: </label><div class='col-sm-8'><input id='{{id}}_tf' class='form-control' type='text'{{#tf}} value='{{tf}}'{{/tf}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_tg'>tg: </label><div class='col-sm-8'><input id='{{id}}_tg' class='form-control' type='text'{{#tg}} value='{{tg}}'{{/tg}}></div></div>
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_uelin'>uelin: </label><div class='col-sm-8'><select id='{{id}}_uelin' class='form-control custom-select'>{{#uelinExcST7BUELselectorKind}}<option value='{{id}}'{{#selected}} selected{{/selected}}>{{id}}</option>{{/uelinExcST7BUELselectorKind}}</select></div></div>
        ...
        class ExcELIN1 extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcELIN1;
                if (null == bucket)
        ...
        class ExcIEEEAC3A extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEAC3A;
                if (null == bucket)
        ...
        class ExcIEEEST3A extends ExcitationSystemDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExcIEEEST3A;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcIEEEST3A;
                if (null == bucket)
        ...
        class ExcST7B extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcST7B;
                if (null == bucket)
        ...
        class ExcAC2A extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcAC2A;
                if (null == bucket)
        ...
        class ExcHU extends ExcitationSystemDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExcHU;
                if (null == bucket)
