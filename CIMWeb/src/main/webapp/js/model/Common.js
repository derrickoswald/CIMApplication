    ...
    function (base, Core)
    {
        ...
        class FieldDispatchStep extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = CrewStatusKind[document.getElementById (id + "_dispatchStatus").value]; if (temp) obj["dispatchStatus"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#CrewStatusKind." + temp; else delete obj["dispatchStatus"];
                temp = document.getElementById (id + "_sequenceNumber").value; if ("" !== temp) obj["sequenceNumber"] = temp;
