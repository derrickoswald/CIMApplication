...
(
    ...
    function (base, Core, StandardModels)
    {
         ...
         *
         */
        let WindLookupTableFunctionKind =
        {
            "prr": "prr",
            "omegap": "omegap",
            "ipmax": "ipmax",
        ...
        class WindMechIEC extends Core.IdentifiedObject
        {
            constructor (template, cim_data)
            {
                ...
                let bucket = cim_data.WindMechIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindMechIEC;
                if (null == bucket)
        ...
        class WindAeroConstIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindAeroConstIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindAeroConstIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindAeroConstIEC" };
                super.submit (id, obj);
        ...
        class WindContCurrLimIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindContCurrLimIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindContCurrLimIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindContCurrLimIEC" };
                super.submit (id, obj);
        ...
        class WindGenType4IEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindGenType4IEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindGenType4IEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindGenType4IEC" };
                super.submit (id, obj);
        ...
        class WindContPitchAngleIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindContPitchAngleIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindContPitchAngleIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindContPitchAngleIEC" };
                super.submit (id, obj);
        ...
        class WindContPType4aIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindContPType4aIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindContPType4aIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindContPType4aIEC" };
                super.submit (id, obj);
        ...
        class WindProtectionIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindProtectionIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindProtectionIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindProtectionIEC" };
                super.submit (id, obj);
        ...
        class WindAeroTwoDimIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindAeroTwoDimIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindAeroTwoDimIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindAeroTwoDimIEC" };
                super.submit (id, obj);
        ...
        class WindContPType3IEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindContPType3IEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:WindContPType3IEC.omegadtd>([\s\S]*?)<\/cim:WindContPType3IEC.omegadtd>/g, obj, "omegadtd", base.to_string, sub, context);
                ...
                base.parse_element (/<cim:WindContPType3IEC.tomegaref>([\s\S]*?)<\/cim:WindContPType3IEC.tomegaref>/g, obj, "tomegaref", base.to_string, sub, context);
                ...
                let bucket = context.parsed.WindContPType3IEC;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "WindContPType3IEC", "omegadtd", "omegadtd",  base.from_string, fields);
                ...
                base.export_element (obj, "WindContPType3IEC", "tomegaref", "tomegaref",  base.from_string, fields);
            ...
            template ()
            {
                return (
                    ...
                    {{#omegadtd}}<div><b>omegadtd</b>: {{omegadtd}}</div>{{/omegadtd}}
                    ...
                    {{#tomegaref}}<div><b>tomegaref</b>: {{tomegaref}}</div>{{/tomegaref}}
            ...
            edit_template ()
            {
                return (
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_omegadtd'>omegadtd: </label><div class='col-sm-8'><input id='{{id}}_omegadtd' class='form-control' type='text'{{#omegadtd}} value='{{omegadtd}}'{{/omegadtd}}></div></div>
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_tomegaref'>tomegaref: </label><div class='col-sm-8'><input id='{{id}}_tomegaref' class='form-control' type='text'{{#tomegaref}} value='{{tomegaref}}'{{/tomegaref}}></div></div>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindContPType3IEC" };
                super.submit (id, obj);
                ...
                temp = document.getElementById (id + "_omegadtd").value; if ("" !== temp) obj["omegadtd"] = temp;
                ...
                temp = document.getElementById (id + "_tomegaref").value; if ("" !== temp) obj["tomegaref"] = temp;
        ...
        class WindPlantDynamics extends StandardModels.DynamicsFunctionBlock
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindPlantDynamics;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindPlantDynamics;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindPlantDynamics" };
                super.submit (id, obj);
        ...
        class WindGenType3IEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindGenType3IEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindGenType3IEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindGenType3IEC" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_dipmax").value; if ("" !== temp) obj["dipmax"] = temp;
                temp = document.getElementById (id + "_diqmax").value; if ("" !== temp) obj["diqmax"] = temp;
        ...
        class WindContQPQULimIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindContQPQULimIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindContQPQULimIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindContQPQULimIEC" };
                super.submit (id, obj);
        ...
        class WindPlantReactiveControlIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindPlantReactiveControlIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindPlantReactiveControlIEC;
                if (null == bucket)
            ...
            {
                super.condition (obj);
                obj["windPlantQcontrolModesTypeWindPlantQcontrolModeKind"] = [{ id: '', selected: (!obj["windPlantQcontrolModesType"])}]; for (let property in WindPlantQcontrolModeKind) obj["windPlantQcontrolModesTypeWindPlantQcontrolModeKind"].push ({ id: property, selected: obj["windPlantQcontrolModesType"] && obj["windPlantQcontrolModesType"].endsWith ('.' + property)});
                if (obj["WindDynamicsLookupTable"]) obj["WindDynamicsLookupTable_string"] = obj["WindDynamicsLookupTable"].join ();
            }
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindPlantReactiveControlIEC" };
                super.submit (id, obj);
        ...
        class WindContQLimIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindContQLimIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindContQLimIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindContQLimIEC" };
                super.submit (id, obj);
        ...
        class WindAeroOneDimIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindAeroOneDimIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindAeroOneDimIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindAeroOneDimIEC" };
                super.submit (id, obj);
        ...
        class WindContRotorRIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindContRotorRIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindContRotorRIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindContRotorRIEC" };
                super.submit (id, obj);
        ...
        class WindPlantFreqPcontrolIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindPlantFreqPcontrolIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindPlantFreqPcontrolIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindPlantFreqPcontrolIEC" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_dprefmax").value; if ("" !== temp) obj["dprefmax"] = temp;
                temp = document.getElementById (id + "_dprefmin").value; if ("" !== temp) obj["dprefmin"] = temp;
        ...
        class WindRefFrameRotIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindRefFrameRotIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindRefFrameRotIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindRefFrameRotIEC" };
                super.submit (id, obj);
        ...
        class WindTurbineType1or2Dynamics extends StandardModels.DynamicsFunctionBlock
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindTurbineType1or2Dynamics;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindTurbineType1or2Dynamics;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindTurbineType1or2Dynamics" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_RemoteInputSignal").value; if ("" !== temp) obj["RemoteInputSignal"] = temp;
        ...
        class WindPitchContPowerIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindPitchContPowerIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindPitchContPowerIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindPitchContPowerIEC" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_dpmax").value; if ("" !== temp) obj["dpmax"] = temp;
        ...
        class WindContQIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindContQIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindContQIEC;
                if (null == bucket)
            ...
            {
                super.condition (obj);
                obj["windQcontrolModesTypeWindQcontrolModeKind"] = [{ id: '', selected: (!obj["windQcontrolModesType"])}]; for (let property in WindQcontrolModeKind) obj["windQcontrolModesTypeWindQcontrolModeKind"].push ({ id: property, selected: obj["windQcontrolModesType"] && obj["windQcontrolModesType"].endsWith ('.' + property)});
                obj["windUVRTQcontrolModesTypeWindUVRTQcontrolModeKind"] = [{ id: '', selected: (!obj["windUVRTQcontrolModesType"])}]; for (let property in WindUVRTQcontrolModeKind) obj["windUVRTQcontrolModesTypeWindUVRTQcontrolModeKind"].push ({ id: property, selected: obj["windUVRTQcontrolModesType"] && obj["windUVRTQcontrolModesType"].endsWith ('.' + property)});
            }
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindContQIEC" };
                super.submit (id, obj);
        ...
        class WindTurbineType3or4Dynamics extends StandardModels.DynamicsFunctionBlock
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindTurbineType3or4Dynamics;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_attribute (/<cim:WindTurbineType3or4Dynamics.PowerElectronicsConnection\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "PowerElectronicsConnection", sub, context);
                ...
                let bucket = context.parsed.WindTurbineType3or4Dynamics;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "WindTurbineType3or4Dynamics", "PowerElectronicsConnection", "PowerElectronicsConnection", fields);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindTurbineType3or4Dynamics" };
                super.submit (id, obj);
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["PowerElectronicsConnection", "1", "0..1", "PowerElectronicsConnection", "WindTurbineType3or4Dynamics"],
        ...
        class WindDynamicsLookupTable extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindDynamicsLookupTable;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindDynamicsLookupTable;
                if (null == bucket)
            ...
            {
                super.condition (obj);
                obj["lookupTableFunctionTypeWindLookupTableFunctionKind"] = [{ id: '', selected: (!obj["lookupTableFunctionType"])}]; for (let property in WindLookupTableFunctionKind) obj["lookupTableFunctionTypeWindLookupTableFunctionKind"].push ({ id: property, selected: obj["lookupTableFunctionType"] && obj["lookupTableFunctionType"].endsWith ('.' + property)});
            }
        ...
        class WindContPType4bIEC extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindContPType4bIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindContPType4bIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindContPType4bIEC" };
                super.submit (id, obj);
        ...
        class WindPlantIEC extends WindPlantDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindPlantIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = WindPlantDynamics.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.WindPlantIEC;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = WindPlantDynamics.prototype.export.call (this, obj, false);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindPlantIEC" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_WindPlantFreqPcontrolIEC").value; if ("" !== temp) obj["WindPlantFreqPcontrolIEC"] = temp;
                temp = document.getElementById (id + "_WindPlantReactiveControlIEC").value; if ("" !== temp) obj["WindPlantReactiveControlIEC"] = temp;
        ...
        class WindGenType3bIEC extends WindGenType3IEC
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindGenType3bIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = WindGenType3IEC.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.WindGenType3bIEC;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = WindGenType3IEC.prototype.export.call (this, obj, false);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindGenType3bIEC" };
                super.submit (id, obj);
        ...
        class WindGenType3aIEC extends WindGenType3IEC
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindGenType3aIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindGenType3aIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindGenType3aIEC" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_kpc").value; if ("" !== temp) obj["kpc"] = temp;
        ...
        class WindTurbineType1or2IEC extends WindTurbineType1or2Dynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindTurbineType1or2IEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = WindTurbineType1or2Dynamics.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.WindTurbineType1or2IEC;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = WindTurbineType1or2Dynamics.prototype.export.call (this, obj, false);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindTurbineType1or2IEC" };
                super.submit (id, obj);
        ...
        class WindGenTurbineType1aIEC extends WindTurbineType1or2IEC
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindGenTurbineType1aIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = WindTurbineType1or2IEC.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.WindGenTurbineType1aIEC;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = WindTurbineType1or2IEC.prototype.export.call (this, obj, false);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindGenTurbineType1aIEC" };
                super.submit (id, obj);
        ...
        class WindGenTurbineType2IEC extends WindTurbineType1or2IEC
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindGenTurbineType2IEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindGenTurbineType2IEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindGenTurbineType2IEC" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_WindPitchContPowerIEC").value; if ("" !== temp) obj["WindPitchContPowerIEC"] = temp;
                temp = document.getElementById (id + "_WindContRotorRIEC").value; if ("" !== temp) obj["WindContRotorRIEC"] = temp;
        ...
        class WindGenTurbineType1bIEC extends WindTurbineType1or2IEC
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindGenTurbineType1bIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindGenTurbineType1bIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindGenTurbineType1bIEC" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_WindPitchContPowerIEC").value; if ("" !== temp) obj["WindPitchContPowerIEC"] = temp;
        ...
        class WindTurbineType3or4IEC extends WindTurbineType3or4Dynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindTurbineType3or4IEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = WindTurbineType3or4Dynamics.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.WindTurbineType3or4IEC;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = WindTurbineType3or4Dynamics.prototype.export.call (this, obj, false);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindTurbineType3or4IEC" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_WindContCurrLimIEC").value; if ("" !== temp) obj["WindContCurrLimIEC"] = temp;
        ...
        class WindTurbineType4IEC extends WindTurbineType3or4IEC
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindTurbineType4IEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = WindTurbineType3or4IEC.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.WindTurbineType4IEC;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = WindTurbineType3or4IEC.prototype.export.call (this, obj, false);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindTurbineType4IEC" };
                super.submit (id, obj);
        ...
        class WindTurbineType4bIEC extends WindTurbineType4IEC
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindTurbineType4bIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = WindTurbineType4IEC.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.WindTurbineType4bIEC;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = WindTurbineType4IEC.prototype.export.call (this, obj, false);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindTurbineType4bIEC" };
                super.submit (id, obj);
        ...
        class WindTurbineType3IEC extends WindTurbineType3or4IEC
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindTurbineType3IEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindTurbineType3IEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindTurbineType3IEC" };
                super.submit (id, obj);
        ...
        class WindTurbineType4aIEC extends WindTurbineType4IEC
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.WindTurbineType4aIEC;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.WindTurbineType4aIEC;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "WindTurbineType4aIEC" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_WindGenType4IEC").value; if ("" !== temp) obj["WindGenType4IEC"] = temp;
