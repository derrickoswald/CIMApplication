    ...
    function (base, Common, Core, ExternalInputs, MarketPlan, MktDomain)
    {
        ...
        class PriceDescriptor extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                temp = MktDomain.PriceTypeKind[document.getElementById (id + "_priceType").value]; if (temp) obj["priceType"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#PriceTypeKind." + temp; else delete obj["priceType"];
