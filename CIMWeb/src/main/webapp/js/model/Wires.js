...
(
    ...
    function (base, Core, Domain, LoadModel)
    {
         ...
         *
         */
        let SynchronousMachineOperatingMode =
        {
            "generator": "generator",
            "condenser": "condenser",
            "motor": "motor"
        ...
        class Conductor extends Core.ConductingEquipment
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.Conductor;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Conductor_collapse" aria-expanded="true" aria-controls="Conductor_collapse" style="margin-left: 10px;">Conductor</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Conductor_collapse" aria-expanded="true" aria-controls="{{id}}_Conductor_collapse" style="margin-left: 10px;">Conductor</a></legend>
        ...
        class TransformerTank extends Core.Equipment
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.TransformerTank;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.TransformerTank;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#TransformerTank_collapse" aria-expanded="true" aria-controls="TransformerTank_collapse" style="margin-left: 10px;">TransformerTank</a></legend>
                    ...
                    {{#PowerTransformer}}<div><b>PowerTransformer</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{PowerTransformer}}");}); return false;'>{{PowerTransformer}}</a></div>{{/PowerTransformer}}
                    {{#TransformerTankEnds}}<div><b>TransformerTankEnds</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/TransformerTankEnds}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_TransformerTank_collapse" aria-expanded="true" aria-controls="{{id}}_TransformerTank_collapse" style="margin-left: 10px;">TransformerTank</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "TransformerTank" };
                super.submit (id, obj);
        ...
        class NonlinearShuntCompensatorPoint extends base.Element
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.NonlinearShuntCompensatorPoint;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.NonlinearShuntCompensatorPoint;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#NonlinearShuntCompensatorPoint_collapse" aria-expanded="true" aria-controls="NonlinearShuntCompensatorPoint_collapse" style="margin-left: 10px;">NonlinearShuntCompensatorPoint</a></legend>
                    ...
                    {{#NonlinearShuntCompensator}}<div><b>NonlinearShuntCompensator</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{NonlinearShuntCompensator}}");}); return false;'>{{NonlinearShuntCompensator}}</a></div>{{/NonlinearShuntCompensator}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_NonlinearShuntCompensatorPoint_collapse" aria-expanded="true" aria-controls="{{id}}_NonlinearShuntCompensatorPoint_collapse" style="margin-left: 10px;">NonlinearShuntCompensatorPoint</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "NonlinearShuntCompensatorPoint" };
                super.submit (id, obj);
        ...
        class CompositeSwitch extends Core.Equipment
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.CompositeSwitch;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.CompositeSwitch;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#CompositeSwitch_collapse" aria-expanded="true" aria-controls="CompositeSwitch_collapse" style="margin-left: 10px;">CompositeSwitch</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_CompositeSwitch_collapse" aria-expanded="true" aria-controls="{{id}}_CompositeSwitch_collapse" style="margin-left: 10px;">CompositeSwitch</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "CompositeSwitch" };
                super.submit (id, obj);
        ...
        class SeriesCompensator extends Core.ConductingEquipment
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.SeriesCompensator;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.SeriesCompensator;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#SeriesCompensator_collapse" aria-expanded="true" aria-controls="SeriesCompensator_collapse" style="margin-left: 10px;">SeriesCompensator</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_SeriesCompensator_collapse" aria-expanded="true" aria-controls="{{id}}_SeriesCompensator_collapse" style="margin-left: 10px;">SeriesCompensator</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "SeriesCompensator" };
                super.submit (id, obj);
        ...
        class TapSchedule extends LoadModel.SeasonDayTypeSchedule
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.TapSchedule;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = LoadModel.SeasonDayTypeSchedule.prototype.parse.call (this, context, sub);
                obj.cls = "TapSchedule";
                base.parse_attribute (/<cim:TapSchedule.TapChanger\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "TapChanger", sub, context);
                let bucket = context.parsed.TapSchedule;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = LoadModel.SeasonDayTypeSchedule.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#TapSchedule_collapse" aria-expanded="true" aria-controls="TapSchedule_collapse" style="margin-left: 10px;">TapSchedule</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_TapSchedule_collapse" aria-expanded="true" aria-controls="{{id}}_TapSchedule_collapse" style="margin-left: 10px;">TapSchedule</a></legend>
        ...
        class RegulationSchedule extends LoadModel.SeasonDayTypeSchedule
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.RegulationSchedule;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.RegulationSchedule;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#RegulationSchedule_collapse" aria-expanded="true" aria-controls="RegulationSchedule_collapse" style="margin-left: 10px;">RegulationSchedule</a></legend>
                    ...
                    {{#VoltageControlZones}}<div><b>VoltageControlZones</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/VoltageControlZones}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_RegulationSchedule_collapse" aria-expanded="true" aria-controls="{{id}}_RegulationSchedule_collapse" style="margin-left: 10px;">RegulationSchedule</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "RegulationSchedule" };
                super.submit (id, obj);
        ...
        class TapChanger extends Core.PowerSystemResource
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.TapChanger;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.TapChanger;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#TapChanger_collapse" aria-expanded="true" aria-controls="TapChanger_collapse" style="margin-left: 10px;">TapChanger</a></legend>
                    ...
                    {{#TapChangerControl}}<div><b>TapChangerControl</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{TapChangerControl}}");}); return false;'>{{TapChangerControl}}</a></div>{{/TapChangerControl}}
                    {{#SvTapStep}}<div><b>SvTapStep</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{SvTapStep}}");}); return false;'>{{SvTapStep}}</a></div>{{/SvTapStep}}
                    {{#TapSchedules}}<div><b>TapSchedules</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/TapSchedules}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_TapChanger_collapse" aria-expanded="true" aria-controls="{{id}}_TapChanger_collapse" style="margin-left: 10px;">TapChanger</a></legend>
        ...
        class TransformerStarImpedance extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.TransformerStarImpedance;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.TransformerStarImpedance;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#TransformerStarImpedance_collapse" aria-expanded="true" aria-controls="TransformerStarImpedance_collapse" style="margin-left: 10px;">TransformerStarImpedance</a></legend>
                    ...
                    {{#x}}<div><b>x</b>: {{x}}</div>{{/x}}
                    {{#x0}}<div><b>x0</b>: {{x0}}</div>{{/x0}}
                    {{#TransformerEndInfo}}<div><b>TransformerEndInfo</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{TransformerEndInfo}}");}); return false;'>{{TransformerEndInfo}}</a></div>{{/TransformerEndInfo}}
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_TransformerStarImpedance_collapse" aria-expanded="true" aria-controls="{{id}}_TransformerStarImpedance_collapse" style="margin-left: 10px;">TransformerStarImpedance</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "TransformerStarImpedance" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_r").value; if ("" !== temp) obj["r"] = temp;
                temp = document.getElementById (id + "_r0").value; if ("" !== temp) obj["r0"] = temp;
                temp = document.getElementById (id + "_x").value; if ("" !== temp) obj["x"] = temp;
        ...
        class ACLineSegmentPhase extends Core.PowerSystemResource
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ACLineSegmentPhase;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#ACLineSegmentPhase_collapse" aria-expanded="true" aria-controls="ACLineSegmentPhase_collapse" style="margin-left: 10px;">ACLineSegmentPhase</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_ACLineSegmentPhase_collapse" aria-expanded="true" aria-controls="{{id}}_ACLineSegmentPhase_collapse" style="margin-left: 10px;">ACLineSegmentPhase</a></legend>
         ...
         *
         */
        class PowerElectronicsConnectionPhase extends Core.PowerSystemResource
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.PowerElectronicsConnectionPhase;
                if (null == bucket)
                   cim_data.PowerElectronicsConnectionPhase = bucket = {};
                bucket[template.id] = template;
            }
            ...
            {
               super.remove (obj, cim_data);
               delete cim_data.PowerElectronicsConnectionPhase[obj.id];
            }

            parse (context, sub)
            {
                let obj = Core.PowerSystemResource.prototype.parse.call (this, context, sub);
                obj.cls = "PowerElectronicsConnectionPhase";
                base.parse_element (/<cim:PowerElectronicsConnectionPhase.p>([\s\S]*?)<\/cim:PowerElectronicsConnectionPhase.p>/g, obj, "p", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnectionPhase.q>([\s\S]*?)<\/cim:PowerElectronicsConnectionPhase.q>/g, obj, "q", base.to_string, sub, context);
                base.parse_attribute (/<cim:PowerElectronicsConnectionPhase.phase\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "phase", sub, context);
                base.parse_attribute (/<cim:PowerElectronicsConnectionPhase.PowerElectronicsConnection\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "PowerElectronicsConnection", sub, context);
                let bucket = context.parsed.PowerElectronicsConnectionPhase;
                if (null == bucket)
                   context.parsed.PowerElectronicsConnectionPhase = bucket = {};
                bucket[obj.id] = obj;
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "PowerElectronicsConnectionPhase", "p", "p",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnectionPhase", "q", "q",  base.from_string, fields);
                base.export_attribute (obj, "PowerElectronicsConnectionPhase", "phase", "phase", fields);
                base.export_attribute (obj, "PowerElectronicsConnectionPhase", "PowerElectronicsConnection", "PowerElectronicsConnection", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PowerElectronicsConnectionPhase_collapse" aria-expanded="true" aria-controls="PowerElectronicsConnectionPhase_collapse" style="margin-left: 10px;">PowerElectronicsConnectionPhase</a></legend>
                    <div id="PowerElectronicsConnectionPhase_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Core.PowerSystemResource.prototype.template.call (this) +
                    `
                    {{#p}}<div><b>p</b>: {{p}}</div>{{/p}}
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PowerElectronicsConnectionPhase_collapse" aria-expanded="true" aria-controls="{{id}}_PowerElectronicsConnectionPhase_collapse" style="margin-left: 10px;">PowerElectronicsConnectionPhase</a></legend>
                    <div id="{{id}}_PowerElectronicsConnectionPhase_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Core.PowerSystemResource.prototype.edit_template.call (this) +
                    `
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PowerElectronicsConnectionPhase" };
                super.submit (id, obj);
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["PowerElectronicsConnection", "1", "0..*", "PowerElectronicsConnection", "PowerElectronicsConnectionPhase"]
                        ]
                    )
                );
            }
        ...
        class ShuntCompensatorPhase extends Core.PowerSystemResource
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ShuntCompensatorPhase;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#ShuntCompensatorPhase_collapse" aria-expanded="true" aria-controls="ShuntCompensatorPhase_collapse" style="margin-left: 10px;">ShuntCompensatorPhase</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_ShuntCompensatorPhase_collapse" aria-expanded="true" aria-controls="{{id}}_ShuntCompensatorPhase_collapse" style="margin-left: 10px;">ShuntCompensatorPhase</a></legend>
        ...
        class NonlinearShuntCompensatorPhasePoint extends base.Element
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.NonlinearShuntCompensatorPhasePoint;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.NonlinearShuntCompensatorPhasePoint;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#NonlinearShuntCompensatorPhasePoint_collapse" aria-expanded="true" aria-controls="NonlinearShuntCompensatorPhasePoint_collapse" style="margin-left: 10px;">NonlinearShuntCompensatorPhasePoint</a></legend>
                    ...
                    {{#b}}<div><b>b</b>: {{b}}</div>{{/b}}
                    {{#g}}<div><b>g</b>: {{g}}</div>{{/g}}
                    {{#NonlinearShuntCompensatorPhase}}<div><b>NonlinearShuntCompensatorPhase</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{NonlinearShuntCompensatorPhase}}");}); return false;'>{{NonlinearShuntCompensatorPhase}}</a></div>{{/NonlinearShuntCompensatorPhase}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_NonlinearShuntCompensatorPhasePoint_collapse" aria-expanded="true" aria-controls="{{id}}_NonlinearShuntCompensatorPhasePoint_collapse" style="margin-left: 10px;">NonlinearShuntCompensatorPhasePoint</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "NonlinearShuntCompensatorPhasePoint" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_sectionNumber").value; if ("" !== temp) obj["sectionNumber"] = temp;
                temp = document.getElementById (id + "_b").value; if ("" !== temp) obj["b"] = temp;
                temp = document.getElementById (id + "_g").value; if ("" !== temp) obj["g"] = temp;
        ...
        class EnergySchedulingType extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.EnergySchedulingType;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.EnergySchedulingType;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    ...
                    + Core.IdentifiedObject.prototype.template.call (this) +
                    `
                    {{#EnergySource}}<div><b>EnergySource</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/EnergySource}}
                    </div>
                    </fieldset>
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "EnergySchedulingType" };
                super.submit (id, obj);
        ...
        class Ground extends Core.ConductingEquipment
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.Ground;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Ground_collapse" aria-expanded="true" aria-controls="Ground_collapse" style="margin-left: 10px;">Ground</a></legend>
                    <div id="Ground_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Core.ConductingEquipment.prototype.template.call (this) +
                    `
                    {{#GroundAction}}<div><b>GroundAction</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{GroundAction}}");}); return false;'>{{GroundAction}}</a></div>{{/GroundAction}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Ground_collapse" aria-expanded="true" aria-controls="{{id}}_Ground_collapse" style="margin-left: 10px;">Ground</a></legend>
        ...
        class PhaseImpedanceData extends base.Element
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PhaseImpedanceData;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:PhaseImpedanceData.g>([\s\S]*?)<\/cim:PhaseImpedanceData.g>/g, obj, "g", base.to_string, sub, context);
                base.parse_attribute (/<cim:PhaseImpedanceData.fromPhase\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "fromPhase", sub, context);
                base.parse_attribute (/<cim:PhaseImpedanceData.toPhase\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "toPhase", sub, context);
                base.parse_element (/<cim:PhaseImpedanceData.row>([\s\S]*?)<\/cim:PhaseImpedanceData.row>/g, obj, "row", base.to_string, sub, context);
                base.parse_element (/<cim:PhaseImpedanceData.column>([\s\S]*?)<\/cim:PhaseImpedanceData.column>/g, obj, "column", base.to_string, sub, context);
                base.parse_attribute (/<cim:PhaseImpedanceData.PhaseImpedance\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "PhaseImpedance", sub, context);
                let bucket = context.parsed.PhaseImpedanceData;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "PhaseImpedanceData", "g", "g",  base.from_string, fields);
                base.export_attribute (obj, "PhaseImpedanceData", "fromPhase", "fromPhase", fields);
                base.export_attribute (obj, "PhaseImpedanceData", "toPhase", "toPhase", fields);
                base.export_element (obj, "PhaseImpedanceData", "row", "row",  base.from_string, fields);
                base.export_element (obj, "PhaseImpedanceData", "column", "column",  base.from_string, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PhaseImpedanceData_collapse" aria-expanded="true" aria-controls="PhaseImpedanceData_collapse" style="margin-left: 10px;">PhaseImpedanceData</a></legend>
                    ...
                    {{#x}}<div><b>x</b>: {{x}}</div>{{/x}}
                    {{#g}}<div><b>g</b>: {{g}}</div>{{/g}}
                    {{#fromPhase}}<div><b>fromPhase</b>: {{fromPhase}}</div>{{/fromPhase}}
                    {{#toPhase}}<div><b>toPhase</b>: {{toPhase}}</div>{{/toPhase}}
                    {{#row}}<div><b>row</b>: {{row}}</div>{{/row}}
                    {{#column}}<div><b>column</b>: {{column}}</div>{{/column}}
                    {{#PhaseImpedance}}<div><b>PhaseImpedance</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{PhaseImpedance}}");}); return false;'>{{PhaseImpedance}}</a></div>{{/PhaseImpedance}}
                    </div>
                    </fieldset>
            ...
            {
                super.condition (obj);
                obj["fromPhaseSinglePhaseKind"] = [{ id: '', selected: (!obj["fromPhase"])}]; for (let property in SinglePhaseKind) obj["fromPhaseSinglePhaseKind"].push ({ id: property, selected: obj["fromPhase"] && obj["fromPhase"].endsWith ('.' + property)});
                obj["toPhaseSinglePhaseKind"] = [{ id: '', selected: (!obj["toPhase"])}]; for (let property in SinglePhaseKind) obj["toPhaseSinglePhaseKind"].push ({ id: property, selected: obj["toPhase"] && obj["toPhase"].endsWith ('.' + property)});
            }

            uncondition (obj)
            {
                super.uncondition (obj);
                delete obj["fromPhaseSinglePhaseKind"];
                delete obj["toPhaseSinglePhaseKind"];
            }
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PhaseImpedanceData_collapse" aria-expanded="true" aria-controls="{{id}}_PhaseImpedanceData_collapse" style="margin-left: 10px;">PhaseImpedanceData</a></legend>
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_x'>x: </label><div class='col-sm-8'><input id='{{id}}_x' class='form-control' type='text'{{#x}} value='{{x}}'{{/x}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_g'>g: </label><div class='col-sm-8'><input id='{{id}}_g' class='form-control' type='text'{{#g}} value='{{g}}'{{/g}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_fromPhase'>fromPhase: </label><div class='col-sm-8'><select id='{{id}}_fromPhase' class='form-control custom-select'>{{#fromPhaseSinglePhaseKind}}<option value='{{id}}'{{#selected}} selected{{/selected}}>{{id}}</option>{{/fromPhaseSinglePhaseKind}}</select></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_toPhase'>toPhase: </label><div class='col-sm-8'><select id='{{id}}_toPhase' class='form-control custom-select'>{{#toPhaseSinglePhaseKind}}<option value='{{id}}'{{#selected}} selected{{/selected}}>{{id}}</option>{{/toPhaseSinglePhaseKind}}</select></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_row'>row: </label><div class='col-sm-8'><input id='{{id}}_row' class='form-control' type='text'{{#row}} value='{{row}}'{{/row}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_column'>column: </label><div class='col-sm-8'><input id='{{id}}_column' class='form-control' type='text'{{#column}} value='{{column}}'{{/column}}></div></div>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PhaseImpedanceData" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_b").value; if ("" !== temp) obj["b"] = temp;
                temp = document.getElementById (id + "_r").value; if ("" !== temp) obj["r"] = temp;
                temp = document.getElementById (id + "_x").value; if ("" !== temp) obj["x"] = temp;
        ...
        class MutualCoupling extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.MutualCoupling;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.MutualCoupling;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#MutualCoupling_collapse" aria-expanded="true" aria-controls="MutualCoupling_collapse" style="margin-left: 10px;">MutualCoupling</a></legend>
                    ...
                    {{#r0}}<div><b>r0</b>: {{r0}}</div>{{/r0}}
                    {{#x0}}<div><b>x0</b>: {{x0}}</div>{{/x0}}
                    {{#First_Terminal}}<div><b>First_Terminal</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{First_Terminal}}");}); return false;'>{{First_Terminal}}</a></div>{{/First_Terminal}}
                    {{#Second_Terminal}}<div><b>Second_Terminal</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{Second_Terminal}}");}); return false;'>{{Second_Terminal}}</a></div>{{/Second_Terminal}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_MutualCoupling_collapse" aria-expanded="true" aria-controls="{{id}}_MutualCoupling_collapse" style="margin-left: 10px;">MutualCoupling</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "MutualCoupling" };
                super.submit (id, obj);
        ...
        class TransformerEnd extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.TransformerEnd;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.TransformerEnd;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#TransformerEnd_collapse" aria-expanded="true" aria-controls="TransformerEnd_collapse" style="margin-left: 10px;">TransformerEnd</a></legend>
                    ...
                    {{#FromMeshImpedance}}<div><b>FromMeshImpedance</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/FromMeshImpedance}}
                    {{#ToMeshImpedance}}<div><b>ToMeshImpedance</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/ToMeshImpedance}}
                    ...
                    {{#FromWindingInsulations}}<div><b>FromWindingInsulations</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/FromWindingInsulations}}
                    {{#StarImpedance}}<div><b>StarImpedance</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{StarImpedance}}");}); return false;'>{{StarImpedance}}</a></div>{{/StarImpedance}}
                    {{#ToWindingInsulations}}<div><b>ToWindingInsulations</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/ToWindingInsulations}}
                    ...
                    {{#PhaseTapChanger}}<div><b>PhaseTapChanger</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{PhaseTapChanger}}");}); return false;'>{{PhaseTapChanger}}</a></div>{{/PhaseTapChanger}}
                    {{#RatioTapChanger}}<div><b>RatioTapChanger</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{RatioTapChanger}}");}); return false;'>{{RatioTapChanger}}</a></div>{{/RatioTapChanger}}
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_TransformerEnd_collapse" aria-expanded="true" aria-controls="{{id}}_TransformerEnd_collapse" style="margin-left: 10px;">TransformerEnd</a></legend>
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_ToMeshImpedance'>ToMeshImpedance: </label><div class='col-sm-8'><input id='{{id}}_ToMeshImpedance' class='form-control' type='text'{{#ToMeshImpedance}} value='{{ToMeshImpedance_string}}'{{/ToMeshImpedance}}></div></div>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "TransformerEnd" };
                super.submit (id, obj);
        ...
        class Plant extends Core.EquipmentContainer
        {
            ...
            parse (context, sub)
            {
                ...
                obj.cls = "Plant";
                let bucket = context.parsed.Plant;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Plant_collapse" aria-expanded="true" aria-controls="Plant_collapse" style="margin-left: 10px;">Plant</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Plant_collapse" aria-expanded="true" aria-controls="{{id}}_Plant_collapse" style="margin-left: 10px;">Plant</a></legend>
         ...
         *
         */
        class EnergySourcePhase extends Core.PowerSystemResource
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.EnergySourcePhase;
                if (null == bucket)
                   cim_data.EnergySourcePhase = bucket = {};
                bucket[template.id] = template;
            }
            ...
            {
               super.remove (obj, cim_data);
               delete cim_data.EnergySourcePhase[obj.id];
            }

            parse (context, sub)
            {
                let obj = Core.PowerSystemResource.prototype.parse.call (this, context, sub);
                obj.cls = "EnergySourcePhase";
                base.parse_attribute (/<cim:EnergySourcePhase.phase\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "phase", sub, context);
                base.parse_attribute (/<cim:EnergySourcePhase.EnergySource\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "EnergySource", sub, context);
                let bucket = context.parsed.EnergySourcePhase;
                if (null == bucket)
                   context.parsed.EnergySourcePhase = bucket = {};
                bucket[obj.id] = obj;
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "EnergySourcePhase", "phase", "phase", fields);
                base.export_attribute (obj, "EnergySourcePhase", "EnergySource", "EnergySource", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#EnergySourcePhase_collapse" aria-expanded="true" aria-controls="EnergySourcePhase_collapse" style="margin-left: 10px;">EnergySourcePhase</a></legend>
                    <div id="EnergySourcePhase_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Core.PowerSystemResource.prototype.template.call (this) +
                    `
                    {{#phase}}<div><b>phase</b>: {{phase}}</div>{{/phase}}
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_EnergySourcePhase_collapse" aria-expanded="true" aria-controls="{{id}}_EnergySourcePhase_collapse" style="margin-left: 10px;">EnergySourcePhase</a></legend>
                    <div id="{{id}}_EnergySourcePhase_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Core.PowerSystemResource.prototype.edit_template.call (this) +
                    `
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_phase'>phase: </label><div class='col-sm-8'><select id='{{id}}_phase' class='form-control custom-select'>{{#phaseSinglePhaseKind}}<option value='{{id}}'{{#selected}} selected{{/selected}}>{{id}}</option>{{/phaseSinglePhaseKind}}</select></div></div>
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["EnergySource", "1", "0..*", "EnergySource", "EnergySourcePhase"]
                        ]
                    )
                );
            }
        ...
        class SwitchPhase extends Core.PowerSystemResource
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.SwitchPhase;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:SwitchPhase.ratedCurrent>([\s\S]*?)<\/cim:SwitchPhase.ratedCurrent>/g, obj, "ratedCurrent", base.to_string, sub, context);
                base.parse_attribute (/<cim:SwitchPhase.Switch\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "Switch", sub, context);
                let bucket = context.parsed.SwitchPhase;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "SwitchPhase", "ratedCurrent", "ratedCurrent",  base.from_string, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#SwitchPhase_collapse" aria-expanded="true" aria-controls="SwitchPhase_collapse" style="margin-left: 10px;">SwitchPhase</a></legend>
            ...
            {
                super.condition (obj);
                obj["phaseSide1SinglePhaseKind"] = [{ id: '', selected: (!obj["phaseSide1"])}]; for (let property in SinglePhaseKind) obj["phaseSide1SinglePhaseKind"].push ({ id: property, selected: obj["phaseSide1"] && obj["phaseSide1"].endsWith ('.' + property)});
                obj["phaseSide2SinglePhaseKind"] = [{ id: '', selected: (!obj["phaseSide2"])}]; for (let property in SinglePhaseKind) obj["phaseSide2SinglePhaseKind"].push ({ id: property, selected: obj["phaseSide2"] && obj["phaseSide2"].endsWith ('.' + property)});
            }
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_SwitchPhase_collapse" aria-expanded="true" aria-controls="{{id}}_SwitchPhase_collapse" style="margin-left: 10px;">SwitchPhase</a></legend>
        ...
        class EnergyConsumerPhase extends Core.PowerSystemResource
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.EnergyConsumerPhase;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:EnergyConsumerPhase.p>([\s\S]*?)<\/cim:EnergyConsumerPhase.p>/g, obj, "p", base.to_string, sub, context);
                base.parse_element (/<cim:EnergyConsumerPhase.q>([\s\S]*?)<\/cim:EnergyConsumerPhase.q>/g, obj, "q", base.to_string, sub, context);
                base.parse_attribute (/<cim:EnergyConsumerPhase.EnergyConsumer\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "EnergyConsumer", sub, context);
                let bucket = context.parsed.EnergyConsumerPhase;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "EnergyConsumerPhase", "p", "p",  base.from_string, fields);
                base.export_element (obj, "EnergyConsumerPhase", "q", "q",  base.from_string, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#EnergyConsumerPhase_collapse" aria-expanded="true" aria-controls="EnergyConsumerPhase_collapse" style="margin-left: 10px;">EnergyConsumerPhase</a></legend>
                    ...
                    {{#p}}<div><b>p</b>: {{p}}</div>{{/p}}
                    {{#q}}<div><b>q</b>: {{q}}</div>{{/q}}
                    {{#EnergyConsumer}}<div><b>EnergyConsumer</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{EnergyConsumer}}");}); return false;'>{{EnergyConsumer}}</a></div>{{/EnergyConsumer}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_EnergyConsumerPhase_collapse" aria-expanded="true" aria-controls="{{id}}_EnergyConsumerPhase_collapse" style="margin-left: 10px;">EnergyConsumerPhase</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "EnergyConsumerPhase" };
                super.submit (id, obj);
        ...
        class SwitchSchedule extends LoadModel.SeasonDayTypeSchedule
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.SwitchSchedule;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.SwitchSchedule;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#SwitchSchedule_collapse" aria-expanded="true" aria-controls="SwitchSchedule_collapse" style="margin-left: 10px;">SwitchSchedule</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_SwitchSchedule_collapse" aria-expanded="true" aria-controls="{{id}}_SwitchSchedule_collapse" style="margin-left: 10px;">SwitchSchedule</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "SwitchSchedule" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_Switch").value; if ("" !== temp) obj["Switch"] = temp;
        ...
        class RegulatingControl extends Core.PowerSystemResource
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.RegulatingControl;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.RegulatingControl;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#RegulatingControl_collapse" aria-expanded="true" aria-controls="RegulatingControl_collapse" style="margin-left: 10px;">RegulatingControl</a></legend>
                    ...
                    {{#Terminal}}<div><b>Terminal</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{Terminal}}");}); return false;'>{{Terminal}}</a></div>{{/Terminal}}
                    {{#RegulatingCondEq}}<div><b>RegulatingCondEq</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/RegulatingCondEq}}
                    </div>
                    </fieldset>
            ...
            {
                super.condition (obj);
                obj["modeRegulatingControlModeKind"] = [{ id: '', selected: (!obj["mode"])}]; for (let property in RegulatingControlModeKind) obj["modeRegulatingControlModeKind"].push ({ id: property, selected: obj["mode"] && obj["mode"].endsWith ('.' + property)});
                obj["monitoredPhasePhaseCode"] = [{ id: '', selected: (!obj["monitoredPhase"])}]; for (let property in Core.PhaseCode) obj["monitoredPhasePhaseCode"].push ({ id: property, selected: obj["monitoredPhase"] && obj["monitoredPhase"].endsWith ('.' + property)});
                obj["targetValueUnitMultiplierUnitMultiplier"] = [{ id: '', selected: (!obj["targetValueUnitMultiplier"])}]; for (let property in Domain.UnitMultiplier) obj["targetValueUnitMultiplierUnitMultiplier"].push ({ id: property, selected: obj["targetValueUnitMultiplier"] && obj["targetValueUnitMultiplier"].endsWith ('.' + property)});
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_RegulatingControl_collapse" aria-expanded="true" aria-controls="{{id}}_RegulatingControl_collapse" style="margin-left: 10px;">RegulatingControl</a></legend>
        ...
        class Line extends Core.EquipmentContainer
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.Line;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Line_collapse" aria-expanded="true" aria-controls="Line_collapse" style="margin-left: 10px;">Line</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Line_collapse" aria-expanded="true" aria-controls="{{id}}_Line_collapse" style="margin-left: 10px;">Line</a></legend>
        ...
        class TapChangerTablePoint extends base.Element
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.TapChangerTablePoint;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.TapChangerTablePoint;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#TapChangerTablePoint_collapse" aria-expanded="true" aria-controls="TapChangerTablePoint_collapse" style="margin-left: 10px;">TapChangerTablePoint</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_TapChangerTablePoint_collapse" aria-expanded="true" aria-controls="{{id}}_TapChangerTablePoint_collapse" style="margin-left: 10px;">TapChangerTablePoint</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "TapChangerTablePoint" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_b").value; if ("" !== temp) obj["b"] = temp;
                temp = document.getElementById (id + "_g").value; if ("" !== temp) obj["g"] = temp;
                temp = document.getElementById (id + "_r").value; if ("" !== temp) obj["r"] = temp;
        ...
        class TransformerMeshImpedance extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.TransformerMeshImpedance;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.TransformerMeshImpedance;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#TransformerMeshImpedance_collapse" aria-expanded="true" aria-controls="TransformerMeshImpedance_collapse" style="margin-left: 10px;">TransformerMeshImpedance</a></legend>
                    ...
                    {{#x}}<div><b>x</b>: {{x}}</div>{{/x}}
                    {{#x0}}<div><b>x0</b>: {{x0}}</div>{{/x0}}
                    {{#FromTransformerEnd}}<div><b>FromTransformerEnd</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{FromTransformerEnd}}");}); return false;'>{{FromTransformerEnd}}</a></div>{{/FromTransformerEnd}}
                    {{#FromTransformerEndInfo}}<div><b>FromTransformerEndInfo</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{FromTransformerEndInfo}}");}); return false;'>{{FromTransformerEndInfo}}</a></div>{{/FromTransformerEndInfo}}
                    {{#ToTransformerEnd}}<div><b>ToTransformerEnd</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/ToTransformerEnd}}
                    {{#ToTransformerEndInfos}}<div><b>ToTransformerEndInfos</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/ToTransformerEndInfos}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_TransformerMeshImpedance_collapse" aria-expanded="true" aria-controls="{{id}}_TransformerMeshImpedance_collapse" style="margin-left: 10px;">TransformerMeshImpedance</a></legend>
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_ToTransformerEnd'>ToTransformerEnd: </label><div class='col-sm-8'><input id='{{id}}_ToTransformerEnd' class='form-control' type='text'{{#ToTransformerEnd}} value='{{ToTransformerEnd_string}}'{{/ToTransformerEnd}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_ToTransformerEndInfos'>ToTransformerEndInfos: </label><div class='col-sm-8'><input id='{{id}}_ToTransformerEndInfos' class='form-control' type='text'{{#ToTransformerEndInfos}} value='{{ToTransformerEndInfos_string}}'{{/ToTransformerEndInfos}}></div></div>
                    </div>
                    </fieldset>
                    `
                );
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "TransformerMeshImpedance" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_r").value; if ("" !== temp) obj["r"] = temp;
                temp = document.getElementById (id + "_r0").value; if ("" !== temp) obj["r0"] = temp;
                temp = document.getElementById (id + "_x").value; if ("" !== temp) obj["x"] = temp;
        ...
        class PowerTransformer extends Core.ConductingEquipment
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PowerTransformer;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.PowerTransformer;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PowerTransformer_collapse" aria-expanded="true" aria-controls="PowerTransformer_collapse" style="margin-left: 10px;">PowerTransformer</a></legend>
                    ...
                    {{#TransformerTanks}}<div><b>TransformerTanks</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/TransformerTanks}}
                    {{#PowerTransformerEnd}}<div><b>PowerTransformerEnd</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/PowerTransformerEnd}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PowerTransformer_collapse" aria-expanded="true" aria-controls="{{id}}_PowerTransformer_collapse" style="margin-left: 10px;">PowerTransformer</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PowerTransformer" };
                super.submit (id, obj);
        ...
        class PhaseTapChangerTable extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PhaseTapChangerTable;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.PhaseTapChangerTable;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PhaseTapChangerTable_collapse" aria-expanded="true" aria-controls="PhaseTapChangerTable_collapse" style="margin-left: 10px;">PhaseTapChangerTable</a></legend>
                    <div id="PhaseTapChangerTable_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Core.IdentifiedObject.prototype.template.call (this) +
                    `
                    {{#PhaseTapChangerTablePoint}}<div><b>PhaseTapChangerTablePoint</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/PhaseTapChangerTablePoint}}
                    {{#PhaseTapChangerTabular}}<div><b>PhaseTapChangerTabular</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/PhaseTapChangerTabular}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PhaseTapChangerTable_collapse" aria-expanded="true" aria-controls="{{id}}_PhaseTapChangerTable_collapse" style="margin-left: 10px;">PhaseTapChangerTable</a></legend>
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "PhaseTapChangerTable" };
                super.submit (id, obj);
         ...
         *
         */
        class EnergyConnection extends Core.ConductingEquipment
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.EnergyConnection;
                if (null == bucket)
                   cim_data.EnergyConnection = bucket = {};
                bucket[template.id] = template;
            }
            ...
            {
               super.remove (obj, cim_data);
               delete cim_data.EnergyConnection[obj.id];
            }

            parse (context, sub)
            {
                let obj = Core.ConductingEquipment.prototype.parse.call (this, context, sub);
                obj.cls = "EnergyConnection";
                let bucket = context.parsed.EnergyConnection;
                if (null == bucket)
                   context.parsed.EnergyConnection = bucket = {};
                bucket[obj.id] = obj;
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#EnergyConnection_collapse" aria-expanded="true" aria-controls="EnergyConnection_collapse" style="margin-left: 10px;">EnergyConnection</a></legend>
                    <div id="EnergyConnection_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Core.ConductingEquipment.prototype.template.call (this) +
                    `
                    </div>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_EnergyConnection_collapse" aria-expanded="true" aria-controls="{{id}}_EnergyConnection_collapse" style="margin-left: 10px;">EnergyConnection</a></legend>
                    <div id="{{id}}_EnergyConnection_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Core.ConductingEquipment.prototype.edit_template.call (this) +
                    `
                    </div>
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "EnergyConnection" };
                super.submit (id, obj);
        ...
        class PerLengthLineParameter extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PerLengthLineParameter;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_attribute (/<cim:PerLengthLineParameter.WireAssemblyInfo\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "WireAssemblyInfo", sub, context);
                let bucket = context.parsed.PerLengthLineParameter;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "PerLengthLineParameter", "WireAssemblyInfo", "WireAssemblyInfo", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PerLengthLineParameter_collapse" aria-expanded="true" aria-controls="PerLengthLineParameter_collapse" style="margin-left: 10px;">PerLengthLineParameter</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PerLengthLineParameter_collapse" aria-expanded="true" aria-controls="{{id}}_PerLengthLineParameter_collapse" style="margin-left: 10px;">PerLengthLineParameter</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PerLengthLineParameter" };
                super.submit (id, obj);
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["WireAssemblyInfo", "0..1", "0..*", "WireAssemblyInfo", "PerLengthLineParameter"]
                        ]
                    )
                );
            }
        ...
        class Clamp extends Core.ConductingEquipment
        {
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Clamp_collapse" aria-expanded="true" aria-controls="Clamp_collapse" style="margin-left: 10px;">Clamp</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Clamp_collapse" aria-expanded="true" aria-controls="{{id}}_Clamp_collapse" style="margin-left: 10px;">Clamp</a></legend>
        ...
        class ReactiveCapabilityCurve extends Core.Curve
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ReactiveCapabilityCurve;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ReactiveCapabilityCurve;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#ReactiveCapabilityCurve_collapse" aria-expanded="true" aria-controls="ReactiveCapabilityCurve_collapse" style="margin-left: 10px;">ReactiveCapabilityCurve</a></legend>
                    ...
                    {{#EquivalentInjection}}<div><b>EquivalentInjection</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/EquivalentInjection}}
                    {{#InitiallyUsedBySynchronousMachines}}<div><b>InitiallyUsedBySynchronousMachines</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/InitiallyUsedBySynchronousMachines}}
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_ReactiveCapabilityCurve_collapse" aria-expanded="true" aria-controls="{{id}}_ReactiveCapabilityCurve_collapse" style="margin-left: 10px;">ReactiveCapabilityCurve</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ReactiveCapabilityCurve" };
                super.submit (id, obj);
        ...
        class TransformerCoreAdmittance extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.TransformerCoreAdmittance;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.TransformerCoreAdmittance;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#TransformerCoreAdmittance_collapse" aria-expanded="true" aria-controls="TransformerCoreAdmittance_collapse" style="margin-left: 10px;">TransformerCoreAdmittance</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_TransformerCoreAdmittance_collapse" aria-expanded="true" aria-controls="{{id}}_TransformerCoreAdmittance_collapse" style="margin-left: 10px;">TransformerCoreAdmittance</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "TransformerCoreAdmittance" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_b").value; if ("" !== temp) obj["b"] = temp;
                temp = document.getElementById (id + "_b0").value; if ("" !== temp) obj["b0"] = temp;
                temp = document.getElementById (id + "_g").value; if ("" !== temp) obj["g"] = temp;
        ...
        class EarthFaultCompensator extends Core.ConductingEquipment
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.EarthFaultCompensator;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.EarthFaultCompensator;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#EarthFaultCompensator_collapse" aria-expanded="true" aria-controls="EarthFaultCompensator_collapse" style="margin-left: 10px;">EarthFaultCompensator</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_EarthFaultCompensator_collapse" aria-expanded="true" aria-controls="{{id}}_EarthFaultCompensator_collapse" style="margin-left: 10px;">EarthFaultCompensator</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "EarthFaultCompensator" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_r").value; if ("" !== temp) obj["r"] = temp;
        ...
        class VoltageControlZone extends Core.PowerSystemResource
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.VoltageControlZone;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.VoltageControlZone;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#VoltageControlZone_collapse" aria-expanded="true" aria-controls="VoltageControlZone_collapse" style="margin-left: 10px;">VoltageControlZone</a></legend>
                    <div id="VoltageControlZone_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Core.PowerSystemResource.prototype.template.call (this) +
                    `
                    {{#RegulationSchedule}}<div><b>RegulationSchedule</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{RegulationSchedule}}");}); return false;'>{{RegulationSchedule}}</a></div>{{/RegulationSchedule}}
                    {{#BusbarSection}}<div><b>BusbarSection</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{BusbarSection}}");}); return false;'>{{BusbarSection}}</a></div>{{/BusbarSection}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_VoltageControlZone_collapse" aria-expanded="true" aria-controls="{{id}}_VoltageControlZone_collapse" style="margin-left: 10px;">VoltageControlZone</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "VoltageControlZone" };
                super.submit (id, obj);
        ...
        class Switch extends Core.ConductingEquipment
        {
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Switch_collapse" aria-expanded="true" aria-controls="Switch_collapse" style="margin-left: 10px;">Switch</a></legend>
            ...
            {
                super.condition (obj);
                if (obj["SvSwitch"]) obj["SvSwitch_string"] = obj["SvSwitch"].join ();
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Switch_collapse" aria-expanded="true" aria-controls="{{id}}_Switch_collapse" style="margin-left: 10px;">Switch</a></legend>
        ...
        class RatioTapChangerTable extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.RatioTapChangerTable;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.RatioTapChangerTable;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#RatioTapChangerTable_collapse" aria-expanded="true" aria-controls="RatioTapChangerTable_collapse" style="margin-left: 10px;">RatioTapChangerTable</a></legend>
                    <div id="RatioTapChangerTable_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Core.IdentifiedObject.prototype.template.call (this) +
                    `
                    {{#RatioTapChanger}}<div><b>RatioTapChanger</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/RatioTapChanger}}
                    {{#RatioTapChangerTablePoint}}<div><b>RatioTapChangerTablePoint</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/RatioTapChangerTablePoint}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_RatioTapChangerTable_collapse" aria-expanded="true" aria-controls="{{id}}_RatioTapChangerTable_collapse" style="margin-left: 10px;">RatioTapChangerTable</a></legend>
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "RatioTapChangerTable" };
                super.submit (id, obj);
        ...
        class Connector extends Core.ConductingEquipment
        {
            ...
            parse (context, sub)
            {
                let obj = Core.ConductingEquipment.prototype.parse.call (this, context, sub);
                obj.cls = "Connector";
                let bucket = context.parsed.Connector;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Connector_collapse" aria-expanded="true" aria-controls="Connector_collapse" style="margin-left: 10px;">Connector</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Connector_collapse" aria-expanded="true" aria-controls="{{id}}_Connector_collapse" style="margin-left: 10px;">Connector</a></legend>
        ...
        class ACLineSegment extends Conductor
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ACLineSegment;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#ACLineSegment_collapse" aria-expanded="true" aria-controls="ACLineSegment_collapse" style="margin-left: 10px;">ACLineSegment</a></legend>
                    ...
                    {{#x}}<div><b>x</b>: {{x}}</div>{{/x}}
                    {{#x0}}<div><b>x0</b>: {{x0}}</div>{{/x0}}
                    {{#ACLineSegmentPhases}}<div><b>ACLineSegmentPhases</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/ACLineSegmentPhases}}
                    {{#PerLengthImpedance}}<div><b>PerLengthImpedance</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{PerLengthImpedance}}");}); return false;'>{{PerLengthImpedance}}</a></div>{{/PerLengthImpedance}}
                    {{#Cut}}<div><b>Cut</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/Cut}}
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_ACLineSegment_collapse" aria-expanded="true" aria-controls="{{id}}_ACLineSegment_collapse" style="margin-left: 10px;">ACLineSegment</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ACLineSegment" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_b0ch").value; if ("" !== temp) obj["b0ch"] = temp;
        ...
        class RatioTapChanger extends TapChanger
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.RatioTapChanger;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = TapChanger.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.RatioTapChanger;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = TapChanger.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#RatioTapChanger_collapse" aria-expanded="true" aria-controls="RatioTapChanger_collapse" style="margin-left: 10px;">RatioTapChanger</a></legend>
                    ...
                    {{#RatioTapChangerTable}}<div><b>RatioTapChangerTable</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{RatioTapChangerTable}}");}); return false;'>{{RatioTapChangerTable}}</a></div>{{/RatioTapChangerTable}}
                    {{#TransformerEnd}}<div><b>TransformerEnd</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{TransformerEnd}}");}); return false;'>{{TransformerEnd}}</a></div>{{/TransformerEnd}}
                    </div>
                    </fieldset>
            ...
            {
                super.condition (obj);
                obj["tculControlModeTransformerControlMode"] = [{ id: '', selected: (!obj["tculControlMode"])}]; for (let property in TransformerControlMode) obj["tculControlModeTransformerControlMode"].push ({ id: property, selected: obj["tculControlMode"] && obj["tculControlMode"].endsWith ('.' + property)});
            }
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_RatioTapChanger_collapse" aria-expanded="true" aria-controls="{{id}}_RatioTapChanger_collapse" style="margin-left: 10px;">RatioTapChanger</a></legend>
        ...
        class PhaseTapChanger extends TapChanger
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PhaseTapChanger;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.PhaseTapChanger;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PhaseTapChanger_collapse" aria-expanded="true" aria-controls="PhaseTapChanger_collapse" style="margin-left: 10px;">PhaseTapChanger</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PhaseTapChanger_collapse" aria-expanded="true" aria-controls="{{id}}_PhaseTapChanger_collapse" style="margin-left: 10px;">PhaseTapChanger</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PhaseTapChanger" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_TransformerEnd").value; if ("" !== temp) obj["TransformerEnd"] = temp;
        ...
        class PhaseTapChangerTabular extends PhaseTapChanger
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PhaseTapChangerTabular;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = PhaseTapChanger.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.PhaseTapChangerTabular;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = PhaseTapChanger.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PhaseTapChangerTabular_collapse" aria-expanded="true" aria-controls="PhaseTapChangerTabular_collapse" style="margin-left: 10px;">PhaseTapChangerTabular</a></legend>
                    ...
                    `
                    {{#PhaseTapChangerTable}}<div><b>PhaseTapChangerTable</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{PhaseTapChangerTable}}");}); return false;'>{{PhaseTapChangerTable}}</a></div>{{/PhaseTapChangerTable}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PhaseTapChangerTabular_collapse" aria-expanded="true" aria-controls="{{id}}_PhaseTapChangerTabular_collapse" style="margin-left: 10px;">PhaseTapChangerTabular</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PhaseTapChangerTabular" };
                super.submit (id, obj);
        ...
        class PhaseTapChangerNonLinear extends PhaseTapChanger
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PhaseTapChangerNonLinear;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.PhaseTapChangerNonLinear;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PhaseTapChangerNonLinear_collapse" aria-expanded="true" aria-controls="PhaseTapChangerNonLinear_collapse" style="margin-left: 10px;">PhaseTapChangerNonLinear</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PhaseTapChangerNonLinear_collapse" aria-expanded="true" aria-controls="{{id}}_PhaseTapChangerNonLinear_collapse" style="margin-left: 10px;">PhaseTapChangerNonLinear</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PhaseTapChangerNonLinear" };
                super.submit (id, obj);
        ...
        class PhaseTapChangerLinear extends PhaseTapChanger
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PhaseTapChangerLinear;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.PhaseTapChangerLinear;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PhaseTapChangerLinear_collapse" aria-expanded="true" aria-controls="PhaseTapChangerLinear_collapse" style="margin-left: 10px;">PhaseTapChangerLinear</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PhaseTapChangerLinear_collapse" aria-expanded="true" aria-controls="{{id}}_PhaseTapChangerLinear_collapse" style="margin-left: 10px;">PhaseTapChangerLinear</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PhaseTapChangerLinear" };
                super.submit (id, obj);
        ...
        class PhaseTapChangerSymmetrical extends PhaseTapChangerNonLinear
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PhaseTapChangerSymmetrical;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = PhaseTapChangerNonLinear.prototype.parse.call (this, context, sub);
                obj.cls = "PhaseTapChangerSymmetrical";
                let bucket = context.parsed.PhaseTapChangerSymmetrical;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = PhaseTapChangerNonLinear.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PhaseTapChangerSymmetrical_collapse" aria-expanded="true" aria-controls="PhaseTapChangerSymmetrical_collapse" style="margin-left: 10px;">PhaseTapChangerSymmetrical</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PhaseTapChangerSymmetrical_collapse" aria-expanded="true" aria-controls="{{id}}_PhaseTapChangerSymmetrical_collapse" style="margin-left: 10px;">PhaseTapChangerSymmetrical</a></legend>
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "PhaseTapChangerSymmetrical" };
                super.submit (id, obj);
        ...
        class PhaseTapChangerAsymmetrical extends PhaseTapChangerNonLinear
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PhaseTapChangerAsymmetrical;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.PhaseTapChangerAsymmetrical;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PhaseTapChangerAsymmetrical_collapse" aria-expanded="true" aria-controls="PhaseTapChangerAsymmetrical_collapse" style="margin-left: 10px;">PhaseTapChangerAsymmetrical</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PhaseTapChangerAsymmetrical_collapse" aria-expanded="true" aria-controls="{{id}}_PhaseTapChangerAsymmetrical_collapse" style="margin-left: 10px;">PhaseTapChangerAsymmetrical</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PhaseTapChangerAsymmetrical" };
                super.submit (id, obj);
        ...
        class LinearShuntCompensatorPhase extends ShuntCompensatorPhase
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.LinearShuntCompensatorPhase;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = ShuntCompensatorPhase.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.LinearShuntCompensatorPhase;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = ShuntCompensatorPhase.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#LinearShuntCompensatorPhase_collapse" aria-expanded="true" aria-controls="LinearShuntCompensatorPhase_collapse" style="margin-left: 10px;">LinearShuntCompensatorPhase</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_LinearShuntCompensatorPhase_collapse" aria-expanded="true" aria-controls="{{id}}_LinearShuntCompensatorPhase_collapse" style="margin-left: 10px;">LinearShuntCompensatorPhase</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "LinearShuntCompensatorPhase" };
                super.submit (id, obj);
        ...
        class NonlinearShuntCompensatorPhase extends ShuntCompensatorPhase
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.NonlinearShuntCompensatorPhase;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.NonlinearShuntCompensatorPhase;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#NonlinearShuntCompensatorPhase_collapse" aria-expanded="true" aria-controls="NonlinearShuntCompensatorPhase_collapse" style="margin-left: 10px;">NonlinearShuntCompensatorPhase</a></legend>
                    <div id="NonlinearShuntCompensatorPhase_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + ShuntCompensatorPhase.prototype.template.call (this) +
                    `
                    {{#NonlinearShuntCompensatorPhasePoints}}<div><b>NonlinearShuntCompensatorPhasePoints</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/NonlinearShuntCompensatorPhasePoints}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_NonlinearShuntCompensatorPhase_collapse" aria-expanded="true" aria-controls="{{id}}_NonlinearShuntCompensatorPhase_collapse" style="margin-left: 10px;">NonlinearShuntCompensatorPhase</a></legend>
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "NonlinearShuntCompensatorPhase" };
                super.submit (id, obj);
        ...
        class TransformerTankEnd extends TransformerEnd
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.TransformerTankEnd;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = TransformerEnd.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.TransformerTankEnd;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = TransformerEnd.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#TransformerTankEnd_collapse" aria-expanded="true" aria-controls="TransformerTankEnd_collapse" style="margin-left: 10px;">TransformerTankEnd</a></legend>
                    ...
                    {{#TransformerTank}}<div><b>TransformerTank</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{TransformerTank}}");}); return false;'>{{TransformerTank}}</a></div>{{/TransformerTank}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_TransformerTankEnd_collapse" aria-expanded="true" aria-controls="{{id}}_TransformerTankEnd_collapse" style="margin-left: 10px;">TransformerTankEnd</a></legend>
        ...
        class PowerTransformerEnd extends TransformerEnd
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PowerTransformerEnd;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.PowerTransformerEnd;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PowerTransformerEnd_collapse" aria-expanded="true" aria-controls="PowerTransformerEnd_collapse" style="margin-left: 10px;">PowerTransformerEnd</a></legend>
            ...
            {
                super.condition (obj);
                obj["connectionKindWindingConnection"] = [{ id: '', selected: (!obj["connectionKind"])}]; for (let property in WindingConnection) obj["connectionKindWindingConnection"].push ({ id: property, selected: obj["connectionKind"] && obj["connectionKind"].endsWith ('.' + property)});
            }
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PowerTransformerEnd_collapse" aria-expanded="true" aria-controls="{{id}}_PowerTransformerEnd_collapse" style="margin-left: 10px;">PowerTransformerEnd</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PowerTransformerEnd" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_b").value; if ("" !== temp) obj["b"] = temp;
                temp = document.getElementById (id + "_b0").value; if ("" !== temp) obj["b0"] = temp;
        ...
        class TapChangerControl extends RegulatingControl
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.TapChangerControl;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = RegulatingControl.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.TapChangerControl;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = RegulatingControl.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#TapChangerControl_collapse" aria-expanded="true" aria-controls="TapChangerControl_collapse" style="margin-left: 10px;">TapChangerControl</a></legend>
                    ...
                    {{#TapChanger}}<div><b>TapChanger</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/TapChanger}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_TapChangerControl_collapse" aria-expanded="true" aria-controls="{{id}}_TapChangerControl_collapse" style="margin-left: 10px;">TapChangerControl</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "TapChangerControl" };
                super.submit (id, obj);
        ...
        class PhaseTapChangerTablePoint extends TapChangerTablePoint
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PhaseTapChangerTablePoint;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = TapChangerTablePoint.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.PhaseTapChangerTablePoint;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = TapChangerTablePoint.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PhaseTapChangerTablePoint_collapse" aria-expanded="true" aria-controls="PhaseTapChangerTablePoint_collapse" style="margin-left: 10px;">PhaseTapChangerTablePoint</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PhaseTapChangerTablePoint_collapse" aria-expanded="true" aria-controls="{{id}}_PhaseTapChangerTablePoint_collapse" style="margin-left: 10px;">PhaseTapChangerTablePoint</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PhaseTapChangerTablePoint" };
                super.submit (id, obj);
        ...
        class RatioTapChangerTablePoint extends TapChangerTablePoint
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.RatioTapChangerTablePoint;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.RatioTapChangerTablePoint;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#RatioTapChangerTablePoint_collapse" aria-expanded="true" aria-controls="RatioTapChangerTablePoint_collapse" style="margin-left: 10px;">RatioTapChangerTablePoint</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_RatioTapChangerTablePoint_collapse" aria-expanded="true" aria-controls="{{id}}_RatioTapChangerTablePoint_collapse" style="margin-left: 10px;">RatioTapChangerTablePoint</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "RatioTapChangerTablePoint" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_RatioTapChangerTable").value; if ("" !== temp) obj["RatioTapChangerTable"] = temp;
         ...
         *
         */
        class RegulatingCondEq extends EnergyConnection
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.RegulatingCondEq;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = EnergyConnection.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.RegulatingCondEq;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = EnergyConnection.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#RegulatingCondEq_collapse" aria-expanded="true" aria-controls="RegulatingCondEq_collapse" style="margin-left: 10px;">RegulatingCondEq</a></legend>
                    <div id="RegulatingCondEq_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + EnergyConnection.prototype.template.call (this) +
                    `
                    {{#controlEnabled}}<div><b>controlEnabled</b>: {{controlEnabled}}</div>{{/controlEnabled}}
                    {{#RegulatingControl}}<div><b>RegulatingControl</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{RegulatingControl}}");}); return false;'>{{RegulatingControl}}</a></div>{{/RegulatingControl}}
                    </div>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_RegulatingCondEq_collapse" aria-expanded="true" aria-controls="{{id}}_RegulatingCondEq_collapse" style="margin-left: 10px;">RegulatingCondEq</a></legend>
                    <div id="{{id}}_RegulatingCondEq_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + EnergyConnection.prototype.edit_template.call (this) +
                    `
                    <div class='form-group row'><div class='col-sm-4' for='{{id}}_controlEnabled'>controlEnabled: </div><div class='col-sm-8'><div class='form-check'><input id='{{id}}_controlEnabled' class='form-check-input' type='checkbox'{{#controlEnabled}} checked{{/controlEnabled}}></div></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_RegulatingControl'>RegulatingControl: </label><div class='col-sm-8'><input id='{{id}}_RegulatingControl' class='form-control' type='text'{{#RegulatingControl}} value='{{RegulatingControl}}'{{/RegulatingControl}}></div></div>
                    </div>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "RegulatingCondEq" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_controlEnabled").checked; if (temp) obj["controlEnabled"] = true;
                temp = document.getElementById (id + "_RegulatingControl").value; if ("" !== temp) obj["RegulatingControl"] = temp;
         ...
         *
         */
        class PowerElectronicsConnection extends RegulatingCondEq
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.PowerElectronicsConnection;
                if (null == bucket)
                   cim_data.PowerElectronicsConnection = bucket = {};
                bucket[template.id] = template;
            }
            ...
            {
               super.remove (obj, cim_data);
               delete cim_data.PowerElectronicsConnection[obj.id];
            }

            parse (context, sub)
            {
                let obj = RegulatingCondEq.prototype.parse.call (this, context, sub);
                obj.cls = "PowerElectronicsConnection";
                base.parse_element (/<cim:PowerElectronicsConnection.maxQ>([\s\S]*?)<\/cim:PowerElectronicsConnection.maxQ>/g, obj, "maxQ", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnection.minQ>([\s\S]*?)<\/cim:PowerElectronicsConnection.minQ>/g, obj, "minQ", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnection.p>([\s\S]*?)<\/cim:PowerElectronicsConnection.p>/g, obj, "p", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnection.q>([\s\S]*?)<\/cim:PowerElectronicsConnection.q>/g, obj, "q", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnection.r>([\s\S]*?)<\/cim:PowerElectronicsConnection.r>/g, obj, "r", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnection.r0>([\s\S]*?)<\/cim:PowerElectronicsConnection.r0>/g, obj, "r0", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnection.ratedS>([\s\S]*?)<\/cim:PowerElectronicsConnection.ratedS>/g, obj, "ratedS", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnection.ratedU>([\s\S]*?)<\/cim:PowerElectronicsConnection.ratedU>/g, obj, "ratedU", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnection.rn>([\s\S]*?)<\/cim:PowerElectronicsConnection.rn>/g, obj, "rn", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnection.x>([\s\S]*?)<\/cim:PowerElectronicsConnection.x>/g, obj, "x", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnection.x0>([\s\S]*?)<\/cim:PowerElectronicsConnection.x0>/g, obj, "x0", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnection.xn>([\s\S]*?)<\/cim:PowerElectronicsConnection.xn>/g, obj, "xn", base.to_string, sub, context);
                base.parse_element (/<cim:PowerElectronicsConnection.maxIFault>([\s\S]*?)<\/cim:PowerElectronicsConnection.maxIFault>/g, obj, "maxIFault", base.to_string, sub, context);
                base.parse_attributes (/<cim:PowerElectronicsConnection.PowerElectronicsConnectionPhase\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "PowerElectronicsConnectionPhase", sub, context);
                base.parse_attribute (/<cim:PowerElectronicsConnection.WindTurbineType3or4Dynamics\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "WindTurbineType3or4Dynamics", sub, context);
                base.parse_attributes (/<cim:PowerElectronicsConnection.PowerElectronicsUnit\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "PowerElectronicsUnit", sub, context);
                let bucket = context.parsed.PowerElectronicsConnection;
                if (null == bucket)
                   context.parsed.PowerElectronicsConnection = bucket = {};
                bucket[obj.id] = obj;
            ...
            export (obj, full)
            {
                let fields = RegulatingCondEq.prototype.export.call (this, obj, false);

                base.export_element (obj, "PowerElectronicsConnection", "maxQ", "maxQ",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnection", "minQ", "minQ",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnection", "p", "p",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnection", "q", "q",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnection", "r", "r",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnection", "r0", "r0",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnection", "ratedS", "ratedS",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnection", "ratedU", "ratedU",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnection", "rn", "rn",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnection", "x", "x",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnection", "x0", "x0",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnection", "xn", "xn",  base.from_string, fields);
                base.export_element (obj, "PowerElectronicsConnection", "maxIFault", "maxIFault",  base.from_string, fields);
                base.export_attributes (obj, "PowerElectronicsConnection", "PowerElectronicsConnectionPhase", "PowerElectronicsConnectionPhase", fields);
                base.export_attribute (obj, "PowerElectronicsConnection", "WindTurbineType3or4Dynamics", "WindTurbineType3or4Dynamics", fields);
                base.export_attributes (obj, "PowerElectronicsConnection", "PowerElectronicsUnit", "PowerElectronicsUnit", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PowerElectronicsConnection_collapse" aria-expanded="true" aria-controls="PowerElectronicsConnection_collapse" style="margin-left: 10px;">PowerElectronicsConnection</a></legend>
                    <div id="PowerElectronicsConnection_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    ...
                    {{#maxIFault}}<div><b>maxIFault</b>: {{maxIFault}}</div>{{/maxIFault}}
                    {{#PowerElectronicsConnectionPhase}}<div><b>PowerElectronicsConnectionPhase</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/PowerElectronicsConnectionPhase}}
                    ...
                    {{#PowerElectronicsUnit}}<div><b>PowerElectronicsUnit</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/PowerElectronicsUnit}}
                    </div>
                    </fieldset>
            ...
            {
                super.condition (obj);
                if (obj["PowerElectronicsConnectionPhase"]) obj["PowerElectronicsConnectionPhase_string"] = obj["PowerElectronicsConnectionPhase"].join ();
                if (obj["PowerElectronicsUnit"]) obj["PowerElectronicsUnit_string"] = obj["PowerElectronicsUnit"].join ();
            }

            uncondition (obj)
            {
                super.uncondition (obj);
                delete obj["PowerElectronicsConnectionPhase_string"];
                delete obj["PowerElectronicsUnit_string"];
            }
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PowerElectronicsConnection_collapse" aria-expanded="true" aria-controls="{{id}}_PowerElectronicsConnection_collapse" style="margin-left: 10px;">PowerElectronicsConnection</a></legend>
                    <div id="{{id}}_PowerElectronicsConnection_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_maxIFault'>maxIFault: </label><div class='col-sm-8'><input id='{{id}}_maxIFault' class='form-control' type='text'{{#maxIFault}} value='{{maxIFault}}'{{/maxIFault}}></div></div>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PowerElectronicsConnection" };
                super.submit (id, obj);
                ...
                temp = document.getElementById (id + "_maxIFault").value; if ("" !== temp) obj["maxIFault"] = temp;
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["PowerElectronicsConnectionPhase", "0..*", "1", "PowerElectronicsConnectionPhase", "PowerElectronicsConnection"],
                            ["WindTurbineType3or4Dynamics", "0..1", "1", "WindTurbineType3or4Dynamics", "PowerElectronicsConnection"],
                            ["PowerElectronicsUnit", "0..*", "1", "PowerElectronicsUnit", "PowerElectronicsConnection"]
                        ]
                    )
                );
            }
        ...
        class ShuntCompensator extends RegulatingCondEq
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ShuntCompensator;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#ShuntCompensator_collapse" aria-expanded="true" aria-controls="ShuntCompensator_collapse" style="margin-left: 10px;">ShuntCompensator</a></legend>
            ...
            {
                super.condition (obj);
                obj["phaseConnectionPhaseShuntConnectionKind"] = [{ id: '', selected: (!obj["phaseConnection"])}]; for (let property in PhaseShuntConnectionKind) obj["phaseConnectionPhaseShuntConnectionKind"].push ({ id: property, selected: obj["phaseConnection"] && obj["phaseConnection"].endsWith ('.' + property)});
                if (obj["ShuntCompensatorPhase"]) obj["ShuntCompensatorPhase_string"] = obj["ShuntCompensatorPhase"].join ();
                if (obj["SvShuntCompensatorSections"]) obj["SvShuntCompensatorSections_string"] = obj["SvShuntCompensatorSections"].join ();
            }
            ...
            uncondition (obj)
            {
                ...
                delete obj["SvShuntCompensatorSections_string"];
            }
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_ShuntCompensator_collapse" aria-expanded="true" aria-controls="{{id}}_ShuntCompensator_collapse" style="margin-left: 10px;">ShuntCompensator</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ShuntCompensator" };
                super.submit (id, obj);
        ...
        class EnergyConsumer extends EnergyConnection
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.EnergyConsumer;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.EnergyConsumer;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#EnergyConsumer_collapse" aria-expanded="true" aria-controls="EnergyConsumer_collapse" style="margin-left: 10px;">EnergyConsumer</a></legend>
                    ...
                    {{#LoadResponse}}<div><b>LoadResponse</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{LoadResponse}}");}); return false;'>{{LoadResponse}}</a></div>{{/LoadResponse}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_EnergyConsumer_collapse" aria-expanded="true" aria-controls="{{id}}_EnergyConsumer_collapse" style="margin-left: 10px;">EnergyConsumer</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "EnergyConsumer" };
                super.submit (id, obj);
        ...
        class RotatingMachine extends RegulatingCondEq
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.RotatingMachine;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.RotatingMachine;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#RotatingMachine_collapse" aria-expanded="true" aria-controls="RotatingMachine_collapse" style="margin-left: 10px;">RotatingMachine</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_RotatingMachine_collapse" aria-expanded="true" aria-controls="{{id}}_RotatingMachine_collapse" style="margin-left: 10px;">RotatingMachine</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "RotatingMachine" };
                super.submit (id, obj);
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["GeneratingUnit", "0..1", "0..*", "GeneratingUnit", "RotatingMachine"]
                        ]
                    )
                );
            }
        ...
        class NonlinearShuntCompensator extends ShuntCompensator
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.NonlinearShuntCompensator;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = ShuntCompensator.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.NonlinearShuntCompensator;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = ShuntCompensator.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#NonlinearShuntCompensator_collapse" aria-expanded="true" aria-controls="NonlinearShuntCompensator_collapse" style="margin-left: 10px;">NonlinearShuntCompensator</a></legend>
                    ...
                    `
                    {{#NonlinearShuntCompensatorPoints}}<div><b>NonlinearShuntCompensatorPoints</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/NonlinearShuntCompensatorPoints}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_NonlinearShuntCompensator_collapse" aria-expanded="true" aria-controls="{{id}}_NonlinearShuntCompensator_collapse" style="margin-left: 10px;">NonlinearShuntCompensator</a></legend>
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "NonlinearShuntCompensator" };
                super.submit (id, obj);
        ...
        class StaticVarCompensator extends RegulatingCondEq
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.StaticVarCompensator;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_attribute (/<cim:StaticVarCompensator.StaticVarCompensatorDynamics\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "StaticVarCompensatorDynamics", sub, context);
                let bucket = context.parsed.StaticVarCompensator;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "StaticVarCompensator", "StaticVarCompensatorDynamics", "StaticVarCompensatorDynamics", fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#StaticVarCompensator_collapse" aria-expanded="true" aria-controls="StaticVarCompensator_collapse" style="margin-left: 10px;">StaticVarCompensator</a></legend>
                    ...
                    {{#q}}<div><b>q</b>: {{q}}</div>{{/q}}
                    {{#StaticVarCompensatorDynamics}}<div><b>StaticVarCompensatorDynamics</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{StaticVarCompensatorDynamics}}");}); return false;'>{{StaticVarCompensatorDynamics}}</a></div>{{/StaticVarCompensatorDynamics}}
                    </div>
                    </fieldset>
            ...
            {
                super.condition (obj);
                obj["sVCControlModeSVCControlMode"] = [{ id: '', selected: (!obj["sVCControlMode"])}]; for (let property in SVCControlMode) obj["sVCControlModeSVCControlMode"].push ({ id: property, selected: obj["sVCControlMode"] && obj["sVCControlMode"].endsWith ('.' + property)});
            }
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_StaticVarCompensator_collapse" aria-expanded="true" aria-controls="{{id}}_StaticVarCompensator_collapse" style="margin-left: 10px;">StaticVarCompensator</a></legend>
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_q'>q: </label><div class='col-sm-8'><input id='{{id}}_q' class='form-control' type='text'{{#q}} value='{{q}}'{{/q}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_StaticVarCompensatorDynamics'>StaticVarCompensatorDynamics: </label><div class='col-sm-8'><input id='{{id}}_StaticVarCompensatorDynamics' class='form-control' type='text'{{#StaticVarCompensatorDynamics}} value='{{StaticVarCompensatorDynamics}}'{{/StaticVarCompensatorDynamics}}></div></div>
                    </div>
                    </fieldset>
                    `
                );
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "StaticVarCompensator" };
                super.submit (id, obj);
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["StaticVarCompensatorDynamics", "0..1", "1", "StaticVarCompensatorDynamics", "StaticVarCompensator"]
                        ]
                    )
                );
            }
         ...
         *
         */
        class EnergySource extends EnergyConnection
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.EnergySource;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:EnergySource.pMin>([\s\S]*?)<\/cim:EnergySource.pMin>/g, obj, "pMin", base.to_string, sub, context);
                base.parse_element (/<cim:EnergySource.pMax>([\s\S]*?)<\/cim:EnergySource.pMax>/g, obj, "pMax", base.to_string, sub, context);
                base.parse_attribute (/<cim:EnergySource.EnergySourceAction\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "EnergySourceAction", sub, context);
                base.parse_attributes (/<cim:EnergySource.EnergySourcePhase\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "EnergySourcePhase", sub, context);
                ...
                let bucket = context.parsed.EnergySource;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "EnergySource", "pMin", "pMin",  base.from_string, fields);
                base.export_element (obj, "EnergySource", "pMax", "pMax",  base.from_string, fields);
                base.export_attribute (obj, "EnergySource", "EnergySourceAction", "EnergySourceAction", fields);
                base.export_attributes (obj, "EnergySource", "EnergySourcePhase", "EnergySourcePhase", fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#EnergySource_collapse" aria-expanded="true" aria-controls="EnergySource_collapse" style="margin-left: 10px;">EnergySource</a></legend>
                    ...
                    {{#EnergySourceAction}}<div><b>EnergySourceAction</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{EnergySourceAction}}");}); return false;'>{{EnergySourceAction}}</a></div>{{/EnergySourceAction}}
                    {{#EnergySourcePhase}}<div><b>EnergySourcePhase</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/EnergySourcePhase}}
                    {{#EnergySchedulingType}}<div><b>EnergySchedulingType</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{EnergySchedulingType}}");}); return false;'>{{EnergySchedulingType}}</a></div>{{/EnergySchedulingType}}
                    </div>
                    </fieldset>
            ...
            {
                super.condition (obj);
                if (obj["EnergySourcePhase"]) obj["EnergySourcePhase_string"] = obj["EnergySourcePhase"].join ();
            }

            uncondition (obj)
            {
                super.uncondition (obj);
                delete obj["EnergySourcePhase_string"];
            }
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_EnergySource_collapse" aria-expanded="true" aria-controls="{{id}}_EnergySource_collapse" style="margin-left: 10px;">EnergySource</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "EnergySource" };
                super.submit (id, obj);
                ...
                return (
                    super.relations ().concat (
                        [
                            ...
                            ["EnergySourcePhase", "0..*", "1", "EnergySourcePhase", "EnergySource"],
        ...
        class LinearShuntCompensator extends ShuntCompensator
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.LinearShuntCompensator;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.LinearShuntCompensator;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#LinearShuntCompensator_collapse" aria-expanded="true" aria-controls="LinearShuntCompensator_collapse" style="margin-left: 10px;">LinearShuntCompensator</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_LinearShuntCompensator_collapse" aria-expanded="true" aria-controls="{{id}}_LinearShuntCompensator_collapse" style="margin-left: 10px;">LinearShuntCompensator</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "LinearShuntCompensator" };
                super.submit (id, obj);
        ...
        class FrequencyConverter extends RegulatingCondEq
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.FrequencyConverter;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.FrequencyConverter;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#FrequencyConverter_collapse" aria-expanded="true" aria-controls="FrequencyConverter_collapse" style="margin-left: 10px;">FrequencyConverter</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_FrequencyConverter_collapse" aria-expanded="true" aria-controls="{{id}}_FrequencyConverter_collapse" style="margin-left: 10px;">FrequencyConverter</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "FrequencyConverter" };
                super.submit (id, obj);
        ...
        class ExternalNetworkInjection extends RegulatingCondEq
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ExternalNetworkInjection;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ExternalNetworkInjection;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#ExternalNetworkInjection_collapse" aria-expanded="true" aria-controls="ExternalNetworkInjection_collapse" style="margin-left: 10px;">ExternalNetworkInjection</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_ExternalNetworkInjection_collapse" aria-expanded="true" aria-controls="{{id}}_ExternalNetworkInjection_collapse" style="margin-left: 10px;">ExternalNetworkInjection</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ExternalNetworkInjection" };
                super.submit (id, obj);
        ...
        class SynchronousMachine extends RotatingMachine
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.SynchronousMachine;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.SynchronousMachine;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#SynchronousMachine_collapse" aria-expanded="true" aria-controls="SynchronousMachine_collapse" style="margin-left: 10px;">SynchronousMachine</a></legend>
                    ...
                    {{#PrimeMovers}}<div><b>PrimeMovers</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/PrimeMovers}}
                    {{#InitialReactiveCapabilityCurve}}<div><b>InitialReactiveCapabilityCurve</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{InitialReactiveCapabilityCurve}}");}); return false;'>{{InitialReactiveCapabilityCurve}}</a></div>{{/InitialReactiveCapabilityCurve}}
                    ...
                    {{#ReactiveCapabilityCurves}}<div><b>ReactiveCapabilityCurves</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/ReactiveCapabilityCurves}}
                    </div>
                    </fieldset>
            ...
            {
                super.condition (obj);
                obj["coolantTypeCoolantType"] = [{ id: '', selected: (!obj["coolantType"])}]; for (let property in CoolantType) obj["coolantTypeCoolantType"].push ({ id: property, selected: obj["coolantType"] && obj["coolantType"].endsWith ('.' + property)});
                obj["operatingModeSynchronousMachineOperatingMode"] = [{ id: '', selected: (!obj["operatingMode"])}]; for (let property in SynchronousMachineOperatingMode) obj["operatingModeSynchronousMachineOperatingMode"].push ({ id: property, selected: obj["operatingMode"] && obj["operatingMode"].endsWith ('.' + property)});
                obj["shortCircuitRotorTypeShortCircuitRotorKind"] = [{ id: '', selected: (!obj["shortCircuitRotorType"])}]; for (let property in ShortCircuitRotorKind) obj["shortCircuitRotorTypeShortCircuitRotorKind"].push ({ id: property, selected: obj["shortCircuitRotorType"] && obj["shortCircuitRotorType"].endsWith ('.' + property)});
                obj["typeSynchronousMachineKind"] = [{ id: '', selected: (!obj["type"])}]; for (let property in SynchronousMachineKind) obj["typeSynchronousMachineKind"].push ({ id: property, selected: obj["type"] && obj["type"].endsWith ('.' + property)});
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_SynchronousMachine_collapse" aria-expanded="true" aria-controls="{{id}}_SynchronousMachine_collapse" style="margin-left: 10px;">SynchronousMachine</a></legend>
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_PrimeMovers'>PrimeMovers: </label><div class='col-sm-8'><input id='{{id}}_PrimeMovers' class='form-control' type='text'{{#PrimeMovers}} value='{{PrimeMovers_string}}'{{/PrimeMovers}}></div></div>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "SynchronousMachine" };
                super.submit (id, obj);
        ...
        class AsynchronousMachine extends RotatingMachine
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.AsynchronousMachine;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#AsynchronousMachine_collapse" aria-expanded="true" aria-controls="AsynchronousMachine_collapse" style="margin-left: 10px;">AsynchronousMachine</a></legend>
            ...
            {
                super.condition (obj);
                obj["asynchronousMachineTypeAsynchronousMachineKind"] = [{ id: '', selected: (!obj["asynchronousMachineType"])}]; for (let property in AsynchronousMachineKind) obj["asynchronousMachineTypeAsynchronousMachineKind"].push ({ id: property, selected: obj["asynchronousMachineType"] && obj["asynchronousMachineType"].endsWith ('.' + property)});
            }
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_AsynchronousMachine_collapse" aria-expanded="true" aria-controls="{{id}}_AsynchronousMachine_collapse" style="margin-left: 10px;">AsynchronousMachine</a></legend>
        ...
        class PerLengthImpedance extends PerLengthLineParameter
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PerLengthImpedance;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = PerLengthLineParameter.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.PerLengthImpedance;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = PerLengthLineParameter.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PerLengthImpedance_collapse" aria-expanded="true" aria-controls="PerLengthImpedance_collapse" style="margin-left: 10px;">PerLengthImpedance</a></legend>
                    ...
                    `
                    {{#ACLineSegments}}<div><b>ACLineSegments</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/ACLineSegments}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PerLengthImpedance_collapse" aria-expanded="true" aria-controls="{{id}}_PerLengthImpedance_collapse" style="margin-left: 10px;">PerLengthImpedance</a></legend>
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "PerLengthImpedance" };
                super.submit (id, obj);
        ...
        class PerLengthPhaseImpedance extends PerLengthImpedance
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PerLengthPhaseImpedance;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = PerLengthImpedance.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.PerLengthPhaseImpedance;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = PerLengthImpedance.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PerLengthPhaseImpedance_collapse" aria-expanded="true" aria-controls="PerLengthPhaseImpedance_collapse" style="margin-left: 10px;">PerLengthPhaseImpedance</a></legend>
                    ...
                    {{#PhaseImpedanceData}}<div><b>PhaseImpedanceData</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/PhaseImpedanceData}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PerLengthPhaseImpedance_collapse" aria-expanded="true" aria-controls="{{id}}_PerLengthPhaseImpedance_collapse" style="margin-left: 10px;">PerLengthPhaseImpedance</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PerLengthPhaseImpedance" };
                super.submit (id, obj);
        ...
        class PerLengthSequenceImpedance extends PerLengthImpedance
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PerLengthSequenceImpedance;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.PerLengthSequenceImpedance;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PerLengthSequenceImpedance_collapse" aria-expanded="true" aria-controls="PerLengthSequenceImpedance_collapse" style="margin-left: 10px;">PerLengthSequenceImpedance</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PerLengthSequenceImpedance_collapse" aria-expanded="true" aria-controls="{{id}}_PerLengthSequenceImpedance_collapse" style="margin-left: 10px;">PerLengthSequenceImpedance</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PerLengthSequenceImpedance" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_b0ch").value; if ("" !== temp) obj["b0ch"] = temp;
                temp = document.getElementById (id + "_bch").value; if ("" !== temp) obj["bch"] = temp;
                temp = document.getElementById (id + "_g0ch").value; if ("" !== temp) obj["g0ch"] = temp;
        ...
        class GroundingImpedance extends EarthFaultCompensator
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GroundingImpedance;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = EarthFaultCompensator.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.GroundingImpedance;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = EarthFaultCompensator.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#GroundingImpedance_collapse" aria-expanded="true" aria-controls="GroundingImpedance_collapse" style="margin-left: 10px;">GroundingImpedance</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_GroundingImpedance_collapse" aria-expanded="true" aria-controls="{{id}}_GroundingImpedance_collapse" style="margin-left: 10px;">GroundingImpedance</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "GroundingImpedance" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_x").value; if ("" !== temp) obj["x"] = temp;
        ...
        class PetersenCoil extends EarthFaultCompensator
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PetersenCoil;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.PetersenCoil;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#PetersenCoil_collapse" aria-expanded="true" aria-controls="PetersenCoil_collapse" style="margin-left: 10px;">PetersenCoil</a></legend>
            ...
            {
                super.condition (obj);
                obj["modePetersenCoilModeKind"] = [{ id: '', selected: (!obj["mode"])}]; for (let property in PetersenCoilModeKind) obj["modePetersenCoilModeKind"].push ({ id: property, selected: obj["mode"] && obj["mode"].endsWith ('.' + property)});
            }
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_PetersenCoil_collapse" aria-expanded="true" aria-controls="{{id}}_PetersenCoil_collapse" style="margin-left: 10px;">PetersenCoil</a></legend>
        ...
        class Fuse extends Switch
        {
            ...
            parse (context, sub)
            {
                let obj = Switch.prototype.parse.call (this, context, sub);
                obj.cls = "Fuse";
                let bucket = context.parsed.Fuse;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = Switch.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Fuse_collapse" aria-expanded="true" aria-controls="Fuse_collapse" style="margin-left: 10px;">Fuse</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Fuse_collapse" aria-expanded="true" aria-controls="{{id}}_Fuse_collapse" style="margin-left: 10px;">Fuse</a></legend>
        ...
        class Cut extends Switch
        {
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Cut_collapse" aria-expanded="true" aria-controls="Cut_collapse" style="margin-left: 10px;">Cut</a></legend>
                    ...
                    {{#lengthFromTerminal1}}<div><b>lengthFromTerminal1</b>: {{lengthFromTerminal1}}</div>{{/lengthFromTerminal1}}
                    {{#ACLineSegment}}<div><b>ACLineSegment</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{ACLineSegment}}");}); return false;'>{{ACLineSegment}}</a></div>{{/ACLineSegment}}
                    {{#CutAction}}<div><b>CutAction</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{CutAction}}");}); return false;'>{{CutAction}}</a></div>{{/CutAction}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Cut_collapse" aria-expanded="true" aria-controls="{{id}}_Cut_collapse" style="margin-left: 10px;">Cut</a></legend>
        ...
        class Sectionaliser extends Switch
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.Sectionaliser;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.Sectionaliser;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Sectionaliser_collapse" aria-expanded="true" aria-controls="Sectionaliser_collapse" style="margin-left: 10px;">Sectionaliser</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Sectionaliser_collapse" aria-expanded="true" aria-controls="{{id}}_Sectionaliser_collapse" style="margin-left: 10px;">Sectionaliser</a></legend>
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "Sectionaliser" };
                super.submit (id, obj);
        ...
        class Disconnector extends Switch
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.Disconnector;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.Disconnector;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Disconnector_collapse" aria-expanded="true" aria-controls="Disconnector_collapse" style="margin-left: 10px;">Disconnector</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Disconnector_collapse" aria-expanded="true" aria-controls="{{id}}_Disconnector_collapse" style="margin-left: 10px;">Disconnector</a></legend>
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "Disconnector" };
                super.submit (id, obj);
        ...
        class Jumper extends Switch
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.Jumper;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Jumper_collapse" aria-expanded="true" aria-controls="Jumper_collapse" style="margin-left: 10px;">Jumper</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Jumper_collapse" aria-expanded="true" aria-controls="{{id}}_Jumper_collapse" style="margin-left: 10px;">Jumper</a></legend>
        ...
        class ProtectedSwitch extends Switch
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ProtectedSwitch;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.ProtectedSwitch;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#ProtectedSwitch_collapse" aria-expanded="true" aria-controls="ProtectedSwitch_collapse" style="margin-left: 10px;">ProtectedSwitch</a></legend>
                    ...
                    {{#RecloseSequences}}<div><b>RecloseSequences</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/RecloseSequences}}
                    {{#OperatedByProtectionEquipment}}<div><b>OperatedByProtectionEquipment</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{.}}");}); return false;'>{{.}}</a></div>{{/OperatedByProtectionEquipment}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_ProtectedSwitch_collapse" aria-expanded="true" aria-controls="{{id}}_ProtectedSwitch_collapse" style="margin-left: 10px;">ProtectedSwitch</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ProtectedSwitch" };
                super.submit (id, obj);
        ...
        class GroundDisconnector extends Switch
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GroundDisconnector;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GroundDisconnector;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#GroundDisconnector_collapse" aria-expanded="true" aria-controls="GroundDisconnector_collapse" style="margin-left: 10px;">GroundDisconnector</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_GroundDisconnector_collapse" aria-expanded="true" aria-controls="{{id}}_GroundDisconnector_collapse" style="margin-left: 10px;">GroundDisconnector</a></legend>
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "GroundDisconnector" };
                super.submit (id, obj);
        ...
        class LoadBreakSwitch extends ProtectedSwitch
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.LoadBreakSwitch;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = ProtectedSwitch.prototype.parse.call (this, context, sub);
                obj.cls = "LoadBreakSwitch";
                let bucket = context.parsed.LoadBreakSwitch;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = ProtectedSwitch.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#LoadBreakSwitch_collapse" aria-expanded="true" aria-controls="LoadBreakSwitch_collapse" style="margin-left: 10px;">LoadBreakSwitch</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_LoadBreakSwitch_collapse" aria-expanded="true" aria-controls="{{id}}_LoadBreakSwitch_collapse" style="margin-left: 10px;">LoadBreakSwitch</a></legend>
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "LoadBreakSwitch" };
                super.submit (id, obj);
        ...
        class Recloser extends ProtectedSwitch
        {
            ...
            parse (context, sub)
            {
                let obj = ProtectedSwitch.prototype.parse.call (this, context, sub);
                obj.cls = "Recloser";
                let bucket = context.parsed.Recloser;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Recloser_collapse" aria-expanded="true" aria-controls="Recloser_collapse" style="margin-left: 10px;">Recloser</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Recloser_collapse" aria-expanded="true" aria-controls="{{id}}_Recloser_collapse" style="margin-left: 10px;">Recloser</a></legend>
        ...
        class Breaker extends ProtectedSwitch
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.Breaker;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Breaker_collapse" aria-expanded="true" aria-controls="Breaker_collapse" style="margin-left: 10px;">Breaker</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Breaker_collapse" aria-expanded="true" aria-controls="{{id}}_Breaker_collapse" style="margin-left: 10px;">Breaker</a></legend>
        ...
        class Junction extends Connector
        {
            ...
            parse (context, sub)
            {
                let obj = Connector.prototype.parse.call (this, context, sub);
                obj.cls = "Junction";
                let bucket = context.parsed.Junction;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = Connector.prototype.export.call (this, obj, false);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#Junction_collapse" aria-expanded="true" aria-controls="Junction_collapse" style="margin-left: 10px;">Junction</a></legend>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_Junction_collapse" aria-expanded="true" aria-controls="{{id}}_Junction_collapse" style="margin-left: 10px;">Junction</a></legend>
        ...
        class BusbarSection extends Connector
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.BusbarSection;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.BusbarSection;
                if (null == bucket)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#BusbarSection_collapse" aria-expanded="true" aria-controls="BusbarSection_collapse" style="margin-left: 10px;">BusbarSection</a></legend>
                    <div id="BusbarSection_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + Connector.prototype.template.call (this) +
                    `
                    {{#ipMax}}<div><b>ipMax</b>: {{ipMax}}</div>{{/ipMax}}
                    {{#VoltageControlZone}}<div><b>VoltageControlZone</b>: <a href='#' onclick='require(["cimmap"], function(cimmap) {cimmap.select ("{{VoltageControlZone}}");}); return false;'>{{VoltageControlZone}}</a></div>{{/VoltageControlZone}}
                    </div>
                    </fieldset>
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_BusbarSection_collapse" aria-expanded="true" aria-controls="{{id}}_BusbarSection_collapse" style="margin-left: 10px;">BusbarSection</a></legend>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "BusbarSection" };
                super.submit (id, obj);
