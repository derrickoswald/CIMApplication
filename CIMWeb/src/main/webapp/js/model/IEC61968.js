...
(
    ...
    function (base)
    {
        ...
        function parse_IEC61968CIMVersion (context, sub)
        {
             ...
             *
             */
            obj["date"] = base.parse_element (/<cim:IEC61968CIMVersion.date>([\s\S]*?)<\/cim:IEC61968CIMVersion.date>/g, sub, context, true);
            /**
             ...
             *
             */
            obj["version"] = base.parse_element (/<cim:IEC61968CIMVersion.version>([\s\S]*?)<\/cim:IEC61968CIMVersion.version>/g, sub, context, true);
