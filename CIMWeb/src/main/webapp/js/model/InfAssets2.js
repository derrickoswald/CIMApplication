    ...
    function (base, Assets, InfAssets)
    {
        ...
        class Tower extends Assets.Structure
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = InfAssets.TowerConstructionKind[document.getElementById (id + "_constructionKind").value]; if (temp) obj["constructionKind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#TowerConstructionKind." + temp; else delete obj["constructionKind"];
        ...
        class Pole extends Assets.Structure
        {
            ...
            submit (id, obj)
            {
                ...
                temp = InfAssets.PoleTreatmentKind[document.getElementById (id + "_treatmentKind").value]; if (temp) obj["treatmentKind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#PoleTreatmentKind." + temp; else delete obj["treatmentKind"];
                temp = InfAssets.PoleBaseKind[document.getElementById (id + "_baseKind").value]; if (temp) obj["baseKind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#PoleBaseKind." + temp; else delete obj["baseKind"];
                temp = InfAssets.PolePreservativeKind[document.getElementById (id + "_preservativeKind").value]; if (temp) obj["preservativeKind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#PolePreservativeKind." + temp; else delete obj["preservativeKind"];
        ...
        class UndergroundStructure extends Assets.Structure
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = InfAssets.UndergroundStructureKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#UndergroundStructureKind." + temp; else delete obj["kind"];
