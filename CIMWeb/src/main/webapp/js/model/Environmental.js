    ...
    function (base, AssetMeas, Common, Core, EnvDomain, Meas)
    {
        ...
        class EnvironmentalLocationType extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = EnvDomain.LocationKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#LocationKind." + temp; else delete obj["kind"];
        ...
        class EnvironmentalDiscrete extends Meas.Discrete
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = EnvDomain.EnvironmentalDiscreteKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#EnvironmentalDiscreteKind." + temp; else delete obj["kind"];
                temp = document.getElementById (id + "_EnvironmentalInformation").value; if ("" !== temp) obj["EnvironmentalInformation"] = temp;
        ...
        class EnvironmentalCodedValue extends Meas.StringMeasurementValue
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = EnvDomain.CoverageCodeKind[document.getElementById (id + "_coverageKind").value]; if (temp) obj["coverageKind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#CoverageCodeKind." + temp; else delete obj["coverageKind"];
                temp = EnvDomain.IntensityCodeKind[document.getElementById (id + "_intensityKind").value]; if (temp) obj["intensityKind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#IntensityCodeKind." + temp; else delete obj["intensityKind"];
                temp = document.getElementById (id + "_probabilityPercent").value; if ("" !== temp) obj["probabilityPercent"] = temp;
                temp = EnvDomain.WeatherCodeKind[document.getElementById (id + "_weatherKind").value]; if (temp) obj["weatherKind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#WeatherCodeKind." + temp; else delete obj["weatherKind"];
        ...
        class ClassificationCondition extends Core.IdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                temp = EnvDomain.TestKind[document.getElementById (id + "_test").value]; if (temp) obj["test"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#TestKind." + temp; else delete obj["test"];
        ...
        class ReportingCapability extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                temp = AssetMeas.CalculationIntervalUnitKind[document.getElementById (id + "_reportingIntervalType").value]; if (temp) obj["reportingIntervalType"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#CalculationIntervalUnitKind." + temp; else delete obj["reportingIntervalType"];
                temp = EnvDomain.ReportingMethodKind[document.getElementById (id + "_reportingMethod").value]; if (temp) obj["reportingMethod"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#ReportingMethodKind." + temp; else delete obj["reportingMethod"];
                temp = document.getElementById (id + "_EnvironmentalMonitoringStation").value; if ("" !== temp) obj["EnvironmentalMonitoringStation"] = temp;
        ...
        class SpaceAnalog extends EnvironmentalAnalog
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = EnvDomain.SpaceAnalogKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#SpaceAnalogKind." + temp; else delete obj["kind"];
        ...
        class HydrosphericAnalog extends EnvironmentalAnalog
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = EnvDomain.HydrosphericAnalogKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#HydrosphericAnalogKind." + temp; else delete obj["kind"];
        ...
        class AtmosphericAnalog extends EnvironmentalAnalog
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = EnvDomain.AtmosphericAnalogKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#AtmosphericAnalogKind." + temp; else delete obj["kind"];
        ...
        class GeosphericAnalog extends EnvironmentalAnalog
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = EnvDomain.GeosphericAnalogKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#GeosphericAnalogKind." + temp; else delete obj["kind"];
        ...
        class CloudCondition extends AtmosphericPhenomenon
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = EnvDomain.CloudKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#CloudKind." + temp; else delete obj["kind"];
        ...
        class Tornado extends AtmosphericPhenomenon
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = EnvDomain.FScale[document.getElementById (id + "_fScale").value]; if (temp) obj["fScale"] = "http://iec.ch/TC57/2013/CIM-schema-cim16#FScale." + temp; else delete obj["fScale"];
