    ...
    function (base, Common, Core, Work)
    {
        ...
        class PropertyUnit extends WorkIdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                temp = WorkActionKind[document.getElementById (id + "_activityCode").value]; if (temp) obj["activityCode"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#WorkActionKind." + temp; else delete obj["activityCode"];
        ...
        class DesignLocationCU extends WorkIdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                temp = WorkActionKind[document.getElementById (id + "_cuAction").value]; if (temp) obj["cuAction"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#WorkActionKind." + temp; else delete obj["cuAction"];
        ...
        class ConditionFactor extends WorkIdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                temp = ConditionFactorKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ConditionFactorKind." + temp; else delete obj["kind"];
                temp = document.getElementById (id + "_status").value; if ("" !== temp) obj["status"] = temp;
        ...
        class Design extends WorkDocument
        {
            ...
            submit (id, obj)
            {
                ...
                temp = DesignKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#DesignKind." + temp; else delete obj["kind"];
