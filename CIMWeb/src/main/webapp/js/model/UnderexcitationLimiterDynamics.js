    ...
    function (base, StandardModels)
    {
        ...
        class UnderexcitationLimiterDynamics extends StandardModels.DynamicsFunctionBlock
        {
            constructor (template, cim_data)
            {
                ...
                let bucket = cim_data.UnderexcitationLimiterDynamics;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.UnderexcitationLimiterDynamics;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "UnderexcitationLimiterDynamics" };
                super.submit (id, obj);
        ...
        class UnderexcLimX2 extends UnderexcitationLimiterDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.UnderexcLimX2;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = UnderexcitationLimiterDynamics.prototype.parse.call (this, context, sub);
            ...
            export (obj, full)
            {
                let fields = UnderexcitationLimiterDynamics.prototype.export.call (this, obj, false);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "UnderexcLimX2" };
                super.submit (id, obj);
        ...
        class UnderexcLim2Simplified extends UnderexcitationLimiterDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.UnderexcLim2Simplified;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.UnderexcLim2Simplified;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "UnderexcLim2Simplified" };
                super.submit (id, obj);
        ...
        class UnderexcLimIEEE1 extends UnderexcitationLimiterDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.UnderexcLimIEEE1;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.UnderexcLimIEEE1;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "UnderexcLimIEEE1" };
                super.submit (id, obj);
        ...
        class UnderexcLimIEEE2 extends UnderexcitationLimiterDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.UnderexcLimIEEE2;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.UnderexcLimIEEE2;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "UnderexcLimIEEE2" };
                super.submit (id, obj);
        ...
        class UnderexcLimX1 extends UnderexcitationLimiterDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.UnderexcLimX1;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.UnderexcLimX1;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "UnderexcLimX1" };
                super.submit (id, obj);
