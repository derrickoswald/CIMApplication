...
(
    ...
    function (base, Core)
    {
         ...
         *
         */
        let HydroTurbineKind =
        {
            "francis": "francis",
            "pelton": "pelton",
            "kaplan": "kaplan"
        };
        Object.freeze (HydroTurbineKind);

        /**
         * Boiler control mode.
         *
         */
        let BoilerControlMode =
        {
            "following": "following",
        ...
        class PrimeMover extends Core.PowerSystemResource
        {
            constructor (template, cim_data)
            {
                ...
                let bucket = cim_data.PrimeMover;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.PrimeMover;
                if (null == bucket)
        ...
        class SteamSupply extends Core.PowerSystemResource
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.SteamSupply;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.SteamSupply;
                if (null == bucket)
        ...
        class CTTempActivePowerCurve extends Core.Curve
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.CTTempActivePowerCurve;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.CTTempActivePowerCurve;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "CTTempActivePowerCurve" };
                super.submit (id, obj);
        ...
        class SteamTurbine extends PrimeMover
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.SteamTurbine;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = PrimeMover.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.SteamTurbine;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = PrimeMover.prototype.export.call (this, obj, false);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "SteamTurbine" };
                super.submit (id, obj);
        ...
        class HydroTurbine extends PrimeMover
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.HydroTurbine;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.HydroTurbine;
                if (null == bucket)
            ...
            {
                super.condition (obj);
                obj["turbineTypeHydroTurbineKind"] = [{ id: '', selected: (!obj["turbineType"])}]; for (let property in HydroTurbineKind) obj["turbineTypeHydroTurbineKind"].push ({ id: property, selected: obj["turbineType"] && obj["turbineType"].endsWith ('.' + property)});
            }
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "HydroTurbine" };
                super.submit (id, obj);
        ...
        class CombustionTurbine extends PrimeMover
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.CombustionTurbine;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.CombustionTurbine;
                if (null == bucket)
            ...
            edit_template ()
            {
                return (
                    ...
                    <div class='form-group row'><div class='col-sm-4' for='{{id}}_heatRecoveryFlag'>heatRecoveryFlag: </div><div class='col-sm-8'><div class='form-check'><input id='{{id}}_heatRecoveryFlag' class='form-check-input' type='checkbox'{{#heatRecoveryFlag}} checked{{/heatRecoveryFlag}}></div></div></div>
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "CombustionTurbine" };
                super.submit (id, obj);
        ...
        class FossilSteamSupply extends SteamSupply
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.FossilSteamSupply;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = SteamSupply.prototype.parse.call (this, context, sub);
                ...
                let bucket = context.parsed.FossilSteamSupply;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = SteamSupply.prototype.export.call (this, obj, false);
            ...
            {
                super.condition (obj);
                obj["boilerControlModeBoilerControlMode"] = [{ id: '', selected: (!obj["boilerControlMode"])}]; for (let property in BoilerControlMode) obj["boilerControlModeBoilerControlMode"].push ({ id: property, selected: obj["boilerControlMode"] && obj["boilerControlMode"].endsWith ('.' + property)});
            }
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "FossilSteamSupply" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_auxPowerVersusFrequency").value; if ("" !== temp) obj["auxPowerVersusFrequency"] = temp;
                temp = document.getElementById (id + "_auxPowerVersusVoltage").value; if ("" !== temp) obj["auxPowerVersusVoltage"] = temp;
        ...
        class Supercritical extends FossilSteamSupply
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.Supercritical;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = FossilSteamSupply.prototype.parse.call (this, context, sub);
                obj.cls = "Supercritical";
                let bucket = context.parsed.Supercritical;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = FossilSteamSupply.prototype.export.call (this, obj, false);
            ...
            submit (id, obj)
            {
                obj = obj || { id: id, cls: "Supercritical" };
                super.submit (id, obj);
        ...
        class DrumBoiler extends FossilSteamSupply
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.DrumBoiler;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.DrumBoiler;
                if (null == bucket)
        ...
        class PWRSteamSupply extends SteamSupply
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.PWRSteamSupply;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.PWRSteamSupply;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "PWRSteamSupply" };
                super.submit (id, obj);
        ...
        class HeatRecoveryBoiler extends FossilSteamSupply
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.HeatRecoveryBoiler;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.HeatRecoveryBoiler;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "HeatRecoveryBoiler" };
                super.submit (id, obj);
        ...
        class Subcritical extends FossilSteamSupply
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.Subcritical;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = FossilSteamSupply.prototype.parse.call (this, context, sub);
                obj.cls = "Subcritical";
                let bucket = context.parsed.Subcritical;
                if (null == bucket)
        ...
        class BWRSteamSupply extends SteamSupply
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.BWRSteamSupply;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.BWRSteamSupply;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "BWRSteamSupply" };
                super.submit (id, obj);
