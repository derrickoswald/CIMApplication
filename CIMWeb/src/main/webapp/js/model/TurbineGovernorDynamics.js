...
(
    ...
    function (base, StandardModels)
    {
         ...
         *
         */
        let FrancisGovernorControlKind =
        {
         ...
         *
         */
        let GovHydro4ModelKind =
        {
            "simple": "simple",
            "francisPelton": "francisPelton",
            "kaplan": "kaplan"
        };
        Object.freeze (GovHydro4ModelKind);
         ...
         *
         */
        class CrossCompoundTurbineGovernorDynamics extends StandardModels.DynamicsFunctionBlock
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.CrossCompoundTurbineGovernorDynamics;
                if (null == bucket)
                   cim_data.CrossCompoundTurbineGovernorDynamics = bucket = {};
            ...
            remove (obj, cim_data)
            {
               ...
               delete cim_data.CrossCompoundTurbineGovernorDynamics[obj.id];
            }

            parse (context, sub)
            {
                let obj = StandardModels.DynamicsFunctionBlock.prototype.parse.call (this, context, sub);
                obj.cls = "CrossCompoundTurbineGovernorDynamics";
                base.parse_attribute (/<cim:CrossCompoundTurbineGovernorDynamics.LowPressureSynchronousMachineDynamics\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "LowPressureSynchronousMachineDynamics", sub, context);
                base.parse_attribute (/<cim:CrossCompoundTurbineGovernorDynamics.HighPressureSynchronousMachineDynamics\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "HighPressureSynchronousMachineDynamics", sub, context);
                let bucket = context.parsed.CrossCompoundTurbineGovernorDynamics;
                if (null == bucket)
                   context.parsed.CrossCompoundTurbineGovernorDynamics = bucket = {};
                bucket[obj.id] = obj;
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "CrossCompoundTurbineGovernorDynamics", "LowPressureSynchronousMachineDynamics", "LowPressureSynchronousMachineDynamics", fields);
                base.export_attribute (obj, "CrossCompoundTurbineGovernorDynamics", "HighPressureSynchronousMachineDynamics", "HighPressureSynchronousMachineDynamics", fields);
                if (full)
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#CrossCompoundTurbineGovernorDynamics_collapse" aria-expanded="true" aria-controls="CrossCompoundTurbineGovernorDynamics_collapse" style="margin-left: 10px;">CrossCompoundTurbineGovernorDynamics</a></legend>
                    <div id="CrossCompoundTurbineGovernorDynamics_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_CrossCompoundTurbineGovernorDynamics_collapse" aria-expanded="true" aria-controls="{{id}}_CrossCompoundTurbineGovernorDynamics_collapse" style="margin-left: 10px;">CrossCompoundTurbineGovernorDynamics</a></legend>
                    <div id="{{id}}_CrossCompoundTurbineGovernorDynamics_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + StandardModels.DynamicsFunctionBlock.prototype.edit_template.call (this) +
                    `
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_LowPressureSynchronousMachineDynamics'>LowPressureSynchronousMachineDynamics: </label><div class='col-sm-8'><input id='{{id}}_LowPressureSynchronousMachineDynamics' class='form-control' type='text'{{#LowPressureSynchronousMachineDynamics}} value='{{LowPressureSynchronousMachineDynamics}}'{{/LowPressureSynchronousMachineDynamics}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_HighPressureSynchronousMachineDynamics'>HighPressureSynchronousMachineDynamics: </label><div class='col-sm-8'><input id='{{id}}_HighPressureSynchronousMachineDynamics' class='form-control' type='text'{{#HighPressureSynchronousMachineDynamics}} value='{{HighPressureSynchronousMachineDynamics}}'{{/HighPressureSynchronousMachineDynamics}}></div></div>
                    </div>
                    </fieldset>
                    `
                );
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "CrossCompoundTurbineGovernorDynamics" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_LowPressureSynchronousMachineDynamics").value; if ("" !== temp) obj["LowPressureSynchronousMachineDynamics"] = temp;
                temp = document.getElementById (id + "_HighPressureSynchronousMachineDynamics").value; if ("" !== temp) obj["HighPressureSynchronousMachineDynamics"] = temp;
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["LowPressureSynchronousMachineDynamics", "1", "0..1", "SynchronousMachineDynamics", "CrossCompoundTurbineGovernorDynamics"],
                            ["HighPressureSynchronousMachineDynamics", "1", "0..1", "SynchronousMachineDynamics", "CrossCompoundTurbineGovernorDyanmics"]
                        ]
                    )
                );
            }
        ...
        class TurbineGovernorDynamics extends StandardModels.DynamicsFunctionBlock
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.TurbineGovernorDynamics;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_attribute (/<cim:TurbineGovernorDynamics.SynchronousMachineDynamics\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "SynchronousMachineDynamics", sub, context);
                ...
                let bucket = context.parsed.TurbineGovernorDynamics;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "TurbineGovernorDynamics", "SynchronousMachineDynamics", "SynchronousMachineDynamics", fields);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "TurbineGovernorDynamics" };
                super.submit (id, obj);
            ...
            relations ()
            {
                return (
                    super.relations ().concat (
                        [
                            ["SynchronousMachineDynamics", "0..1", "0..*", "SynchronousMachineDynamics", "TurbineGovernorDynamics"],
         ...
         *
         */
        class GovSteamCC extends CrossCompoundTurbineGovernorDynamics
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.GovSteamCC;
                if (null == bucket)
        ...
        class GovHydroFrancis extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovHydroFrancis;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovHydroFrancis;
                if (null == bucket)
            ...
            {
                super.condition (obj);
                obj["governorControlFrancisGovernorControlKind"] = [{ id: '', selected: (!obj["governorControl"])}]; for (let property in FrancisGovernorControlKind) obj["governorControlFrancisGovernorControlKind"].push ({ id: property, selected: obj["governorControl"] && obj["governorControl"].endsWith ('.' + property)});
            }
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "GovHydroFrancis" };
                super.submit (id, obj);
        ...
        class GovSteamIEEE1 extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovSteamIEEE1;
                if (null == bucket)
        ...
        class GovHydro4 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_attribute (/<cim:GovHydro4.model\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "model", sub, context);
                ...
                base.parse_element (/<cim:GovHydro4.qnl>([\s\S]*?)<\/cim:GovHydro4.qnl>/g, obj, "qnl", base.to_string, sub, context);
                ...
                let bucket = context.parsed.GovHydro4;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_attribute (obj, "GovHydro4", "model", "model", fields);
                ...
                base.export_element (obj, "GovHydro4", "qnl", "qnl",  base.from_string, fields);
            ...
            template ()
            {
                return (
                    ...
                    {{#model}}<div><b>model</b>: {{model}}</div>{{/model}}
                    {{#mwbase}}<div><b>mwbase</b>: {{mwbase}}</div>{{/mwbase}}
            ...
            {
                super.condition (obj);
                obj["modelGovHydro4ModelKind"] = [{ id: '', selected: (!obj["model"])}]; for (let property in GovHydro4ModelKind) obj["modelGovHydro4ModelKind"].push ({ id: property, selected: obj["model"] && obj["model"].endsWith ('.' + property)});
            }

            uncondition (obj)
            {
                super.uncondition (obj);
                delete obj["modelGovHydro4ModelKind"];
            }
            ...
            edit_template ()
            {
                return (
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_model'>model: </label><div class='col-sm-8'><select id='{{id}}_model' class='form-control custom-select'>{{#modelGovHydro4ModelKind}}<option value='{{id}}'{{#selected}} selected{{/selected}}>{{id}}</option>{{/modelGovHydro4ModelKind}}</select></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_mwbase'>mwbase: </label><div class='col-sm-8'><input id='{{id}}_mwbase' class='form-control' type='text'{{#mwbase}} value='{{mwbase}}'{{/mwbase}}></div></div>
        ...
        class GovHydroPID extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovHydroPID;
                if (null == bucket)
         ...
         *
         */
        class GovSteamBB extends TurbineGovernorDynamics
        {
            constructor (template, cim_data)
            {
                super (template, cim_data);
                let bucket = cim_data.GovSteamBB;
                if (null == bucket)
                   cim_data.GovSteamBB = bucket = {};
                bucket[template.id] = template;
            }
            ...
            {
               super.remove (obj, cim_data);
               delete cim_data.GovSteamBB[obj.id];
            }
            ...
            parse (context, sub)
            {
                let obj = TurbineGovernorDynamics.prototype.parse.call (this, context, sub);
                obj.cls = "GovSteamBB";
                base.parse_element (/<cim:GovSteamBB.fcut>([\s\S]*?)<\/cim:GovSteamBB.fcut>/g, obj, "fcut", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.k2>([\s\S]*?)<\/cim:GovSteamBB.k2>/g, obj, "k2", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.k3>([\s\S]*?)<\/cim:GovSteamBB.k3>/g, obj, "k3", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.kd>([\s\S]*?)<\/cim:GovSteamBB.kd>/g, obj, "kd", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.kg>([\s\S]*?)<\/cim:GovSteamBB.kg>/g, obj, "kg", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.kls>([\s\S]*?)<\/cim:GovSteamBB.kls>/g, obj, "kls", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.kp>([\s\S]*?)<\/cim:GovSteamBB.kp>/g, obj, "kp", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.ks>([\s\S]*?)<\/cim:GovSteamBB.ks>/g, obj, "ks", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.peflag>([\s\S]*?)<\/cim:GovSteamBB.peflag>/g, obj, "peflag", base.to_boolean, sub, context);
                base.parse_element (/<cim:GovSteamBB.pmax>([\s\S]*?)<\/cim:GovSteamBB.pmax>/g, obj, "pmax", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.pmin>([\s\S]*?)<\/cim:GovSteamBB.pmin>/g, obj, "pmin", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.t1>([\s\S]*?)<\/cim:GovSteamBB.t1>/g, obj, "t1", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.t4>([\s\S]*?)<\/cim:GovSteamBB.t4>/g, obj, "t4", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.t5>([\s\S]*?)<\/cim:GovSteamBB.t5>/g, obj, "t5", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.t6>([\s\S]*?)<\/cim:GovSteamBB.t6>/g, obj, "t6", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.td>([\s\S]*?)<\/cim:GovSteamBB.td>/g, obj, "td", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamBB.tn>([\s\S]*?)<\/cim:GovSteamBB.tn>/g, obj, "tn", base.to_string, sub, context);
                let bucket = context.parsed.GovSteamBB;
                if (null == bucket)
                   context.parsed.GovSteamBB = bucket = {};
                bucket[obj.id] = obj;
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "GovSteamBB", "fcut", "fcut",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "k2", "k2",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "k3", "k3",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "kd", "kd",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "kg", "kg",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "kls", "kls",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "kp", "kp",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "ks", "ks",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "peflag", "peflag",  base.from_boolean, fields);
                base.export_element (obj, "GovSteamBB", "pmax", "pmax",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "pmin", "pmin",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "t1", "t1",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "t4", "t4",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "t5", "t5",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "t6", "t6",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "td", "td",  base.from_string, fields);
                base.export_element (obj, "GovSteamBB", "tn", "tn",  base.from_string, fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#GovSteamBB_collapse" aria-expanded="true" aria-controls="GovSteamBB_collapse" style="margin-left: 10px;">GovSteamBB</a></legend>
                    <div id="GovSteamBB_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + TurbineGovernorDynamics.prototype.template.call (this) +
                    `
                    {{#fcut}}<div><b>fcut</b>: {{fcut}}</div>{{/fcut}}
                    {{#k2}}<div><b>k2</b>: {{k2}}</div>{{/k2}}
                    {{#k3}}<div><b>k3</b>: {{k3}}</div>{{/k3}}
                    {{#kd}}<div><b>kd</b>: {{kd}}</div>{{/kd}}
                    {{#kg}}<div><b>kg</b>: {{kg}}</div>{{/kg}}
                    {{#kls}}<div><b>kls</b>: {{kls}}</div>{{/kls}}
                    {{#kp}}<div><b>kp</b>: {{kp}}</div>{{/kp}}
                    {{#ks}}<div><b>ks</b>: {{ks}}</div>{{/ks}}
                    {{#peflag}}<div><b>peflag</b>: {{peflag}}</div>{{/peflag}}
                    {{#pmax}}<div><b>pmax</b>: {{pmax}}</div>{{/pmax}}
                    {{#pmin}}<div><b>pmin</b>: {{pmin}}</div>{{/pmin}}
                    {{#t1}}<div><b>t1</b>: {{t1}}</div>{{/t1}}
                    {{#t4}}<div><b>t4</b>: {{t4}}</div>{{/t4}}
            ...
            edit_template ()
            {
                return (
                    `
                    <fieldset>
                    <legend class='col-form-legend'><a class="collapse-link" data-toggle="collapse" href="#{{id}}_GovSteamBB_collapse" aria-expanded="true" aria-controls="{{id}}_GovSteamBB_collapse" style="margin-left: 10px;">GovSteamBB</a></legend>
                    <div id="{{id}}_GovSteamBB_collapse" class="collapse in show" style="margin-left: 10px;">
                    `
                    + TurbineGovernorDynamics.prototype.edit_template.call (this) +
                    `
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_fcut'>fcut: </label><div class='col-sm-8'><input id='{{id}}_fcut' class='form-control' type='text'{{#fcut}} value='{{fcut}}'{{/fcut}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_k2'>k2: </label><div class='col-sm-8'><input id='{{id}}_k2' class='form-control' type='text'{{#k2}} value='{{k2}}'{{/k2}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_k3'>k3: </label><div class='col-sm-8'><input id='{{id}}_k3' class='form-control' type='text'{{#k3}} value='{{k3}}'{{/k3}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_kd'>kd: </label><div class='col-sm-8'><input id='{{id}}_kd' class='form-control' type='text'{{#kd}} value='{{kd}}'{{/kd}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_kg'>kg: </label><div class='col-sm-8'><input id='{{id}}_kg' class='form-control' type='text'{{#kg}} value='{{kg}}'{{/kg}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_kls'>kls: </label><div class='col-sm-8'><input id='{{id}}_kls' class='form-control' type='text'{{#kls}} value='{{kls}}'{{/kls}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_kp'>kp: </label><div class='col-sm-8'><input id='{{id}}_kp' class='form-control' type='text'{{#kp}} value='{{kp}}'{{/kp}}></div></div>
                    ...
                    <div class='form-group row'><div class='col-sm-4' for='{{id}}_peflag'>peflag: </div><div class='col-sm-8'><div class='form-check'><input id='{{id}}_peflag' class='form-check-input' type='checkbox'{{#peflag}} checked{{/peflag}}></div></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_pmax'>pmax: </label><div class='col-sm-8'><input id='{{id}}_pmax' class='form-control' type='text'{{#pmax}} value='{{pmax}}'{{/pmax}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_pmin'>pmin: </label><div class='col-sm-8'><input id='{{id}}_pmin' class='form-control' type='text'{{#pmin}} value='{{pmin}}'{{/pmin}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_t1'>t1: </label><div class='col-sm-8'><input id='{{id}}_t1' class='form-control' type='text'{{#t1}} value='{{t1}}'{{/t1}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_t4'>t4: </label><div class='col-sm-8'><input id='{{id}}_t4' class='form-control' type='text'{{#t4}} value='{{t4}}'{{/t4}}></div></div>
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_t6'>t6: </label><div class='col-sm-8'><input id='{{id}}_t6' class='form-control' type='text'{{#t6}} value='{{t6}}'{{/t6}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_td'>td: </label><div class='col-sm-8'><input id='{{id}}_td' class='form-control' type='text'{{#td}} value='{{td}}'{{/td}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_tn'>tn: </label><div class='col-sm-8'><input id='{{id}}_tn' class='form-control' type='text'{{#tn}} value='{{tn}}'{{/tn}}></div></div>
                    </div>
                    </fieldset>
                    `
                );
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "GovSteamBB" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_fcut").value; if ("" !== temp) obj["fcut"] = temp;
                temp = document.getElementById (id + "_k2").value; if ("" !== temp) obj["k2"] = temp;
                temp = document.getElementById (id + "_k3").value; if ("" !== temp) obj["k3"] = temp;
                temp = document.getElementById (id + "_kd").value; if ("" !== temp) obj["kd"] = temp;
                temp = document.getElementById (id + "_kg").value; if ("" !== temp) obj["kg"] = temp;
                temp = document.getElementById (id + "_kls").value; if ("" !== temp) obj["kls"] = temp;
                temp = document.getElementById (id + "_kp").value; if ("" !== temp) obj["kp"] = temp;
                temp = document.getElementById (id + "_ks").value; if ("" !== temp) obj["ks"] = temp;
                temp = document.getElementById (id + "_peflag").checked; if (temp) obj["peflag"] = true;
                temp = document.getElementById (id + "_pmax").value; if ("" !== temp) obj["pmax"] = temp;
                temp = document.getElementById (id + "_pmin").value; if ("" !== temp) obj["pmin"] = temp;
                temp = document.getElementById (id + "_t1").value; if ("" !== temp) obj["t1"] = temp;
                temp = document.getElementById (id + "_t4").value; if ("" !== temp) obj["t4"] = temp;
                ...
                temp = document.getElementById (id + "_t6").value; if ("" !== temp) obj["t6"] = temp;
                temp = document.getElementById (id + "_td").value; if ("" !== temp) obj["td"] = temp;
                temp = document.getElementById (id + "_tn").value; if ("" !== temp) obj["tn"] = temp;
        ...
        class GovGAST1 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovGAST1;
                if (null == bucket)
        ...
        class GovSteamFV4 extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovSteamFV4;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovSteamFV4;
                if (null == bucket)
        ...
        class GovSteamFV2 extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovSteamFV2;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovSteamFV2;
                if (null == bucket)
        ...
        class GovGAST3 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovGAST3;
                if (null == bucket)
        ...
        class GovHydroIEEE0 extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovHydroIEEE0;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovHydroIEEE0;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "GovHydroIEEE0" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_k").value; if ("" !== temp) obj["k"] = temp;
                temp = document.getElementById (id + "_mwbase").value; if ("" !== temp) obj["mwbase"] = temp;
                temp = document.getElementById (id + "_pmax").value; if ("" !== temp) obj["pmax"] = temp;
        ...
        class GovHydroR extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovHydroR;
                if (null == bucket)
        ...
        class GovHydro2 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovHydro2;
                if (null == bucket)
        ...
        class GovHydroPelton extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovHydroPelton;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovHydroPelton;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "GovHydroPelton" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_av0").value; if ("" !== temp) obj["av0"] = temp;
                temp = document.getElementById (id + "_av1").value; if ("" !== temp) obj["av1"] = temp;
                temp = document.getElementById (id + "_bp").value; if ("" !== temp) obj["bp"] = temp;
        ...
        class GovCT2 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovCT2;
                if (null == bucket)
            ...
            {
                super.condition (obj);
                obj["rselectDroopSignalFeedbackKind"] = [{ id: '', selected: (!obj["rselect"])}]; for (let property in DroopSignalFeedbackKind) obj["rselectDroopSignalFeedbackKind"].push ({ id: property, selected: obj["rselect"] && obj["rselect"].endsWith ('.' + property)});
            }
        ...
        class GovHydroIEEE2 extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovHydroIEEE2;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovHydroIEEE2;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "GovHydroIEEE2" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_aturb").value; if ("" !== temp) obj["aturb"] = temp;
                temp = document.getElementById (id + "_bturb").value; if ("" !== temp) obj["bturb"] = temp;
                temp = document.getElementById (id + "_gv1").value; if ("" !== temp) obj["gv1"] = temp;
        ...
        class GovGASTWD extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovGASTWD;
                if (null == bucket)
        ...
        class GovHydroDD extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovHydroDD;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovHydroDD;
                if (null == bucket)
        ...
        class GovSteam0 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovSteam0;
                if (null == bucket)
        ...
        class GovGAST4 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:GovGAST4.ty>([\s\S]*?)<\/cim:GovGAST4.ty>/g, obj, "ty", base.to_string, sub, context);
                let bucket = context.parsed.GovGAST4;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "GovGAST4", "ty", "ty",  base.from_string, fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
        ...
        class GovHydroWPID extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovHydroWPID;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovHydroWPID;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "GovHydroWPID" };
                super.submit (id, obj);
        ...
        class GovGAST2 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:GovGAST2.z>([\s\S]*?)<\/cim:GovGAST2.z>/g, obj, "z", base.to_string, sub, context);
                let bucket = context.parsed.GovGAST2;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "GovGAST2", "z", "z",  base.from_string, fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            edit_template ()
            {
                return (
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_y'>y: </label><div class='col-sm-8'><input id='{{id}}_y' class='form-control' type='text'{{#y}} value='{{y}}'{{/y}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_z'>z: </label><div class='col-sm-8'><input id='{{id}}_z' class='form-control' type='text'{{#z}} value='{{z}}'{{/z}}></div></div>
                    </div>
                    </fieldset>
                    `
                );
            ...
            submit (id, obj)
            {
                ...
                temp = document.getElementById (id + "_y").value; if ("" !== temp) obj["y"] = temp;
                temp = document.getElementById (id + "_z").value; if ("" !== temp) obj["z"] = temp;
        ...
        class GovCT1 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovCT1;
                if (null == bucket)
        ...
        class GovSteamSGO extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovSteamSGO;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovSteamSGO;
                if (null == bucket)
        ...
        class GovSteamFV3 extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovSteamFV3;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = TurbineGovernorDynamics.prototype.parse.call (this, context, sub);
                obj.cls = "GovSteamFV3";
                base.parse_element (/<cim:GovSteamFV3.gv1>([\s\S]*?)<\/cim:GovSteamFV3.gv1>/g, obj, "gv1", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamFV3.gv2>([\s\S]*?)<\/cim:GovSteamFV3.gv2>/g, obj, "gv2", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamFV3.gv3>([\s\S]*?)<\/cim:GovSteamFV3.gv3>/g, obj, "gv3", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamFV3.gv4>([\s\S]*?)<\/cim:GovSteamFV3.gv4>/g, obj, "gv4", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamFV3.gv5>([\s\S]*?)<\/cim:GovSteamFV3.gv5>/g, obj, "gv5", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamFV3.gv6>([\s\S]*?)<\/cim:GovSteamFV3.gv6>/g, obj, "gv6", base.to_string, sub, context);
                ...
                base.parse_element (/<cim:GovSteamFV3.pgv1>([\s\S]*?)<\/cim:GovSteamFV3.pgv1>/g, obj, "pgv1", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamFV3.pgv2>([\s\S]*?)<\/cim:GovSteamFV3.pgv2>/g, obj, "pgv2", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamFV3.pgv3>([\s\S]*?)<\/cim:GovSteamFV3.pgv3>/g, obj, "pgv3", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamFV3.pgv4>([\s\S]*?)<\/cim:GovSteamFV3.pgv4>/g, obj, "pgv4", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamFV3.pgv5>([\s\S]*?)<\/cim:GovSteamFV3.pgv5>/g, obj, "pgv5", base.to_string, sub, context);
                base.parse_element (/<cim:GovSteamFV3.pgv6>([\s\S]*?)<\/cim:GovSteamFV3.pgv6>/g, obj, "pgv6", base.to_string, sub, context);
                ...
                let bucket = context.parsed.GovSteamFV3;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "GovSteamFV3", "gv1", "gv1",  base.from_string, fields);
                base.export_element (obj, "GovSteamFV3", "gv2", "gv2",  base.from_string, fields);
                base.export_element (obj, "GovSteamFV3", "gv3", "gv3",  base.from_string, fields);
                base.export_element (obj, "GovSteamFV3", "gv4", "gv4",  base.from_string, fields);
                base.export_element (obj, "GovSteamFV3", "gv5", "gv5",  base.from_string, fields);
                base.export_element (obj, "GovSteamFV3", "gv6", "gv6",  base.from_string, fields);
                ...
                base.export_element (obj, "GovSteamFV3", "pgv1", "pgv1",  base.from_string, fields);
                base.export_element (obj, "GovSteamFV3", "pgv2", "pgv2",  base.from_string, fields);
                base.export_element (obj, "GovSteamFV3", "pgv3", "pgv3",  base.from_string, fields);
                base.export_element (obj, "GovSteamFV3", "pgv4", "pgv4",  base.from_string, fields);
                base.export_element (obj, "GovSteamFV3", "pgv5", "pgv5",  base.from_string, fields);
                base.export_element (obj, "GovSteamFV3", "pgv6", "pgv6",  base.from_string, fields);
        ...
        class GovSteamEU extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovSteamEU;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:GovSteamEU.komegacor>([\s\S]*?)<\/cim:GovSteamEU.komegacor>/g, obj, "komegacor", base.to_string, sub, context);
                ...
                let bucket = context.parsed.GovSteamEU;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "GovSteamEU", "komegacor", "komegacor",  base.from_string, fields);
            ...
            template ()
            {
                return (
                    ...
                    {{#komegacor}}<div><b>komegacor</b>: {{komegacor}}</div>{{/komegacor}}
                    {{#mwbase}}<div><b>mwbase</b>: {{mwbase}}</div>{{/mwbase}}
                    {{#pmax}}<div><b>pmax</b>: {{pmax}}</div>{{/pmax}}
            ...
            edit_template ()
            {
                return (
                    ...
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_komegacor'>komegacor: </label><div class='col-sm-8'><input id='{{id}}_komegacor' class='form-control' type='text'{{#komegacor}} value='{{komegacor}}'{{/komegacor}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_mwbase'>mwbase: </label><div class='col-sm-8'><input id='{{id}}_mwbase' class='form-control' type='text'{{#mwbase}} value='{{mwbase}}'{{/mwbase}}></div></div>
                    <div class='form-group row'><label class='col-sm-4 col-form-label' for='{{id}}_pmax'>pmax: </label><div class='col-sm-8'><input id='{{id}}_pmax' class='form-control' type='text'{{#pmax}} value='{{pmax}}'{{/pmax}}></div></div>
            ...
            submit (id, obj)
            {
                ...
                temp = document.getElementById (id + "_komegacor").value; if ("" !== temp) obj["komegacor"] = temp;
                temp = document.getElementById (id + "_mwbase").value; if ("" !== temp) obj["mwbase"] = temp;
                temp = document.getElementById (id + "_pmax").value; if ("" !== temp) obj["pmax"] = temp;
        ...
        class GovGAST extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovGAST;
                if (null == bucket)
        ...
        class GovSteam2 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovSteam2;
                if (null == bucket)
        ...
        class GovHydroPID2 extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovHydroPID2;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovHydroPID2;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "GovHydroPID2" };
                super.submit (id, obj);
        ...
        class GovHydro3 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovHydro3;
                if (null == bucket)
        ...
        class GovSteam1 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovSteam1;
                if (null == bucket)
        ...
        class GovHydro1 extends TurbineGovernorDynamics
        {
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovHydro1;
                if (null == bucket)
        ...
        class GovHydroWEH extends TurbineGovernorDynamics
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.GovHydroWEH;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.GovHydroWEH;
                if (null == bucket)
        ...
        return (
            {
                ...
                GovHydro4ModelKind: GovHydro4ModelKind,
                GovHydroR: GovHydroR,
                GovHydro4: GovHydro4,
