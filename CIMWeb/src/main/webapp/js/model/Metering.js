    ...
    function (base, Assets, Common, Core, Domain, Meas, Work)
    {
        ...
        class EndDeviceTiming extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                temp = RandomisationKind[document.getElementById (id + "_randomisation").value]; if (temp) obj["randomisation"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#RandomisationKind." + temp; else delete obj["randomisation"];
        ...
        class UsagePoint extends Core.IdentifiedObject
        {
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:UsagePoint.phaseCount>([\s\S]*?)<\/cim:UsagePoint.phaseCount>/g, obj, "phaseCount", base.to_string, sub, context);
                base.parse_attribute (/<cim:UsagePoint.physicalConnectionCapacity\s+rdf:resource\s*?=\s*?(["'])([\s\S]*?)\1\s*?\/>/g, obj, "physicalConnectionCapacity", sub, context);
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "UsagePoint", "phaseCount", "phaseCount",  base.from_string, fields);
                base.export_attribute (obj, "UsagePoint", "physicalConnectionCapacity", "physicalConnectionCapacity", fields);
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = AmiBillingReadyKind[document.getElementById (id + "_amiBillingReady").value]; if (temp) obj["amiBillingReady"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AmiBillingReadyKind." + temp; else delete obj["amiBillingReady"];
                ...
                temp = UsagePointConnectedKind[document.getElementById (id + "_connectionState").value]; if (temp) obj["connectionState"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#UsagePointConnectedKind." + temp; else delete obj["connectionState"];
        ...
        class ReadingType extends Core.IdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = AccumulationKind[document.getElementById (id + "_accumulation").value]; if (temp) obj["accumulation"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AccumulationKind." + temp; else delete obj["accumulation"];
                temp = AggregateKind[document.getElementById (id + "_aggregate").value]; if (temp) obj["aggregate"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AggregateKind." + temp; else delete obj["aggregate"];
                temp = document.getElementById (id + "_argument").value; if ("" !== temp) obj["argument"] = temp;
                temp = CommodityKind[document.getElementById (id + "_commodity").value]; if (temp) obj["commodity"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#CommodityKind." + temp; else delete obj["commodity"];
                ...
                temp = Domain.Currency[document.getElementById (id + "_currency").value]; if (temp) obj["currency"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#Currency." + temp; else delete obj["currency"];
                temp = FlowDirectionKind[document.getElementById (id + "_flowDirection").value]; if (temp) obj["flowDirection"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#FlowDirectionKind." + temp; else delete obj["flowDirection"];
                temp = document.getElementById (id + "_interharmonic").value; if ("" !== temp) obj["interharmonic"] = temp;
                temp = MacroPeriodKind[document.getElementById (id + "_macroPeriod").value]; if (temp) obj["macroPeriod"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#MacroPeriodKind." + temp; else delete obj["macroPeriod"];
                temp = MeasurementKind[document.getElementById (id + "_measurementKind").value]; if (temp) obj["measurementKind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#MeasurementKind." + temp; else delete obj["measurementKind"];
                temp = MeasuringPeriodKind[document.getElementById (id + "_measuringPeriod").value]; if (temp) obj["measuringPeriod"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#MeasuringPeriodKind." + temp; else delete obj["measuringPeriod"];
        ...
        class MeterMultiplier extends Core.IdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = MeterMultiplierKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#MeterMultiplierKind." + temp; else delete obj["kind"];
                temp = document.getElementById (id + "_value").value; if ("" !== temp) obj["value"] = temp;
                temp = document.getElementById (id + "_Meter").value; if ("" !== temp) obj["Meter"] = temp;
        ...
        class MetrologyRequirement extends Core.IdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = ReadingReasonKind[document.getElementById (id + "_reason").value]; if (temp) obj["reason"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ReadingReasonKind." + temp; else delete obj["reason"];
                temp = document.getElementById (id + "_UsagePoints").value; if ("" !== temp) obj["UsagePoints"] = temp.split (",");
        ...
        class ServiceMultiplier extends Core.IdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = ServiceMultiplierKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ServiceMultiplierKind." + temp; else delete obj["kind"];
                temp = document.getElementById (id + "_value").value; if ("" !== temp) obj["value"] = temp;
                temp = document.getElementById (id + "_UsagePoint").value; if ("" !== temp) obj["UsagePoint"] = temp;
        ...
        class PanDisplay extends EndDeviceAction
        {
            ...
            submit (id, obj)
            {
                ...
                temp = TransmissionModeKind[document.getElementById (id + "_transmissionMode").value]; if (temp) obj["transmissionMode"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#TransmissionModeKind." + temp; else delete obj["transmissionMode"];
        ...
        class SimpleEndDeviceFunction extends EndDeviceFunction
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = EndDeviceFunctionKind[document.getElementById (id + "_kind").value]; if (temp) obj["kind"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#EndDeviceFunctionKind." + temp; else delete obj["kind"];
        ...
        class ComFunction extends EndDeviceFunction
        {
            ...
            submit (id, obj)
            {
                ...
                temp = ComDirectionKind[document.getElementById (id + "_direction").value]; if (temp) obj["direction"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ComDirectionKind." + temp; else delete obj["direction"];
                temp = ComTechnologyKind[document.getElementById (id + "_technology").value]; if (temp) obj["technology"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ComTechnologyKind." + temp; else delete obj["technology"];
