    ...
    function (base, Common, ControlArea, Core, MarketPlan, Meas, MktDomain, ParticipantInterfaces, Wires)
    {
        ...
        class EnergyTransaction extends Common.Document
        {
            ...
            submit (id, obj)
            {
                ...
                temp = MktDomain.EnergyTransactionType[document.getElementById (id + "_state").value]; if (temp) obj["state"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#EnergyTransactionType." + temp; else delete obj["state"];
        ...
        class InterchangeSchedule extends Core.Curve
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = MktDomain.CheckOutType[document.getElementById (id + "_checkOutType").value]; if (temp) obj["checkOutType"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#CheckOutType." + temp; else delete obj["checkOutType"];
                temp = MktDomain.InterTieDirection[document.getElementById (id + "_directionType").value]; if (temp) obj["directionType"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#InterTieDirection." + temp; else delete obj["directionType"];
                temp = MktDomain.MarketProductType[document.getElementById (id + "_energyType").value]; if (temp) obj["energyType"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#MarketProductType." + temp; else delete obj["energyType"];
                ...
                temp = MktDomain.EnergyProductType[document.getElementById (id + "_scheduleType").value]; if (temp) obj["scheduleType"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#EnergyProductType." + temp; else delete obj["scheduleType"];
        ...
        class AreaLoadCurve extends Core.RegularIntervalSchedule
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = MktDomain.LoadForecastType[document.getElementById (id + "_forecastType").value]; if (temp) obj["forecastType"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#LoadForecastType." + temp; else delete obj["forecastType"];
        ...
        class MktAnalogLimit extends Meas.AnalogLimit
        {
            ...
            submit (id, obj)
            {
                ...
                temp = MktDomain.AnalogLimitType[document.getElementById (id + "_limitType").value]; if (temp) obj["limitType"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#AnalogLimitType." + temp; else delete obj["limitType"];
        ...
        class SwitchStatus extends base.Element
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = MktDomain.SwitchStatusType[document.getElementById (id + "_switchStatus").value]; if (temp) obj["switchStatus"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#SwitchStatusType." + temp; else delete obj["switchStatus"];
        ...
        class EnergyPriceIndex extends Core.IdentifiedObject
        {
            ...
            submit (id, obj)
            {
                ...
                temp = MktDomain.EnergyPriceIndexType[document.getElementById (id + "_energyPriceIndexType").value]; if (temp) obj["energyPriceIndexType"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#EnergyPriceIndexType." + temp; else delete obj["energyPriceIndexType"];
        ...
        class DefaultBid extends ParticipantInterfaces.Bid
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = MktDomain.BidType[document.getElementById (id + "_bidType").value]; if (temp) obj["bidType"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#BidType." + temp; else delete obj["bidType"];
                temp = document.getElementById (id + "_minLoadCost").value; if ("" !== temp) obj["minLoadCost"] = temp;
                temp = MktDomain.OnOff[document.getElementById (id + "_peakFlag").value]; if (temp) obj["peakFlag"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#OnOff." + temp; else delete obj["peakFlag"];
        ...
        class DefaultBidCurve extends Core.Curve
        {
            ...
            submit (id, obj)
            {
                ...
                temp = MktDomain.YesNo[document.getElementById (id + "_debAdderFlag").value]; if (temp) obj["debAdderFlag"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#YesNo." + temp; else delete obj["debAdderFlag"];
        ...
        class ReserveDemandCurve extends Core.Curve
        {
            ...
            submit (id, obj)
            {
                ...
                temp = MktDomain.ReserveRequirementType[document.getElementById (id + "_reserveRequirementType").value]; if (temp) obj["reserveRequirementType"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#ReserveRequirementType." + temp; else delete obj["reserveRequirementType"];
        ...
        class DefaultBidCurveData extends Core.CurveData
        {
            ...
            submit (id, obj)
            {
                ...
                super.submit (id, obj);
                temp = MktDomain.BidCalculationBasis[document.getElementById (id + "_bidSegmentCalcType").value]; if (temp) obj["bidSegmentCalcType"] = "http://iec.ch/TC57/2016/CIM-schema-cim17#BidCalculationBasis." + temp; else delete obj["bidSegmentCalcType"];
