...
(
    ...
    function (base, Core)
    {
         ...
         *
         */
        let OperationalLimitDirectionKind =
        {
            "high": "high",
            "low": "low",
        ...
        class BranchGroup extends Core.IdentifiedObject
        {
            constructor (template, cim_data)
            {
                ...
                let bucket = cim_data.BranchGroup;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.BranchGroup;
                if (null == bucket)
        ...
        class OperationalLimitType extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.OperationalLimitType;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.OperationalLimitType;
                if (null == bucket)
            ...
            {
                super.condition (obj);
                obj["directionOperationalLimitDirectionKind"] = [{ id: '', selected: (!obj["direction"])}]; for (let property in OperationalLimitDirectionKind) obj["directionOperationalLimitDirectionKind"].push ({ id: property, selected: obj["direction"] && obj["direction"].endsWith ('.' + property)});
        ...
        class BranchGroupTerminal extends base.Element
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.BranchGroupTerminal;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.BranchGroupTerminal;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "BranchGroupTerminal" };
                super.submit (id, obj);
        ...
        class OperationalLimitSet extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.OperationalLimitSet;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.OperationalLimitSet;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "OperationalLimitSet" };
                super.submit (id, obj);
        ...
        class OperationalLimit extends Core.IdentifiedObject
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.OperationalLimit;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                let bucket = context.parsed.OperationalLimit;
                if (null == bucket)
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "OperationalLimit" };
                super.submit (id, obj);
        ...
        class VoltageLimit extends OperationalLimit
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.VoltageLimit;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                let obj = OperationalLimit.prototype.parse.call (this, context, sub);
                ...
                base.parse_element (/<cim:VoltageLimit.normalValue>([\s\S]*?)<\/cim:VoltageLimit.normalValue>/g, obj, "normalValue", base.to_string, sub, context);
                let bucket = context.parsed.VoltageLimit;
                if (null == bucket)
            ...
            export (obj, full)
            {
                let fields = OperationalLimit.prototype.export.call (this, obj, false);

                base.export_element (obj, "VoltageLimit", "value", "value",  base.from_string, fields);
                base.export_element (obj, "VoltageLimit", "normalValue", "normalValue",  base.from_string, fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "VoltageLimit" };
                super.submit (id, obj);
        ...
        class ActivePowerLimit extends OperationalLimit
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ActivePowerLimit;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:ActivePowerLimit.normalValue>([\s\S]*?)<\/cim:ActivePowerLimit.normalValue>/g, obj, "normalValue", base.to_string, sub, context);
                let bucket = context.parsed.ActivePowerLimit;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "ActivePowerLimit", "normalValue", "normalValue",  base.from_string, fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ActivePowerLimit" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_value").value; if ("" !== temp) obj["value"] = temp;
                temp = document.getElementById (id + "_normalValue").value; if ("" !== temp) obj["normalValue"] = temp;
        ...
        class ApparentPowerLimit extends OperationalLimit
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.ApparentPowerLimit;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:ApparentPowerLimit.normalValue>([\s\S]*?)<\/cim:ApparentPowerLimit.normalValue>/g, obj, "normalValue", base.to_string, sub, context);
                let bucket = context.parsed.ApparentPowerLimit;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "ApparentPowerLimit", "normalValue", "normalValue",  base.from_string, fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "ApparentPowerLimit" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_value").value; if ("" !== temp) obj["value"] = temp;
                temp = document.getElementById (id + "_normalValue").value; if ("" !== temp) obj["normalValue"] = temp;
        ...
        class CurrentLimit extends OperationalLimit
        {
            ...
            {
                super (template, cim_data);
                let bucket = cim_data.CurrentLimit;
                if (null == bucket)
            ...
            parse (context, sub)
            {
                ...
                base.parse_element (/<cim:CurrentLimit.normalValue>([\s\S]*?)<\/cim:CurrentLimit.normalValue>/g, obj, "normalValue", base.to_string, sub, context);
                let bucket = context.parsed.CurrentLimit;
                if (null == bucket)
            ...
            export (obj, full)
            {
                ...
                base.export_element (obj, "CurrentLimit", "normalValue", "normalValue",  base.from_string, fields);
                if (full)
                    base.Element.prototype.export.call (this, obj, fields);
            ...
            submit (id, obj)
            {
                ...
                obj = obj || { id: id, cls: "CurrentLimit" };
                super.submit (id, obj);
                temp = document.getElementById (id + "_value").value; if ("" !== temp) obj["value"] = temp;
                temp = document.getElementById (id + "_normalValue").value; if ("" !== temp) obj["normalValue"] = temp;
