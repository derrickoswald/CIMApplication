 ...
 */
case class SchemaMaker (session: SparkSession, keyspace: String = "cimapplication", replication: Int = 2, verbose: Boolean)
{
    if (verbose)
     ...
     */
    def make (connector: CassandraConnector): Boolean =
    {
