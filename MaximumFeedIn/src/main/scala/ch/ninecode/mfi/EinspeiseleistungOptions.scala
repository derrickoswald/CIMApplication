 ...
 * @param ignore_threshold2_when_nonradial  Whether to ignore the custom threshold2 for other feeders if the trafo island is non-radial
...
(
    ...
    ignore_threshold2_when_nonradial: Boolean = false,
...
) extends Mainable with Sparkable with CIMAble with Cassandraable
{
    ...
    def asJSON: JsonObjectBuilder =
    {
        Json.createObjectBuilder
            ...
            .add("ignore_threshold2_when_nonradial", ignore_threshold2_when_nonradial)
