...
class ShortCircuitSuite extends SparkSuite with BeforeAndAfter
{
    ...
    test ("normalOpen=false open=true Fuse")
    {
        ...
        // spark-submit --master spark://sandbox:7077 --conf spark.driver.memory=2g --conf spark.executor.memory=4g /opt/code/ShortCircuit-2.11-2.4.4-2.6.0-jar-with-dependencies.jar --logging "INFO" --netz "0.0 + 0.0j" --trafoz "0.01375 + 0.05312j" --cmax 0.95 --cmin 0.95 "hdfs://sandbox:8020/fuse_nc_sample.rdf"
