...
class Transformers(shortCircuit: ShortCircuit, session: SparkSession, storage_level: StorageLevel) extends Serializable {
    ...
    def addSC(arg: ((PowerTransformer, Substation, (PowerTransformerEnd, Double, Terminal), (PowerTransformerEnd, Double, Terminal)), Option[ShortCircuitData])) =
        {
            ...
            arg._2 match {
                ...
                case None ⇒ (arg._1._1, arg._1._2, arg._1._3, arg._1._4, ShortCircuitData (arg._1._2.id, default_sk, default_wik, false))
            }
        }
    ...
    def getTransformerData(topological_nodes: Boolean = true, shortcircuitdata: String = null): RDD[TData] =
        {
            ...
            val short_circuit =
                if ((null != shortcircuitdata) && ("" != shortcircuitdata)) {
                    shortCircuit.read_csv (shortcircuitdata)
                }
                else
