...
class ModelSuite
{
    import ch.ninecode.ts.ModelSuite._
    ...
    @Test def makeModel ()
    {
        ...
        val model = Model (session, KEYSPACE, StorageLevel.MEMORY_AND_DISK_SER)
...
object ModelSuite
{
    ...
    def cassandra_port: String =
    {
        ...
        "9042" // properties.getProperty ("nativeTransportPort", "9042")
    }
    ...
    @BeforeClass def before ()
    {
        ...
        configuration.setAppName ("ModelSuite")
