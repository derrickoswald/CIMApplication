...
public class CIMManagedConnection implements ManagedConnection, DissociatableManagedConnection
{
        ...
        throws ResourceException
    {
        ...
        // ToDo: find a better way to find the CIMReader jar (/usr/local/tomee/apps/CIMApplication/CIMConnector/CIMReader-2.11-2.4.5-4.2.2.jar)
    ...
    {
        // arbitrarily pick a class to instantiate
        // ToDo: find a better way to find the CIMExport jar (/usr/local/tomee/apps/CIMApplication/CIMConnector/CIMExport-2.11-2.4.5-4.2.2.jar)
        return (jarForObject (new CIMExportOptionsParser ("CIMExport", "2.11-2.4.5-4.2.2")));
    }
