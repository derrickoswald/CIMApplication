...
public class CIMManagedConnection implements ManagedConnection, DissociatableManagedConnection
{
        ...
        throws ResourceException
    {
        ...
        // ToDo: find a better way to find the CIMReader jar (/usr/local/tomee/apps/CIMApplication/CIMConnector/CIMReader-2.12-3.0.0-5.0.1.jar)
    ...
    {
        // arbitrarily pick a class to instantiate
        // ToDo: find a better way to find the CIMExport jar (/usr/local/tomee/apps/CIMApplication/CIMConnector/CIMExport-2.12-3.0.0-5.0.1.jar)
        return (jarForObject (new CIMExportOptionsParser ("CIMExport", "2.12-3.0.0-5.0.1")));
    }
