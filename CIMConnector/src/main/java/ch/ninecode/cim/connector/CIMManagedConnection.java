 ...
 * org.apache.spark:spark-graphx_2.11-2.4.4
 * org.apache.spark:spark-yarn_2.11-2.4.4
 *
 */
public class CIMManagedConnection implements ManagedConnection, DissociatableManagedConnection
{
        ...
        throws ResourceException
    {
        ...
        // ToDo: find a better way to find the CIMReader jar (/usr/local/tomee/apps/CIMApplication/CIMConnector/CIMReader-2.11-2.4.4-4.1.0.jar)
    ...
    {
        // arbitrarily pick a class to instantiate
        // ToDo: find a better way to find the CIMExport jar (/usr/local/tomee/apps/CIMApplication/CIMConnector/CIMExport-2.11-2.4.4-4.1.0.jar)
...
//            configuration.set ("spark.sql.catalogImplementation", "hive");
    ...
    //      configuration.setSparkHome ("/home/derrick/spark/spark-2.4.4-bin-hadoop2.7/"); // ("/usr/local/spark")
    //      configuration.setExecutorEnv ("YARN_CONF_DIR", "/home/derrick/spark/spark-2.4.4-bin-hadoop2.7/conf"); // ("YARN_CONF_DIR", "/usr/local/hadoop/etc/hadoop")
