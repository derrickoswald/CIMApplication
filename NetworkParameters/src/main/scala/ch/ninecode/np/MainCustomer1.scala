...
object MainCustomer1
{
    ...
    val APPLICATION_NAME: String = "Customer1_NetworkParameters"
    ...
    def main (args: Array[String])
    {
        ...
        parser.parse (args, Arguments ()) match
        {
            case Some (arguments) =>
                ...
                if (!arguments.quiet)
                {
                    org.apache.log4j.LogManager.getLogger ("ch.ninecode.np.MainCustomer1$").setLevel (org.apache.log4j.Level.INFO)
                    org.apache.log4j.LogManager.getLogger ("ch.ninecode.np.ShortCircuitInfo1").setLevel (org.apache.log4j.Level.INFO)
                }
                val log = LoggerFactory.getLogger (getClass)
