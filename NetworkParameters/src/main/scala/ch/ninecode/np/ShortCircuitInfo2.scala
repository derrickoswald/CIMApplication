...
extends CIMRDD
{
    ...
    def read_csv (csv1: String, csv2: String): RDD[EquivalentInjection] =
    {
        ...
        def toEquivalentInjection (voltages: Map[Double, String])(row: Row): EquivalentInjection =
        {
            ...
            val obj = IdentifiedObject (sup = element, aliasName = alias, description = description, mRID = mRID, name = s"$name equivalent injection")
            ...
            val injection = EquivalentInjection (equivalent, maxP, maxQ, minP, minQ, 0.0, 0.0, netz_r1, netz_r0, netz_r1, regulationCapability = false, regulationStatus = true, 0.0, netz_x1, netz_x0, netz_x1)
